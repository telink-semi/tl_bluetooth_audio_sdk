...
#define RF_ACCESS_CODE_DEFAULT_THRESHOLD (29) //0x1e  . BQB may use 32. Coded PHY may use 0xF0
#endif
...
#define TX_STL_AUTO_MODE_1M   (115 - PRMBL_EXTRA_1M * 8)
#define TX_STL_AUTO_MODE_2M   (128 - PRMBL_EXTRA_2M * 4)
 ...
 */
#define AD_CONVERT_DLY_1M     16
#define AD_CONVERT_DLY_2M     9
#define AD_CONVERT_DLY_CODED  18
...
{
    rf_power_level_index_e rfPwrLvlIdx = RF_POWER_INDEX_P0p00dBm;
