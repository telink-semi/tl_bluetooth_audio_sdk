 ...
 */
_attribute_ram_code_ _attribute_ram_code_sec_ void ext_hci_irq_handler(void)
{
 ...
 */
_attribute_ram_code_ void ext_hci_dma_irq_handler(void)
{
 ...
 */
_attribute_ram_code_sec_ unsigned char ext_hci_uartSendData(unsigned char *addr, unsigned int len)
{
...
_attribute_ram_code_sec_ //BLE SDK use:
    void
    ext_hci_uartReceData(unsigned char *addr, unsigned int len)
{
