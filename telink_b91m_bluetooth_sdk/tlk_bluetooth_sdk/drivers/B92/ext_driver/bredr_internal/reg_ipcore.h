 ...
 * </pre>
 */
#define IP_RWDMCNTL_ADDR   (REG_IPCORE_BASE_ADDR + 0x00)
 ...
 * </pre>
 */
#define IP_VERSION_ADDR   (REG_IPCORE_BASE_ADDR + 0x04)
 ...
 * </pre>
 */
#define IP_INTCNTL_ADDR   (REG_IPCORE_BASE_ADDR + 0x0C)
 ...
 * </pre>
 */
#define IP_INTSTAT_ADDR   (REG_IPCORE_BASE_ADDR + 0x10)
...
__INLINE void ip_intstat_unpack(uint8_t *swintstat, uint8_t *timestampintstat, uint8_t *finetgtintstat, uint8_t *grosstgtintstat, uint8_t *errorintstat, uint8_t *cryptintstat,
                                uint8_t *slpintstat, uint8_t *clknintstat)
{
 ...
 * </pre>
 */
#define IP_INTRAWSTAT_ADDR   (REG_IPCORE_BASE_ADDR + 0x14)
...
__INLINE void ip_intrawstat_unpack(uint8_t *swintrawstat, uint8_t *timestampintrawstat, uint8_t *finetgtintrawstat, uint8_t *grosstgtintrawstat, uint8_t *errorintrawstat,
                                   uint8_t *cryptintrawstat, uint8_t *slpintrawstat, uint8_t *clknintrawstat)
{
 ...
 * </pre>
 */
#define IP_INTACK_ADDR   (REG_IPCORE_BASE_ADDR + 0x18)
...
__INLINE void ip_intack_pack(uint8_t swintack, uint8_t timestampintack, uint8_t finetgtintack, uint8_t grosstgtintack, uint8_t errorintack, uint8_t cryptintack, uint8_t slpintack,
                             uint8_t clknintack)
{
    ...
    REG_IP_WR(IP_INTACK_ADDR, ((uint32_t)swintack << 12) | ((uint32_t)timestampintack << 11) | ((uint32_t)finetgtintack << 10) | ((uint32_t)grosstgtintack << 9) |
                                  ((uint32_t)errorintack << 8) | ((uint32_t)cryptintack << 7) | ((uint32_t)slpintack << 3) | ((uint32_t)clknintack << 0));
}

__INLINE void ip_intack_unpack(uint8_t *swintack, uint8_t *timestampintack, uint8_t *finetgtintack, uint8_t *grosstgtintack, uint8_t *errorintack, uint8_t *cryptintack,
                               uint8_t *slpintack, uint8_t *clknintack)
{
 ...
 * </pre>
 */
#define IP_SLOTCLK_ADDR   (REG_IPCORE_BASE_ADDR + 0x1C)
...
__INLINE uint32_t ip_slotclk_sclk_getf(void) //half slot, eg. 312.5us
{
    uint32_t localVal = REG_IP_RD(IP_SLOTCLK_ADDR);
 ...
 * </pre>
 */
#define IP_FINETIMECNT_ADDR   (REG_IPCORE_BASE_ADDR + 0x20)
 ...
 * </pre>
 */
#define IP_DEEPSLCNTL_ADDR   (REG_IPCORE_BASE_ADDR + 0x30)
...
__INLINE void ip_deepslcntl_pack(uint8_t extwkupdsb, uint8_t softwakeupreq, uint8_t deepsleepcorren, uint8_t deepsleepon, uint8_t radiosleepen, uint8_t oscsleepen)
{
    ...
    REG_IP_WR(IP_DEEPSLCNTL_ADDR, ((uint32_t)extwkupdsb << 31) | ((uint32_t)softwakeupreq << 4) | ((uint32_t)deepsleepcorren << 3) | ((uint32_t)deepsleepon << 2) |
                                      ((uint32_t)radiosleepen << 1) | ((uint32_t)oscsleepen << 0));
}

__INLINE void ip_deepslcntl_unpack(uint8_t *extwkupdsb, uint8_t *deepsleepstat, uint8_t *softwakeupreq, uint8_t *deepsleepcorren, uint8_t *deepsleepon, uint8_t *radiosleepen,
                                   uint8_t *oscsleepen)
{
 ...
 * </pre>
 */
#define IP_DEEPSLWKUP_ADDR   (REG_IPCORE_BASE_ADDR + 0x34)
 ...
 * </pre>
 */
#define IP_DEEPSLSTAT_ADDR   (REG_IPCORE_BASE_ADDR + 0x38)
 ...
 * </pre>
 */
#define IP_ENBPRESET_ADDR   (REG_IPCORE_BASE_ADDR + 0x3C)
 ...
 * </pre>
 */
#define IP_FINECNTCORR_ADDR   (REG_IPCORE_BASE_ADDR + 0x40)
 ...
 * </pre>
 */
#define IP_CLKNCNTCORR_ADDR   (REG_IPCORE_BASE_ADDR + 0x44)
 ...
 * </pre>
 */
#define IP_DIAGCNTL_ADDR   (REG_IPCORE_BASE_ADDR + 0x50)
...
__INLINE void ip_diagcntl_pack(uint8_t diag3en, uint8_t diag3, uint8_t diag2en, uint8_t diag2, uint8_t diag1en, uint8_t diag1, uint8_t diag0en, uint8_t diag0)
{
    ...
    REG_IP_WR(IP_DIAGCNTL_ADDR, ((uint32_t)diag3en << 31) | ((uint32_t)diag3 << 24) | ((uint32_t)diag2en << 23) | ((uint32_t)diag2 << 16) | ((uint32_t)diag1en << 15) |
 ...
 * </pre>
 */
#define IP_DIAGSTAT_ADDR   (REG_IPCORE_BASE_ADDR + 0x54)
 ...
 * </pre>
 */
#define IP_DEBUGADDMAX_ADDR   (REG_IPCORE_BASE_ADDR + 0x58)
 ...
 * </pre>
 */
#define IP_DEBUGADDMIN_ADDR   (REG_IPCORE_BASE_ADDR + 0x5C)
 ...
 * </pre>
 */
#define IP_ERRORTYPESTAT_ADDR   (REG_IPCORE_BASE_ADDR + 0x60)
 ...
 * </pre>
 */
#define IP_SWPROFILING_ADDR   (REG_IPCORE_BASE_ADDR + 0x64)
...
__INLINE void ip_swprofiling_pack(uint8_t swprof31, uint8_t swprof30, uint8_t swprof29, uint8_t swprof28, uint8_t swprof27, uint8_t swprof26, uint8_t swprof25, uint8_t swprof24,
                                  ...
                                  uint8_t swprof7, uint8_t swprof6, uint8_t swprof5, uint8_t swprof4, uint8_t swprof3, uint8_t swprof2, uint8_t swprof1, uint8_t swprof0)
{
    ...
    REG_IP_WR(IP_SWPROFILING_ADDR, ((uint32_t)swprof31 << 31) | ((uint32_t)swprof30 << 30) | ((uint32_t)swprof29 << 29) | ((uint32_t)swprof28 << 28) | ((uint32_t)swprof27 << 27) |
...
__INLINE void ip_swprofiling_unpack(uint8_t *swprof31, uint8_t *swprof30, uint8_t *swprof29, uint8_t *swprof28, uint8_t *swprof27, uint8_t *swprof26, uint8_t *swprof25,
 ...
 * </pre>
 */
#define IP_RADIOCNTL0_ADDR   (REG_IPCORE_BASE_ADDR + 0x70)
 ...
 * </pre>
 */
#define IP_RADIOCNTL1_ADDR   (REG_IPCORE_BASE_ADDR + 0x74)
...
__INLINE void ip_radiocntl1_pack(uint8_t forceagcen, uint8_t forceiq, uint8_t rxdnsl, uint8_t txdnsl, uint16_t forceagclength, uint8_t syncpulsemode, uint8_t syncpulsesrc,
                                 uint8_t dpcorren, uint8_t jefselect, uint8_t xrfsel, uint8_t subversion)
{
    ...
    REG_IP_WR(IP_RADIOCNTL1_ADDR, ((uint32_t)forceagcen << 31) | ((uint32_t)forceiq << 30) | ((uint32_t)rxdnsl << 29) | ((uint32_t)txdnsl << 28) |
...
__INLINE void ip_radiocntl1_unpack(uint8_t *forceagcen, uint8_t *forceiq, uint8_t *rxdnsl, uint8_t *txdnsl, uint16_t *forceagclength, uint8_t *syncpulsemode, uint8_t *syncpulsesrc,
                                   uint8_t *dpcorren, uint8_t *jefselect, uint8_t *xrfsel, uint8_t *subversion)
{
 ...
 * </pre>
 */
#define IP_AESCNTL_ADDR   (REG_IPCORE_BASE_ADDR + 0xB0)
 ...
 * </pre>
 */
#define IP_AESKEY31_0_ADDR   (REG_IPCORE_BASE_ADDR + 0xB4)
 ...
 * </pre>
 */
#define IP_AESKEY63_32_ADDR   (REG_IPCORE_BASE_ADDR + 0xB8)
 ...
 * </pre>
 */
#define IP_AESKEY95_64_ADDR   (REG_IPCORE_BASE_ADDR + 0xBC)
 ...
 * </pre>
 */
#define IP_AESKEY127_96_ADDR   (REG_IPCORE_BASE_ADDR + 0xC0)
 ...
 * </pre>
 */
#define IP_AESPTR_ADDR   (REG_IPCORE_BASE_ADDR + 0xC4)
 ...
 * </pre>
 */
#define IP_TXMICVAL_ADDR   (REG_IPCORE_BASE_ADDR + 0xC8)
 ...
 * </pre>
 */
#define IP_RXMICVAL_ADDR   (REG_IPCORE_BASE_ADDR + 0xCC)
 ...
 * </pre>
 */
#define IP_PRIOSCHARB_ADDR   (REG_IPCORE_BASE_ADDR + 0xD0)
 ...
 * </pre>
 */
#define IP_GROSSTIMTGT_ADDR   (REG_IPCORE_BASE_ADDR + 0xE4)
 ...
 * </pre>
 */
#define IP_FINETIMTGT_ADDR   (REG_IPCORE_BASE_ADDR + 0xE8)
 ...
 * </pre>
 */
#define IP_CLKNTGT_ADDR   (REG_IPCORE_BASE_ADDR + 0xEC)
 ...
 * </pre>
 */
#define IP_HMICROSECTGT_ADDR   (REG_IPCORE_BASE_ADDR + 0xF0)
...
#define BT_HEADER_RXTYPE_MASK  ((uint16_t)0x00000078)
#define BT_HEADER_RXTYPE_LSB   3
#define BT_HEADER_RXTYPE_WIDTH ((uint16_t)0x00000004)

__INLINE uint8_t bt_rxtype_get(void)
{
    return ((bt_rftestcntl_get() & BT_HEADER_RXTYPE_MASK) >> BT_HEADER_RXTYPE_LSB);
}
