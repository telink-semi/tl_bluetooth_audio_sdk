 ...
 * </pre>
 */
#define BT_E_SCOCHANCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x1D0)
#define BT_E_SCOCHANCNTL_OFFSET 0x000001D0
#define BT_E_SCOCHANCNTL_INDEX  0x00000074
...
#define BT_T_ESCO_MASK       ((uint32_t)0x000000FF)
#define BT_T_ESCO_LSB        0
#define BT_T_ESCO_WIDTH      ((uint32_t)0x00000008)
...
__INLINE void bt_e_scochancntl_pack(int elt_idx, uint8_t escochanswen, uint8_t escochanen, uint8_t itmode2, uint8_t intdelay, uint8_t tesco)
{
    ...
    REG_BT_WR(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              ((uint32_t)escochanswen << 15) | ((uint32_t)escochanen << 14) | ((uint32_t)itmode2 << 13) | ((uint32_t)intdelay << 8) | ((uint32_t)tesco << 0));
}
...
__INLINE void bt_e_scochancntl_e_scochanswen_setf(int elt_idx, uint8_t escochanswen)
{
    ASSERT_ERR((((uint32_t)escochanswen << 15) & ~((uint32_t)0x00008000)) == 0);
    REG_BT_WR(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00008000)) | ((uint32_t)escochanswen << 15));
}
...
__INLINE void bt_e_scochancntl_e_scochanen_setf(int elt_idx, uint8_t escochanen)
{
    ASSERT_ERR((((uint32_t)escochanen << 14) & ~((uint32_t)0x00004000)) == 0);
    REG_BT_WR(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00004000)) | ((uint32_t)escochanen << 14));
}
...
__INLINE void bt_e_scochancntl_itmode2_setf(int elt_idx, uint8_t itmode2)
{
    ASSERT_ERR((((uint32_t)itmode2 << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_BT_WR(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00002000)) | ((uint32_t)itmode2 << 13));
}
...
__INLINE void bt_e_scochancntl_intdelay_setf(int elt_idx, uint8_t intdelay)
{
    ASSERT_ERR((((uint32_t)intdelay << 8) & ~((uint32_t)0x00001F00)) == 0);
    REG_BT_WR(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00001F00)) | ((uint32_t)intdelay << 8));
}

__INLINE uint8_t bt_e_scochancntl_t_esco_getf(int elt_idx)
{
    uint32_t localVal = REG_BT_RD(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE);
    return ((localVal & ((uint32_t)0x000000FF)) >> 0);
}

__INLINE void bt_e_scochancntl_t_esco_setf(int elt_idx, uint8_t tesco)
{
    ASSERT_ERR((((uint32_t)tesco << 0) & ~((uint32_t)0x000000FF)) == 0);
    REG_BT_WR(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOCHANCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x000000FF)) | ((uint32_t)tesco << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOMUTECNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x1D4)
#define BT_E_SCOMUTECNTL_OFFSET 0x000001D4
#define BT_E_SCOMUTECNTL_INDEX  0x00000075
...
__INLINE void bt_e_scomutecntl_pack(int elt_idx, uint8_t mutesink, uint8_t mutesource, uint8_t invl1, uint8_t invl0, uint16_t mutepatt)
{
    ...
    REG_BT_WR(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              ((uint32_t)mutesink << 23) | ((uint32_t)mutesource << 22) | ((uint32_t)invl1 << 18) | ((uint32_t)invl0 << 16) | ((uint32_t)mutepatt << 0));
}
...
__INLINE void bt_e_scomutecntl_mute_sink_setf(int elt_idx, uint8_t mutesink)
{
    ASSERT_ERR((((uint32_t)mutesink << 23) & ~((uint32_t)0x00800000)) == 0);
    REG_BT_WR(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00800000)) | ((uint32_t)mutesink << 23));
}
...
__INLINE void bt_e_scomutecntl_mute_source_setf(int elt_idx, uint8_t mutesource)
{
    ASSERT_ERR((((uint32_t)mutesource << 22) & ~((uint32_t)0x00400000)) == 0);
    REG_BT_WR(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00400000)) | ((uint32_t)mutesource << 22));
}
...
__INLINE void bt_e_scomutecntl_invl_1_setf(int elt_idx, uint8_t invl1)
{
    ASSERT_ERR((((uint32_t)invl1 << 18) & ~((uint32_t)0x000C0000)) == 0);
    REG_BT_WR(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x000C0000)) | ((uint32_t)invl1 << 18));
}
...
__INLINE void bt_e_scomutecntl_invl_0_setf(int elt_idx, uint8_t invl0)
{
    ASSERT_ERR((((uint32_t)invl0 << 16) & ~((uint32_t)0x00030000)) == 0);
    REG_BT_WR(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00030000)) | ((uint32_t)invl0 << 16));
}
...
__INLINE void bt_e_scomutecntl_mutepatt_setf(int elt_idx, uint16_t mutepatt)
{
    ASSERT_ERR((((uint32_t)mutepatt << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOMUTECNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)mutepatt << 0));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16           eSCOPTRTX1   0x0
 *  15:00           eSCOPTRTX0   0x0
 * </pre>
 */
#define BT_E_SCOCURRENTTXPTR_ADDR   (REG_BTCORE_BASE_ADDR + 0x1D8)
#define BT_E_SCOCURRENTTXPTR_OFFSET 0x000001D8
#define BT_E_SCOCURRENTTXPTR_INDEX  0x00000076
...
// field definitions
#define BT_E_SCOPTRTX_1_MASK  ((uint32_t)0xFFFF0000)
#define BT_E_SCOPTRTX_1_LSB   16
#define BT_E_SCOPTRTX_1_WIDTH ((uint32_t)0x00000010)
#define BT_E_SCOPTRTX_0_MASK  ((uint32_t)0x0000FFFF)
#define BT_E_SCOPTRTX_0_LSB   0
#define BT_E_SCOPTRTX_0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)escoptrtx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)escoptrtx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_e_scocurrenttxptr_unpack(int elt_idx, uint16_t *escoptrtx1, uint16_t *escoptrtx0)
{
    ...
    *escoptrtx1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *escoptrtx0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)escoptrtx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOCURRENTTXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)escoptrtx1 << 16));
}
...
__INLINE void bt_e_scocurrenttxptr_e_scoptrtx_0_setf(int elt_idx, uint16_t escoptrtx0)
{
    ASSERT_ERR((((uint32_t)escoptrtx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOCURRENTTXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)escoptrtx0 << 0));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16           eSCOPTRRX1   0x0
 *  15:00           eSCOPTRRX0   0x0
 * </pre>
 */
#define BT_E_SCOCURRENTRXPTR_ADDR   (REG_BTCORE_BASE_ADDR + 0x1DC)
#define BT_E_SCOCURRENTRXPTR_OFFSET 0x000001DC
#define BT_E_SCOCURRENTRXPTR_INDEX  0x00000077
...
// field definitions
#define BT_E_SCOPTRRX_1_MASK  ((uint32_t)0xFFFF0000)
#define BT_E_SCOPTRRX_1_LSB   16
#define BT_E_SCOPTRRX_1_WIDTH ((uint32_t)0x00000010)
#define BT_E_SCOPTRRX_0_MASK  ((uint32_t)0x0000FFFF)
#define BT_E_SCOPTRRX_0_LSB   0
#define BT_E_SCOPTRRX_0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)escoptrrx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)escoptrrx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_e_scocurrentrxptr_unpack(int elt_idx, uint16_t *escoptrrx1, uint16_t *escoptrrx0)
{
    ...
    *escoptrrx1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *escoptrrx0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)escoptrrx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOCURRENTRXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)escoptrrx1 << 16));
}
...
__INLINE void bt_e_scocurrentrxptr_e_scoptrrx_0_setf(int elt_idx, uint16_t escoptrrx0)
{
    ASSERT_ERR((((uint32_t)escoptrrx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOCURRENTRXPTR_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)escoptrrx0 << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOLTCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x1E0)
#define BT_E_SCOLTCNTL_OFFSET 0x000001E0
#define BT_E_SCOLTCNTL_INDEX  0x00000078
...
__INLINE void bt_e_scoltcntl_pack(int elt_idx, uint8_t retxnb, uint8_t escoedrrx, uint8_t escoedrtx, uint8_t syntype, uint8_t synltaddr)
{
    ...
    REG_BT_WR(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              ((uint32_t)retxnb << 16) | ((uint32_t)escoedrrx << 5) | ((uint32_t)escoedrtx << 4) | ((uint32_t)syntype << 3) | ((uint32_t)synltaddr << 0));
}
...
__INLINE void bt_e_scoltcntl_retxnb_setf(int elt_idx, uint8_t retxnb)
{
    ASSERT_ERR((((uint32_t)retxnb << 16) & ~((uint32_t)0x00FF0000)) == 0);
    REG_BT_WR(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00FF0000)) | ((uint32_t)retxnb << 16));
}
...
__INLINE void bt_e_scoltcntl_e_scoedrrx_setf(int elt_idx, uint8_t escoedrrx)
{
    ASSERT_ERR((((uint32_t)escoedrrx << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_BT_WR(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00000020)) | ((uint32_t)escoedrrx << 5));
}
...
__INLINE void bt_e_scoltcntl_e_scoedrtx_setf(int elt_idx, uint8_t escoedrtx)
{
    ASSERT_ERR((((uint32_t)escoedrtx << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_BT_WR(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00000010)) | ((uint32_t)escoedrtx << 4));
}
...
__INLINE void bt_e_scoltcntl_syntype_setf(int elt_idx, uint8_t syntype)
{
    ASSERT_ERR((((uint32_t)syntype << 3) & ~((uint32_t)0x00000008)) == 0);
    REG_BT_WR(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00000008)) | ((uint32_t)syntype << 3));
}
...
__INLINE void bt_e_scoltcntl_synltaddr_setf(int elt_idx, uint8_t synltaddr)
{
    ASSERT_ERR((((uint32_t)synltaddr << 0) & ~((uint32_t)0x00000007)) == 0);
    REG_BT_WR(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOLTCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00000007)) | ((uint32_t)synltaddr << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOTRCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x1E4)
#define BT_E_SCOTRCNTL_OFFSET 0x000001E4
#define BT_E_SCOTRCNTL_INDEX  0x00000079
...
__INLINE void bt_e_scotrcntl_pack(int elt_idx, uint8_t txseqn, uint16_t txlen, uint8_t txtype, uint16_t rxlen, uint8_t rxtype)
{
    ...
    REG_BT_WR(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              ((uint32_t)txseqn << 31) | ((uint32_t)txlen << 20) | ((uint32_t)txtype << 16) | ((uint32_t)rxlen << 4) | ((uint32_t)rxtype << 0));
}
...
__INLINE void bt_e_scotrcntl_txseqn_setf(int elt_idx, uint8_t txseqn)
{
    ASSERT_ERR((((uint32_t)txseqn << 31) & ~((uint32_t)0x80000000)) == 0);
    REG_BT_WR(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x80000000)) | ((uint32_t)txseqn << 31));
}
...
__INLINE void bt_e_scotrcntl_txlen_setf(int elt_idx, uint16_t txlen)
{
    ASSERT_ERR((((uint32_t)txlen << 20) & ~((uint32_t)0x3FF00000)) == 0);
    REG_BT_WR(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x3FF00000)) | ((uint32_t)txlen << 20));
}
...
__INLINE void bt_e_scotrcntl_txtype_setf(int elt_idx, uint8_t txtype)
{
    ASSERT_ERR((((uint32_t)txtype << 16) & ~((uint32_t)0x000F0000)) == 0);
    REG_BT_WR(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x000F0000)) | ((uint32_t)txtype << 16));
}
...
__INLINE void bt_e_scotrcntl_rxlen_setf(int elt_idx, uint16_t rxlen)
{
    ASSERT_ERR((((uint32_t)rxlen << 4) & ~((uint32_t)0x00003FF0)) == 0);
    REG_BT_WR(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x00003FF0)) | ((uint32_t)rxlen << 4));
}
...
__INLINE void bt_e_scotrcntl_rxtype_setf(int elt_idx, uint8_t rxtype)
{
    ASSERT_ERR((((uint32_t)rxtype << 0) & ~((uint32_t)0x0000000F)) == 0);
    REG_BT_WR(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE,
              (REG_BT_RD(BT_E_SCOTRCNTL_ADDR + elt_idx * REG_BTCORE_ESCO_SIZE) & ~((uint32_t)0x0000000F)) | ((uint32_t)rxtype << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCODAYCNT_ADDR   (REG_BTCORE_BASE_ADDR + 0x1E8)
#define BT_E_SCODAYCNT_OFFSET 0x000001E8
#define BT_E_SCODAYCNT_INDEX  0x0000007A
