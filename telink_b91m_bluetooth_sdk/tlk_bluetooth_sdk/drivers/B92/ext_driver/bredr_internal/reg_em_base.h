...
//#include "bredr_ext.h"
    ...
    #define REG_MCU_EM_BASE_ADDR ((0xc0200000) | REG_EM_BASE_ADDR) //0xc0200000 is necessary for B91/B92
#else
    #define REG_EM_BASE_ADDR     ((IRAM_ADDR) | (EM_BASE_IRAM_OFFSET))
    #define REG_MCU_EM_BASE_ADDR ((0xc0000000) | REG_EM_BASE_ADDR) //0xc0000000 is necessary for B91/B92
#endif
...
#define REG_IPCORE_BASE_ADDR       0x80160000
