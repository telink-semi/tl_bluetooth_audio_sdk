 ...
 * </pre>
 */
#define EM_EXTAB_ADDR  (EM_BASE_ADDR + EM_ET_OFFSET)
...
__INLINE void em_extab_pack(int elt_idx, uint8_t schprio1, uint8_t spa, uint8_t csb, uint8_t sniff, uint8_t rsvd, uint8_t esco, uint8_t status, uint8_t mode)
{
    ...
    EM_WR(EM_EXTAB_ADDR + elt_idx * REG_EM_ET_SIZE, ((uint16_t)schprio1 << 11) | ((uint16_t)spa << 10) | ((uint16_t)csb << 9) | ((uint16_t)sniff << 8) | ((uint16_t)rsvd << 7) |
                                                        ((uint16_t)esco << 6) | ((uint16_t)status << 3) | ((uint16_t)mode << 0));
}
 ...
 * </pre>
 */
#define EM_EXTAB0_ADDR  (EM_BASE_ADDR + EM_ET_OFFSET)
...
__INLINE void em_extab0_pack(int elt_idx, uint8_t schprio1, uint8_t spa, uint8_t isobufsel, uint8_t aenps, uint8_t rsvd, uint8_t iso, uint8_t status, uint8_t mode)
{
    ...
    ASSERT_ERR((((uint16_t)status << 3) & ~((uint16_t)0x00000038)) == 0);
    ASSERT_ERR((((uint16_t)mode << 0) & ~((uint16_t)0x00000007)) == 0);
    EM_WR(EM_EXTAB0_ADDR + elt_idx * REG_EM_ET_SIZE, ((uint16_t)schprio1 << 11) | ((uint16_t)spa << 10) | ((uint16_t)isobufsel << 9) | ((uint16_t)aenps << 8) |
                                                         ((uint16_t)rsvd << 7) | ((uint16_t)iso << 6) | ((uint16_t)status << 3) | ((uint16_t)mode << 0));
}
 ...
 * </pre>
 */
#define EM_RAWSTP0_ADDR  (EM_BASE_ADDR + 0x02 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_RAWSTP1_ADDR  (EM_BASE_ADDR + 0x04 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_FINESTP_ADDR  (EM_BASE_ADDR + 0x06 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_CSPTR_ADDR  (EM_BASE_ADDR + 0x08 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_PRIOBW_ADDR  (EM_BASE_ADDR + 0x0A + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_PRIOLVL_ADDR  (EM_BASE_ADDR + 0x0C + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_VXCHAN_ADDR  (EM_BASE_ADDR + 0x0E + EM_ET_OFFSET)
