 ...
 * </pre>
 */
#define EM_BT_RXPTR_ADDR  (REG_EM_BT_RXDESC_BASE_ADDR + 0x00 + EM_BT_RXDESC_OFFSET)
...
{
    ASSERT_ERR((((uint16_t)rxdone << 15) & ~((uint16_t)0x00008000)) == 0);
    EM_BT_WR(EM_BT_RXPTR_ADDR + elt_idx * REG_EM_BT_RXDESC_SIZE,
             (EM_BT_RD(EM_BT_RXPTR_ADDR + elt_idx * REG_EM_BT_RXDESC_SIZE) & ~((uint16_t)0x00008000)) | ((uint16_t)rxdone << 15));
}
...
__INLINE void em_bt_rxptr_nextptr_setf(int elt_idx, uint16_t nextptr)
{
    ASSERT_ERR((((uint16_t)nextptr << 0) & ~((uint16_t)0x00007FFF)) == 0);
    EM_BT_WR(EM_BT_RXPTR_ADDR + elt_idx * REG_EM_BT_RXDESC_SIZE,
             (EM_BT_RD(EM_BT_RXPTR_ADDR + elt_idx * REG_EM_BT_RXDESC_SIZE) & ~((uint16_t)0x00007FFF)) | ((uint16_t)nextptr << 0));
}
 ...
 * </pre>
 */
#define EM_BT_RXSTAT_ADDR  (REG_EM_BT_RXDESC_BASE_ADDR + 0x02 + EM_BT_RXDESC_OFFSET)
...
__INLINE void em_bt_rxstat_unpack(int elt_idx, uint8_t *rxlinklbl, uint8_t *rxeirstat, uint8_t *rxguarderr, uint8_t *rxbadlt, uint8_t *rxfecerr, uint8_t *rxseqerr,
                                  uint8_t *rxmicerr, uint8_t *rxcrcerr, uint8_t *rxhecerr, uint8_t *rxsyncerr)
{
 ...
 * </pre>
 */
#define EM_BT_RXHEADER_ADDR  (REG_EM_BT_RXDESC_BASE_ADDR + 0x04 + EM_BT_RXDESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXPHEADER_ADDR  (REG_EM_BT_RXDESC_BASE_ADDR + 0x06 + EM_BT_RXDESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCHASS_ADDR  (REG_EM_BT_RXDESC_BASE_ADDR + 0x08 + EM_BT_RXDESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXACLBUFPTR_ADDR  (REG_EM_BT_RXDESC_BASE_ADDR + 0x0A + EM_BT_RXDESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXLMBUFPTR_ADDR  (REG_EM_BT_RXDESC_BASE_ADDR + 0x0C + EM_BT_RXDESC_OFFSET)
