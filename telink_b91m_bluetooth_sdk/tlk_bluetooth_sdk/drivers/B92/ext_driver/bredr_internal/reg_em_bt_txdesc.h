 ...
 * </pre>
 */
#define EM_BT_TXPTR_ADDR  (REG_EM_BT_TXDESC_BASE_ADDR + 0x00 + EM_BT_TXDESC_OFFSET)
...
#define EM_BT_NEXTPTR_MASK  ((uint16_t)0x00007FFF)
#define EM_BT_NEXTPTR_LSB   0
#define EM_BT_NEXTPTR_WIDTH ((uint16_t)0x0000000F)
...
{
    ASSERT_ERR((((uint16_t)txdone << 15) & ~((uint16_t)0x00008000)) == 0);
    EM_BT_WR(EM_BT_TXPTR_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXPTR_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00008000)) | ((uint16_t)txdone << 15));
}
...
__INLINE void em_bt_txptr_nextptr_setf(int elt_idx, uint16_t nextptr)
{
    ASSERT_ERR((((uint16_t)nextptr << 0) & ~((uint16_t)0x00007FFF)) == 0);
    EM_BT_WR(EM_BT_TXPTR_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXPTR_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00007FFF)) | ((uint16_t)nextptr << 0));
}
 ...
 * </pre>
 */
#define EM_BT_TXHEADER_ADDR  (REG_EM_BT_TXDESC_BASE_ADDR + 0x02 + EM_BT_TXDESC_OFFSET)
...
__INLINE void em_bt_txheader_pack(int elt_idx, uint8_t txseqn, uint8_t txarqn, uint8_t txflow, uint8_t txtype, uint8_t txltaddr)
{
    ...
    EM_BT_WR(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             ((uint16_t)txseqn << 9) | ((uint16_t)txarqn << 8) | ((uint16_t)txflow << 7) | ((uint16_t)txtype << 3) | ((uint16_t)txltaddr << 0));
}
...
__INLINE void em_bt_txheader_txseqn_setf(int elt_idx, uint8_t txseqn)
{
    ASSERT_ERR((((uint16_t)txseqn << 9) & ~((uint16_t)0x00000200)) == 0);
    EM_BT_WR(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00000200)) | ((uint16_t)txseqn << 9));
}
...
__INLINE void em_bt_txheader_txarqn_setf(int elt_idx, uint8_t txarqn)
{
    ASSERT_ERR((((uint16_t)txarqn << 8) & ~((uint16_t)0x00000100)) == 0);
    EM_BT_WR(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00000100)) | ((uint16_t)txarqn << 8));
}
...
__INLINE void em_bt_txheader_txflow_setf(int elt_idx, uint8_t txflow)
{
    ASSERT_ERR((((uint16_t)txflow << 7) & ~((uint16_t)0x00000080)) == 0);
    EM_BT_WR(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00000080)) | ((uint16_t)txflow << 7));
}
...
__INLINE void em_bt_txheader_txtype_setf(int elt_idx, uint8_t txtype)
{
    ASSERT_ERR((((uint16_t)txtype << 3) & ~((uint16_t)0x00000078)) == 0);
    EM_BT_WR(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00000078)) | ((uint16_t)txtype << 3));
}
...
__INLINE void em_bt_txheader_txltaddr_setf(int elt_idx, uint8_t txltaddr)
{
    ASSERT_ERR((((uint16_t)txltaddr << 0) & ~((uint16_t)0x00000007)) == 0);
    EM_BT_WR(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00000007)) | ((uint16_t)txltaddr << 0));
}
 ...
 * </pre>
 */
#define EM_BT_TXPHEADER_ADDR  (REG_EM_BT_TXDESC_BASE_ADDR + 0x04 + EM_BT_TXDESC_OFFSET)
...
{
    ASSERT_ERR((((uint16_t)txundef << 13) & ~((uint16_t)0x0000E000)) == 0);
    EM_BT_WR(EM_BT_TXPHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXPHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x0000E000)) | ((uint16_t)txundef << 13));
}
...
__INLINE void em_bt_txpheader_txlength_setf(int elt_idx, uint16_t txlength)
{
    ASSERT_ERR((((uint16_t)txlength << 3) & ~((uint16_t)0x00001FF8)) == 0);
    EM_BT_WR(EM_BT_TXPHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXPHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00001FF8)) | ((uint16_t)txlength << 3));
}
...
__INLINE void em_bt_txpheader_txpflow_setf(int elt_idx, uint8_t txpflow)
{
    ASSERT_ERR((((uint16_t)txpflow << 2) & ~((uint16_t)0x00000004)) == 0);
    EM_BT_WR(EM_BT_TXPHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXPHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00000004)) | ((uint16_t)txpflow << 2));
}
...
__INLINE void em_bt_txpheader_txllid_setf(int elt_idx, uint8_t txllid)
{
    ASSERT_ERR((((uint16_t)txllid << 0) & ~((uint16_t)0x00000003)) == 0);
    EM_BT_WR(EM_BT_TXPHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE,
             (EM_BT_RD(EM_BT_TXPHEADER_ADDR + elt_idx * REG_EM_BT_TXDESC_SIZE) & ~((uint16_t)0x00000003)) | ((uint16_t)txllid << 0));
}
 ...
 * </pre>
 */
#define EM_BT_TXACLBUFPTR_ADDR  (REG_EM_BT_TXDESC_BASE_ADDR + 0x06 + EM_BT_TXDESC_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXLMBUFPTR_ADDR  (REG_EM_BT_TXDESC_BASE_ADDR + 0x08 + EM_BT_TXDESC_OFFSET)
