...
#include "stack/bt/common/em_map_bt.h"
#include "stack/bt/common/em_map.h"
 ...
 * </pre>
 */
#define EM_BT_FRCNTL_ADDR  (REG_EM_BT_CS_BASE_ADDR + EM_BT_CS_OFFSET)
...
// field definitions
#define EM_BT_FMWSPATT_MASK  ((uint16_t)0x00007000)
#define EM_BT_FMWSPATT_LSB   12
#define EM_BT_FMWSPATT_WIDTH ((uint16_t)0x00000003)
...
__INLINE void em_bt_frcntl_pack(int elt_idx, uint8_t fmwspatt, uint8_t txbsyen, uint8_t rxbsyen, uint8_t dnabort, uint8_t samen, uint8_t format)
{
    ASSERT_ERR((((uint16_t)fmwspatt << 12) & ~((uint16_t)0x00007000)) == 0);
    ...
    EM_BT_WR(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             ((uint16_t)fmwspatt << 12) | ((uint16_t)txbsyen << 10) | ((uint16_t)rxbsyen << 9) | ((uint16_t)dnabort << 8) | ((uint16_t)samen << 7) | ((uint16_t)format << 0));
}

__INLINE void em_bt_frcntl_unpack(int elt_idx, uint8_t *fmwspatt, uint8_t *txbsyen, uint8_t *rxbsyen, uint8_t *dnabort, uint8_t *samen, uint8_t *format)
{
    uint16_t localVal = EM_BT_RD(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE);

    *fmwspatt = (localVal & ((uint16_t)0x00007000)) >> 12;
...
__INLINE uint8_t em_bt_frcntl_fmwspatt_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x00007000)) >> 12);
}

__INLINE void em_bt_frcntl_fmwspatt_setf(int elt_idx, uint8_t fmwspatt)
{
    ASSERT_ERR((((uint16_t)fmwspatt << 12) & ~((uint16_t)0x00007000)) == 0);
    EM_BT_WR(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00007000)) | ((uint16_t)fmwspatt << 12));
}
 ...
 * </pre>
 */
#define EM_BT_CLKOFF0_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x02 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CLKOFF1_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x04 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_LINKCNTL_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x06 + EM_BT_CS_OFFSET)
...
__INLINE void em_bt_linkcntl_pack(int elt_idx, uint8_t aknena, uint8_t afhena, uint8_t laap, uint8_t whdsb, uint8_t acledr, uint8_t aclltaddr, uint8_t linklbl)
{
    ...
    EM_BT_WR(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE, ((uint16_t)aknena << 15) | ((uint16_t)afhena << 14) | ((uint16_t)laap << 13) | ((uint16_t)whdsb << 12) |
                                                                    ((uint16_t)acledr << 11) | ((uint16_t)aclltaddr << 8) | ((uint16_t)linklbl << 0));
}
...
{
    ASSERT_ERR((((uint16_t)aclltaddr << 8) & ~((uint16_t)0x00000700)) == 0);
    EM_BT_WR(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000700)) | ((uint16_t)aclltaddr << 8));
}
...
// tws_arbiter_en, EM_CS 06H bit(6)
__INLINE uint8_t em_bt_linkcntl_arbiter_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__INLINE void em_bt_linkcntl_arbiter_en_setf(int elt_idx, uint8_t arbiter_en)
{
    ASSERT_ERR((((uint16_t)arbiter_en << 0) & ~((uint16_t)0x00000040)) == 0);
    EM_BT_WR(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000040)) | ((uint16_t)(arbiter_en & 0x1) << 6));
}

// tws_observer_en, EM_CS 06H bit(5)
__INLINE uint8_t em_bt_linkcntl_observer_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__INLINE void em_bt_linkcntl_observer_en_setf(int elt_idx, uint8_t observer_en)
{
    ASSERT_ERR((((uint16_t)observer_en << 0) & ~((uint16_t)0x00000020)) == 0);
    EM_BT_WR(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000020)) | ((uint16_t)(observer_en & 0x1) << 5));
}
 ...
 * </pre>
 */
#define EM_BT_BDADDR_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x08 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_BCH0_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x0E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_BCH1_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x10 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXMAXBUF_BCH2_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x12 + EM_BT_CS_OFFSET)
...
{
    ASSERT_ERR((((uint16_t)rxmaxbuf << 6) & ~((uint16_t)0x0000FFC0)) == 0);
    EM_BT_WR(EM_BT_RXMAXBUF_BCH2_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_RXMAXBUF_BCH2_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x0000FFC0)) | ((uint16_t)rxmaxbuf << 6));
}
...
__INLINE void em_bt_rxmaxbuf_bch2_bch2_setf(int elt_idx, uint8_t bch2)
{
    ASSERT_ERR((((uint16_t)bch2 << 0) & ~((uint16_t)0x00000003)) == 0);
    EM_BT_WR(EM_BT_RXMAXBUF_BCH2_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_RXMAXBUF_BCH2_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000003)) | ((uint16_t)bch2 << 0));
}
 ...
 * </pre>
 */
#define EM_BT_PWRCNTL_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x14 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXRXCNTL_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x16 + EM_BT_CS_OFFSET)
...
__INLINE void em_bt_txrxcntl_pack(int elt_idx, uint8_t rxthr, uint8_t rxeir, uint8_t rxbcry, uint8_t rxcrypt, uint8_t stopmod, uint8_t nullflt, uint8_t txeir, uint8_t txbcry,
                                  uint8_t txcrypt)
{
    ...
    EM_BT_WR(EM_BT_TXRXCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE, ((uint16_t)rxthr << 13) | ((uint16_t)rxeir << 11) | ((uint16_t)rxbcry << 10) | ((uint16_t)rxcrypt << 8) |
                                                                    ((uint16_t)stopmod << 7) | ((uint16_t)nullflt << 6) | ((uint16_t)txeir << 3) | ((uint16_t)txbcry << 2) |
                                                                    ((uint16_t)txcrypt << 0));
}

__INLINE void em_bt_txrxcntl_unpack(int elt_idx, uint8_t *rxthr, uint8_t *rxeir, uint8_t *rxbcry, uint8_t *rxcrypt, uint8_t *stopmod, uint8_t *nullflt, uint8_t *txeir,
                                    uint8_t *txbcry, uint8_t *txcrypt)
{
 ...
 * </pre>
 */
#define EM_BT_WINCNTL_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x18 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXDESCPTR_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x1A + EM_BT_CS_OFFSET)
...
// field definitions
#define EM_BT_TXDESCPTR_MASK  ((uint16_t)0x00007FFF)
#define EM_BT_TXDESCPTR_LSB   0
#define EM_BT_TXDESCPTR_WIDTH ((uint16_t)0x0000000F)
 ...
 * </pre>
 */
#define EM_BT_CHMAP0_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x1C + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CHMAP1_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x1E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CHMAP2_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x20 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CHMAP3_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x22 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CHMAP4_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x24 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_LOOPCNTL_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x26 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_MAXFRMTIME_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x28 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_SAM_PTR_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x2A + EM_BT_CS_OFFSET)
...
// field definitions
#define EM_BT_SAM_PTR_MASK  ((uint16_t)0x0000FFFF)
#define EM_BT_SAM_PTR_LSB   0
#define EM_BT_SAM_PTR_WIDTH ((uint16_t)0x00000010)
...
{
    ASSERT_ERR((((uint16_t)samptr << 0) & ~((uint16_t)0x0000FFFF)) == 0);
 ...
 * </pre>
 */
#define EM_BT_SAM_CNTL_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x2C + EM_BT_CS_OFFSET)
...
{
    ASSERT_ERR((((uint16_t)samlength << 8) & ~((uint16_t)0x0000FF00)) == 0);
    EM_BT_WR(EM_BT_SAM_CNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_SAM_CNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x0000FF00)) | ((uint16_t)samlength << 8));
}
...
__INLINE void em_bt_sam_cntl_sam_offset_setf(int elt_idx, uint8_t samoffset)
{
    ASSERT_ERR((((uint16_t)samoffset << 0) & ~((uint16_t)0x000000FF)) == 0);
    EM_BT_WR(EM_BT_SAM_CNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_SAM_CNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x000000FF)) | ((uint16_t)samoffset << 0));
}
 ...
 * </pre>
 */
#define EM_BT_SK_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x2E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_IV_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x3E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXCCMPLDCNT0_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x46 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXCCMPLDCNT1_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x48 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXCCMPLDCNT2_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x4A + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCCMPLDCNT0_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x4C + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCCMPLDCNT1_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x4E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCCMPLDCNT2_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x50 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCLKN0_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x52 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCLKN1_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x54 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXBIT_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x56 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXDESCCNT_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x58 + EM_BT_CS_OFFSET)
...
{
    ASSERT_ERR((((uint16_t)audiotxdesccnt << 8) & ~((uint16_t)0x00001F00)) == 0);
    EM_BT_WR(EM_BT_TXDESCCNT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_TXDESCCNT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00001F00)) | ((uint16_t)audiotxdesccnt << 8));
}
...
__INLINE void em_bt_txdesccnt_acltxdesccnt_setf(int elt_idx, uint8_t acltxdesccnt)
{
    ASSERT_ERR((((uint16_t)acltxdesccnt << 0) & ~((uint16_t)0x0000001F)) == 0);
    EM_BT_WR(EM_BT_TXDESCCNT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_TXDESCCNT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x0000001F)) | ((uint16_t)acltxdesccnt << 0));
}
 ...
 * </pre>
 */
#define EM_BT_RXDESCCNT_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x5A + EM_BT_CS_OFFSET)
...
{
    ASSERT_ERR((((uint16_t)audiorxdesccnt << 8) & ~((uint16_t)0x00001F00)) == 0);
    EM_BT_WR(EM_BT_RXDESCCNT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_RXDESCCNT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00001F00)) | ((uint16_t)audiorxdesccnt << 8));
}
...
__INLINE void em_bt_rxdesccnt_aclrxdesccnt_setf(int elt_idx, uint8_t aclrxdesccnt)
{
    ASSERT_ERR((((uint16_t)aclrxdesccnt << 0) & ~((uint16_t)0x0000001F)) == 0);
    EM_BT_WR(EM_BT_RXDESCCNT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_RXDESCCNT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x0000001F)) | ((uint16_t)aclrxdesccnt << 0));
}

/**
 * @brief E_SCOTXRXSTAT register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *     09             eSCORSVD   0
 ...
 * </pre>
 */
#define EM_BT_E_SCOTXRXSTAT_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x5C + EM_BT_CS_OFFSET)
#define EM_BT_E_SCOTXRXSTAT_INDEX 0x0000002E
#define EM_BT_E_SCOTXRXSTAT_RESET 0x00000000

__INLINE uint16_t em_bt_e_scotxrxstat_get(int elt_idx)
{
    return EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
}

__INLINE void em_bt_e_scotxrxstat_set(int elt_idx, uint16_t value)
{
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE, value);
}

// field definitions
#define EM_BT_E_SCORSVD_BIT     ((uint16_t)0x00000200)
#define EM_BT_E_SCORSVD_POS     9
#define EM_BT_E_SCORETX_BIT     ((uint16_t)0x00000100)
#define EM_BT_E_SCORETX_POS     8
#define EM_BT_E_SCOWAITACK_BIT  ((uint16_t)0x00000004)
#define EM_BT_E_SCOWAITACK_POS  2
#define EM_BT_E_SCOLASTACK_BIT  ((uint16_t)0x00000002)
#define EM_BT_E_SCOLASTACK_POS  1
#define EM_BT_E_SCOLASTSEQN_BIT ((uint16_t)0x00000001)
#define EM_BT_E_SCOLASTSEQN_POS 0

#define EM_BT_E_SCORSVD_RST     0x0
#define EM_BT_E_SCORETX_RST     0x0
#define EM_BT_E_SCOWAITACK_RST  0x0
#define EM_BT_E_SCOLASTACK_RST  0x0
#define EM_BT_E_SCOLASTSEQN_RST 0x0

__INLINE void em_bt_e_scotxrxstat_pack(int elt_idx, uint8_t escorsvd, uint8_t escoretx, uint8_t escowaitack, uint8_t escolastack, uint8_t escolastseqn)
{
    ASSERT_ERR((((uint16_t)escorsvd << 9) & ~((uint16_t)0x00000200)) == 0);
    ASSERT_ERR((((uint16_t)escoretx << 8) & ~((uint16_t)0x00000100)) == 0);
    ASSERT_ERR((((uint16_t)escowaitack << 2) & ~((uint16_t)0x00000004)) == 0);
    ASSERT_ERR((((uint16_t)escolastack << 1) & ~((uint16_t)0x00000002)) == 0);
    ASSERT_ERR((((uint16_t)escolastseqn << 0) & ~((uint16_t)0x00000001)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             ((uint16_t)escorsvd << 9) | ((uint16_t)escoretx << 8) | ((uint16_t)escowaitack << 2) | ((uint16_t)escolastack << 1) | ((uint16_t)escolastseqn << 0));
}

__INLINE void em_bt_e_scotxrxstat_unpack(int elt_idx, uint8_t *escorsvd, uint8_t *escoretx, uint8_t *escowaitack, uint8_t *escolastack, uint8_t *escolastseqn)
{
    uint16_t localVal = EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE);

    *escorsvd     = (localVal & ((uint16_t)0x00000200)) >> 9;
    *escoretx     = (localVal & ((uint16_t)0x00000100)) >> 8;
    *escowaitack  = (localVal & ((uint16_t)0x00000004)) >> 2;
    *escolastack  = (localVal & ((uint16_t)0x00000002)) >> 1;
    *escolastseqn = (localVal & ((uint16_t)0x00000001)) >> 0;
}

__INLINE uint8_t em_bt_e_scotxrxstat_e_scorsvd_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__INLINE void em_bt_e_scotxrxstat_e_scorsvd_setf(int elt_idx, uint8_t escorsvd)
{
    ASSERT_ERR((((uint16_t)escorsvd << 9) & ~((uint16_t)0x00000200)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000200)) | ((uint16_t)escorsvd << 9));
}

__INLINE uint8_t em_bt_e_scotxrxstat_e_scoretx_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__INLINE void em_bt_e_scotxrxstat_e_scoretx_setf(int elt_idx, uint8_t escoretx)
{
    ASSERT_ERR((((uint16_t)escoretx << 8) & ~((uint16_t)0x00000100)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000100)) | ((uint16_t)escoretx << 8));
}

__INLINE uint8_t em_bt_e_scotxrxstat_e_scowaitack_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__INLINE void em_bt_e_scotxrxstat_e_scowaitack_setf(int elt_idx, uint8_t escowaitack)
{
    ASSERT_ERR((((uint16_t)escowaitack << 2) & ~((uint16_t)0x00000004)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000004)) | ((uint16_t)escowaitack << 2));
}

__INLINE uint8_t em_bt_e_scotxrxstat_e_scolastack_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__INLINE void em_bt_e_scotxrxstat_e_scolastack_setf(int elt_idx, uint8_t escolastack)
{
    ASSERT_ERR((((uint16_t)escolastack << 1) & ~((uint16_t)0x00000002)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000002)) | ((uint16_t)escolastack << 1));
}

__INLINE uint8_t em_bt_e_scotxrxstat_e_scolastseqn_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__INLINE void em_bt_e_scotxrxstat_e_scolastseqn_setf(int elt_idx, uint8_t escolastseqn)
{
    ASSERT_ERR((((uint16_t)escolastseqn << 0) & ~((uint16_t)0x00000001)) == 0);
    EM_BT_WR(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_E_SCOTXRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000001)) | ((uint16_t)escolastseqn << 0));
}
 ...
 * </pre>
 */
#define EM_BT_ACLTXSTAT_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x5E + EM_BT_CS_OFFSET)
#define EM_BT_ACLTXSTAT_INDEX 0x0000002F
...
__INLINE void em_bt_acltxstat_pack(int elt_idx, uint8_t txtog, uint8_t txflush, uint8_t fcrc, uint8_t fnak, uint8_t rswitch, uint8_t waitack, uint8_t lastnull, uint8_t lasttxack,
                                   uint8_t lasttxseqn)
{
    ...
    EM_BT_WR(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE, ((uint16_t)txtog << 15) | ((uint16_t)txflush << 14) | ((uint16_t)fcrc << 13) | ((uint16_t)fnak << 12) |
                                                                     ((uint16_t)rswitch << 11) | ((uint16_t)waitack << 10) | ((uint16_t)lastnull << 7) |
                                                                     ((uint16_t)lasttxack << 1) | ((uint16_t)lasttxseqn << 0));
}

__INLINE void em_bt_acltxstat_unpack(int elt_idx, uint8_t *txtog, uint8_t *txflush, uint8_t *fcrc, uint8_t *fnak, uint8_t *rswitch, uint8_t *waitack, uint8_t *lastnull,
                                     uint8_t *lasttxack, uint8_t *lasttxseqn)
{
...
{
    ASSERT_ERR((((uint16_t)txtog << 15) & ~((uint16_t)0x00008000)) == 0);
    EM_BT_WR(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00008000)) | ((uint16_t)txtog << 15));
}
...
__INLINE void em_bt_acltxstat_txflush_setf(int elt_idx, uint8_t txflush)
{
    ASSERT_ERR((((uint16_t)txflush << 14) & ~((uint16_t)0x00004000)) == 0);
    EM_BT_WR(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00004000)) | ((uint16_t)txflush << 14));
}
...
__INLINE void em_bt_acltxstat_rswitch_setf(int elt_idx, uint8_t rswitch)
{
    ASSERT_ERR((((uint16_t)rswitch << 11) & ~((uint16_t)0x00000800)) == 0);
    EM_BT_WR(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000800)) | ((uint16_t)rswitch << 11));
}
...
__INLINE void em_bt_acltxstat_waitack_setf(int elt_idx, uint8_t waitack)
{
    ASSERT_ERR((((uint16_t)waitack << 10) & ~((uint16_t)0x00000400)) == 0);
    EM_BT_WR(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000400)) | ((uint16_t)waitack << 10));
}
...
__INLINE void em_bt_acltxstat_last_null_setf(int elt_idx, uint8_t lastnull)
{
    ASSERT_ERR((((uint16_t)lastnull << 7) & ~((uint16_t)0x00000080)) == 0);
    EM_BT_WR(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000080)) | ((uint16_t)lastnull << 7));
}
...
__INLINE void em_bt_acltxstat_lasttxack_setf(int elt_idx, uint8_t lasttxack)
{
    ASSERT_ERR((((uint16_t)lasttxack << 1) & ~((uint16_t)0x00000002)) == 0);
    EM_BT_WR(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000002)) | ((uint16_t)lasttxack << 1));
}
...
__INLINE void em_bt_acltxstat_lasttxseqn_setf(int elt_idx, uint8_t lasttxseqn)
{
    ASSERT_ERR((((uint16_t)lasttxseqn << 0) & ~((uint16_t)0x00000001)) == 0);
    EM_BT_WR(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLTXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000001)) | ((uint16_t)lasttxseqn << 0));
}
 ...
 * </pre>
 */
#define EM_BT_ACLRXSTAT_ADDR  (REG_EM_BT_CS_BASE_ADDR + 0x60 + EM_BT_CS_OFFSET)
#define EM_BT_ACLRXSTAT_INDEX 0x00000030
...
__INLINE void em_bt_aclrxstat_pack(int elt_idx, uint8_t rxbufffull, uint8_t rxbfmicerr, uint8_t rxid, uint8_t rxacl, uint8_t rxaudio, uint8_t rxlmp, uint8_t lastrxflow,
                                   uint8_t lastrxack, uint8_t lastrxseqn)
{
    ...
    EM_BT_WR(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE, ((uint16_t)rxbufffull << 15) | ((uint16_t)rxbfmicerr << 14) | ((uint16_t)rxid << 13) | ((uint16_t)rxacl << 12) |
                                                                     ((uint16_t)rxaudio << 11) | ((uint16_t)rxlmp << 10) | ((uint16_t)lastrxflow << 2) |
                                                                     ((uint16_t)lastrxack << 1) | ((uint16_t)lastrxseqn << 0));
}

__INLINE void em_bt_aclrxstat_unpack(int elt_idx, uint8_t *rxbufffull, uint8_t *rxbfmicerr, uint8_t *rxid, uint8_t *rxacl, uint8_t *rxaudio, uint8_t *rxlmp, uint8_t *lastrxflow,
                                     uint8_t *lastrxack, uint8_t *lastrxseqn)
{
...
{
    ASSERT_ERR((((uint16_t)rxbufffull << 15) & ~((uint16_t)0x00008000)) == 0);
    EM_BT_WR(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00008000)) | ((uint16_t)rxbufffull << 15));
}
...
__INLINE void em_bt_aclrxstat_rxbfmicerr_setf(int elt_idx, uint8_t rxbfmicerr)
{
    ASSERT_ERR((((uint16_t)rxbfmicerr << 14) & ~((uint16_t)0x00004000)) == 0);
    EM_BT_WR(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00004000)) | ((uint16_t)rxbfmicerr << 14));
}
...
__INLINE void em_bt_aclrxstat_rxacl_setf(int elt_idx, uint8_t rxacl)
{
    ASSERT_ERR((((uint16_t)rxacl << 12) & ~((uint16_t)0x00001000)) == 0);
    EM_BT_WR(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00001000)) | ((uint16_t)rxacl << 12));
}
...
__INLINE void em_bt_aclrxstat_rxaudio_setf(int elt_idx, uint8_t rxaudio)
{
    ASSERT_ERR((((uint16_t)rxaudio << 11) & ~((uint16_t)0x00000800)) == 0);
    EM_BT_WR(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000800)) | ((uint16_t)rxaudio << 11));
}
...
__INLINE void em_bt_aclrxstat_rxlmp_setf(int elt_idx, uint8_t rxlmp)
{
    ASSERT_ERR((((uint16_t)rxlmp << 10) & ~((uint16_t)0x00000400)) == 0);
    EM_BT_WR(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000400)) | ((uint16_t)rxlmp << 10));
}
...
__INLINE void em_bt_aclrxstat_lastrxflow_setf(int elt_idx, uint8_t lastrxflow)
{
    ASSERT_ERR((((uint16_t)lastrxflow << 2) & ~((uint16_t)0x00000004)) == 0);
    EM_BT_WR(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000004)) | ((uint16_t)lastrxflow << 2));
}
...
__INLINE void em_bt_aclrxstat_lastrxack_setf(int elt_idx, uint8_t lastrxack)
{
    ASSERT_ERR((((uint16_t)lastrxack << 1) & ~((uint16_t)0x00000002)) == 0);
    EM_BT_WR(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000002)) | ((uint16_t)lastrxack << 1));
}
...
__INLINE void em_bt_aclrxstat_lastrxseqn_setf(int elt_idx, uint8_t lastrxseqn)
{
    ASSERT_ERR((((uint16_t)lastrxseqn << 0) & ~((uint16_t)0x00000001)) == 0);
    EM_BT_WR(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE,
             (EM_BT_RD(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000001)) | ((uint16_t)lastrxseqn << 0));
}

// tws_obid_capture, EM_CS 60H bit(4)
__INLINE uint8_t em_bt_linkcntl_obid_capture_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_ACLRXSTAT_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
