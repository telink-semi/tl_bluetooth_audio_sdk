 ...
 *********************************************************************************************************************/
#if BT_ERROR_CODE
volatile unsigned int irq_dis_tick;
volatile unsigned int irq_en_tick;
volatile unsigned int irq_dis_count;
volatile unsigned int irq_dis_pc;
volatile unsigned int irq_dis_ra;
volatile unsigned int irq_dis_ra;
#endif
/**
