...
#include <stdint.h>
#include "compiler.h"
#include "stack/common/co_assert.h"
 ...
 * </pre>
 */
#define BT_RWBTCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x00)
...
__INLINE void bt_rwbtcntl_pack(uint8_t mastersoftrst, uint8_t mastertgsoftrst, uint8_t regsoftrst, uint8_t radiocntlsoftrst, uint8_t swintreq, uint8_t scanabort,
                               uint8_t rftestabort, uint8_t pageinqabort, uint8_t sniffabort, uint8_t lmpflowdsb, uint8_t cryptdsb, uint8_t crcdsb, uint8_t whitdsb, uint8_t hopdsb,
                               uint8_t flowdsb, uint8_t arqndsb, uint8_t seqndsb, uint8_t cxtxbsyena, uint8_t cxrxbsyena, uint8_t cxdnabort, uint8_t rwbten, uint8_t nwinsize)
{
    ...
    REG_BT_WR(BT_RWBTCNTL_ADDR, ((uint32_t)mastersoftrst << 31) | ((uint32_t)mastertgsoftrst << 30) | ((uint32_t)regsoftrst << 29) | ((uint32_t)radiocntlsoftrst << 28) |
                                    ((uint32_t)swintreq << 27) | ((uint32_t)scanabort << 23) | ((uint32_t)rftestabort << 22) | ((uint32_t)pageinqabort << 21) |
                                    ((uint32_t)sniffabort << 20) | ((uint32_t)lmpflowdsb << 19) | ((uint32_t)cryptdsb << 18) | ((uint32_t)crcdsb << 17) |
                                    ((uint32_t)whitdsb << 16) | ((uint32_t)hopdsb << 15) | ((uint32_t)flowdsb << 14) | ((uint32_t)arqndsb << 13) | ((uint32_t)seqndsb << 12) |
                                    ((uint32_t)cxtxbsyena << 11) | ((uint32_t)cxrxbsyena << 10) | ((uint32_t)cxdnabort << 9) | ((uint32_t)rwbten << 8) | ((uint32_t)nwinsize << 0));
}

__INLINE void bt_rwbtcntl_unpack(uint8_t *mastersoftrst, uint8_t *mastertgsoftrst, uint8_t *regsoftrst, uint8_t *radiocntlsoftrst, uint8_t *swintreq, uint8_t *scanabort,
                                 uint8_t *rftestabort, uint8_t *pageinqabort, uint8_t *sniffabort, uint8_t *lmpflowdsb, uint8_t *cryptdsb, uint8_t *crcdsb, uint8_t *whitdsb,
                                 uint8_t *hopdsb, uint8_t *flowdsb, uint8_t *arqndsb, uint8_t *seqndsb, uint8_t *cxtxbsyena, uint8_t *cxrxbsyena, uint8_t *cxdnabort,
                                 uint8_t *rwbten, uint8_t *nwinsize)
{
...
__INLINE uint8_t bt_rwdmcntl_crpyt_soft_rst_getf(void)
{
    uint32_t localVal = REG_IP_RD(BT_RWBTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x04000000)) >> 26);
}

__INLINE void bt_rwdmcntl_crpyt_soft_rst_setf(uint8_t crpyt_soft_rst)
{
    ASSERT_ERR((((uint32_t)crpyt_soft_rst << 26) & ~((uint32_t)0x08000000)) == 0);
    REG_IP_WR(BT_RWBTCNTL_ADDR, (REG_IP_RD(BT_RWBTCNTL_ADDR) & ~((uint32_t)0x04000000)) | ((uint32_t)crpyt_soft_rst << 26));
}
 ...
 * </pre>
 */
#define BT_VERSION_ADDR   (REG_BTCORE_BASE_ADDR + 0x04)
#define BT_VERSION_OFFSET 0x00000004
#define BT_VERSION_INDEX  0x00000001
#define BT_VERSION_RESET  0x09001000
...
#define BT_TYP_RST     0x9
#define BT_REL_RST     0x0
#define BT_UPG_RST     0x10
 ...
 * </pre>
 */
#define BT_RWBTCONF_ADDR   (REG_BTCORE_BASE_ADDR + 0x08)
#define BT_RWBTCONF_OFFSET 0x00000008
#define BT_RWBTCONF_INDEX  0x00000002
#define BT_RWBTCONF_RESET  0x0FE2C8B0
...
#define BT_DATA_WIDTH_BIT   ((uint32_t)0x00000020)
#define BT_DATA_WIDTH_POS   5
...
#define BT_DATA_WIDTH_RST   0x1
#define BT_ADDR_WIDTH_RST   0x10

__INLINE void bt_rwbtconf_unpack(uint8_t *dmmode, uint8_t *correlator, uint8_t *mwswci2, uint8_t *mwswci1, uint8_t *vxportnb, uint8_t *pcm, uint8_t *mwscoex, uint8_t *wlancoex,
                                 uint8_t *rfif, uint8_t *usedbg, uint8_t *decipher, uint8_t *clksel, uint8_t *intmode, uint8_t *bustype, uint8_t *datawidth, uint8_t *addrwidth)
{
...
__INLINE uint8_t bt_rwbtconf_data_width_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_RWBTCONF_ADDR);
 ...
 * </pre>
 */
#define BT_INTCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x0C)
#define BT_INTCNTL_OFFSET 0x0000000C
#define BT_INTCNTL_INDEX  0x00000003
#define BT_INTCNTL_RESET  0x0000003D

__INLINE uint32_t bt_intcntl_get(void)
{
    return REG_BT_RD(BT_INTCNTL_ADDR);
}

__INLINE void bt_intcntl_set(uint32_t value)
{
    REG_BT_WR(BT_INTCNTL_ADDR, value);
}
...
#define BT_MWSWCIRXINTMSK_BIT  ((uint32_t)0x00100000)

#define BT_TXDONEINTMSK_BIT    ((uint32_t)0x00800000)
#define BT_TXDONEINTMSK_POS    23
#define BT_RXDONEINTMSK_BIT    ((uint32_t)0x00400000)
#define BT_RXDONEINTMSK_POS    22
#define BT_RXHEADERINTMSK_BIT  ((uint32_t)0x00200000)
#define BT_RXHEADERINTMSK_POS  21

#define BT_MWSWCIRXINTMSK_POS  20
#define BT_MWSWCITXINTMSK_BIT  ((uint32_t)0x00080000)
#define BT_MWSWCITXINTMSK_POS  19
#define BT_MTOFFINT1MSK_BIT    ((uint32_t)0x00040000)
#define BT_MTOFFINT1MSK_POS    18
#define BT_MTOFFINT0MSK_BIT    ((uint32_t)0x00020000)
#define BT_MTOFFINT0MSK_POS    17
#define BT_FRSYNCINTMSK_BIT    ((uint32_t)0x00010000)
#define BT_FRSYNCINTMSK_POS    16
...
#define BT_SWINTMSK_BIT        ((uint32_t)0x00001000)
#define BT_SWINTMSK_POS        12
#define BT_TIMESTAMPINTMSK_BIT ((uint32_t)0x00000800)
#define BT_TIMESTAMPINTMSK_POS 11
#define BT_FINETGTINTMSK_BIT   ((uint32_t)0x00000400)
#define BT_FINETGTINTMSK_POS   10
#define BT_GROSSTGTINTMSK_BIT  ((uint32_t)0x00000200)
#define BT_GROSSTGTINTMSK_POS  9
#define BT_ERRORINTMSK_BIT     ((uint32_t)0x00000100)
#define BT_ERRORINTMSK_POS     8
#define BT_CRYPTINTMSK_BIT     ((uint32_t)0x00000080)
#define BT_CRYPTINTMSK_POS     7
#define BT_SKIPFRMINTMSK_BIT   ((uint32_t)0x00000040)
#define BT_SKIPFRMINTMSK_POS   6
#define BT_ENDFRMINTMSK_BIT    ((uint32_t)0x00000020)
#define BT_ENDFRMINTMSK_POS    5
#define BT_STARTFRMINTMSK_BIT  ((uint32_t)0x00000010)
#define BT_STARTFRMINTMSK_POS  4
#define BT_SLPINTMSK_BIT       ((uint32_t)0x00000008)
#define BT_SLPINTMSK_POS       3
#define BT_RXINTMSK_BIT        ((uint32_t)0x00000004)
#define BT_RXINTMSK_POS        2
...
#define BT_TIMESTAMPINTMSK_RST 0x0
#define BT_FINETGTINTMSK_RST   0x0
#define BT_GROSSTGTINTMSK_RST  0x0
...
#define BT_RXINTMSK_RST        0x1
#define BT_CLKNINTMSK_RST      0x1

__INLINE void bt_intcntl_pack(uint8_t clknintsrmsk, uint8_t clknintsrval, uint8_t mwswcirxintmsk, uint8_t mwswcitxintmsk, uint8_t mtoffint1msk, uint8_t mtoffint0msk,
                              uint8_t frsyncintmsk, uint8_t audioint2msk, uint8_t audioint1msk, uint8_t audioint0msk, uint8_t swintmsk, uint8_t timestampintmsk,
                              uint8_t finetgtintmsk, uint8_t grosstgtintmsk, uint8_t errorintmsk, uint8_t cryptintmsk, uint8_t skipfrmintmsk, uint8_t endfrmintmsk,
                              uint8_t startfrmintmsk, uint8_t slpintmsk, uint8_t rxintmsk, uint8_t clknintmsk)
{
    ASSERT_ERR((((uint32_t)clknintsrmsk << 28) & ~((uint32_t)0x70000000)) == 0);
    ASSERT_ERR((((uint32_t)clknintsrval << 24) & ~((uint32_t)0x0F000000)) == 0);
    ASSERT_ERR((((uint32_t)mwswcirxintmsk << 20) & ~((uint32_t)0x00100000)) == 0);
    ASSERT_ERR((((uint32_t)mwswcitxintmsk << 19) & ~((uint32_t)0x00080000)) == 0);
    ASSERT_ERR((((uint32_t)mtoffint1msk << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)mtoffint0msk << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)frsyncintmsk << 16) & ~((uint32_t)0x00010000)) == 0);
    ...
    ASSERT_ERR((((uint32_t)skipfrmintmsk << 6) & ~((uint32_t)0x00000040)) == 0);
    ASSERT_ERR((((uint32_t)endfrmintmsk << 5) & ~((uint32_t)0x00000020)) == 0);
    ASSERT_ERR((((uint32_t)startfrmintmsk << 4) & ~((uint32_t)0x00000010)) == 0);
    ...
    REG_BT_WR(BT_INTCNTL_ADDR, ((uint32_t)clknintsrmsk << 28) | ((uint32_t)clknintsrval << 24) | ((uint32_t)mwswcirxintmsk << 20) | ((uint32_t)mwswcitxintmsk << 19) |
                                   ((uint32_t)mtoffint1msk << 18) | ((uint32_t)mtoffint0msk << 17) | ((uint32_t)frsyncintmsk << 16) | ((uint32_t)audioint2msk << 15) |
                                   ((uint32_t)audioint1msk << 14) | ((uint32_t)audioint0msk << 13) | ((uint32_t)swintmsk << 12) | ((uint32_t)timestampintmsk << 11) |
                                   ((uint32_t)finetgtintmsk << 10) | ((uint32_t)grosstgtintmsk << 9) | ((uint32_t)errorintmsk << 8) | ((uint32_t)cryptintmsk << 7) |
                                   ((uint32_t)skipfrmintmsk << 6) | ((uint32_t)endfrmintmsk << 5) | ((uint32_t)startfrmintmsk << 4) | ((uint32_t)slpintmsk << 3) |
                                   ((uint32_t)rxintmsk << 2) | ((uint32_t)clknintmsk << 0));
}

__INLINE void bt_intcntl_unpack(uint8_t *clknintsrmsk, uint8_t *clknintsrval, uint8_t *mwswcirxintmsk, uint8_t *mwswcitxintmsk, uint8_t *mtoffint1msk, uint8_t *mtoffint0msk,
                                uint8_t *frsyncintmsk, uint8_t *audioint2msk, uint8_t *audioint1msk, uint8_t *audioint0msk, uint8_t *swintmsk, uint8_t *timestampintmsk,
                                uint8_t *finetgtintmsk, uint8_t *grosstgtintmsk, uint8_t *errorintmsk, uint8_t *cryptintmsk, uint8_t *skipfrmintmsk, uint8_t *endfrmintmsk,
                                uint8_t *startfrmintmsk, uint8_t *slpintmsk, uint8_t *rxintmsk, uint8_t *clknintmsk)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);

    *clknintsrmsk    = (localVal & ((uint32_t)0x70000000)) >> 28;
    *clknintsrval    = (localVal & ((uint32_t)0x0F000000)) >> 24;
    *mwswcirxintmsk  = (localVal & ((uint32_t)0x00100000)) >> 20;
    *mwswcitxintmsk  = (localVal & ((uint32_t)0x00080000)) >> 19;
    *mtoffint1msk    = (localVal & ((uint32_t)0x00040000)) >> 18;
    *mtoffint0msk    = (localVal & ((uint32_t)0x00020000)) >> 17;
    *frsyncintmsk    = (localVal & ((uint32_t)0x00010000)) >> 16;
    ...
    *skipfrmintmsk   = (localVal & ((uint32_t)0x00000040)) >> 6;
    *endfrmintmsk    = (localVal & ((uint32_t)0x00000020)) >> 5;
    *startfrmintmsk  = (localVal & ((uint32_t)0x00000010)) >> 4;
    *slpintmsk       = (localVal & ((uint32_t)0x00000008)) >> 3;
    *rxintmsk        = (localVal & ((uint32_t)0x00000004)) >> 2;
    *clknintmsk      = (localVal & ((uint32_t)0x00000001)) >> 0;
}

__INLINE uint8_t bt_intcntl_clknintsrmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x70000000)) >> 28);
}

__INLINE void bt_intcntl_clknintsrmsk_setf(uint8_t clknintsrmsk)
{
    ASSERT_ERR((((uint32_t)clknintsrmsk << 28) & ~((uint32_t)0x70000000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x70000000)) | ((uint32_t)clknintsrmsk << 28));
}

__INLINE uint8_t bt_intcntl_clknintsrval_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x0F000000)) >> 24);
}

__INLINE void bt_intcntl_clknintsrval_setf(uint8_t clknintsrval)
{
    ASSERT_ERR((((uint32_t)clknintsrval << 24) & ~((uint32_t)0x0F000000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x0F000000)) | ((uint32_t)clknintsrval << 24));
}

__INLINE uint8_t bt_intcntl_rxheaderdonemsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00200000)) >> 21);
}

__INLINE void bt_intcntl_rxheaderdonemsk_setf(uint8_t rxheaderdonemsk)
{
    ASSERT_ERR((((uint32_t)rxheaderdonemsk << 21) & ~((uint32_t)0x00200000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00200000)) | ((uint32_t)rxheaderdonemsk << 21));
}

__INLINE uint8_t bt_intcntl_rxdonemsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00400000)) >> 22);
}

__INLINE void bt_intcntl_rxdonemsk_setf(uint8_t rxdonemsk)
{
    ASSERT_ERR((((uint32_t)rxdonemsk << 22) & ~((uint32_t)0x00400000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00400000)) | ((uint32_t)rxdonemsk << 22));
}

__INLINE uint8_t bt_intcntl_mwswcirxintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}

__INLINE void bt_intcntl_mwswcirxintmsk_setf(uint8_t mwswcirxintmsk)
{
    ASSERT_ERR((((uint32_t)mwswcirxintmsk << 20) & ~((uint32_t)0x00100000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00100000)) | ((uint32_t)mwswcirxintmsk << 20));
}

__INLINE uint8_t bt_intcntl_mwswcitxintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00080000)) >> 19);
}

__INLINE void bt_intcntl_mwswcitxintmsk_setf(uint8_t mwswcitxintmsk)
{
    ASSERT_ERR((((uint32_t)mwswcitxintmsk << 19) & ~((uint32_t)0x00080000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00080000)) | ((uint32_t)mwswcitxintmsk << 19));
}

__INLINE uint8_t bt_intcntl_mtoffint1msk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}

__INLINE void bt_intcntl_mtoffint1msk_setf(uint8_t mtoffint1msk)
{
    ASSERT_ERR((((uint32_t)mtoffint1msk << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00040000)) | ((uint32_t)mtoffint1msk << 18));
}

__INLINE uint8_t bt_intcntl_mtoffint0msk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}

__INLINE void bt_intcntl_mtoffint0msk_setf(uint8_t mtoffint0msk)
{
    ASSERT_ERR((((uint32_t)mtoffint0msk << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00020000)) | ((uint32_t)mtoffint0msk << 17));
}

__INLINE uint8_t bt_intcntl_frsyncintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}

__INLINE void bt_intcntl_frsyncintmsk_setf(uint8_t frsyncintmsk)
{
    ASSERT_ERR((((uint32_t)frsyncintmsk << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00010000)) | ((uint32_t)frsyncintmsk << 16));
}

__INLINE uint8_t bt_intcntl_audioint2msk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00008000)) >> 15);
}

__INLINE void bt_intcntl_audioint2msk_setf(uint8_t audioint2msk)
{
    ASSERT_ERR((((uint32_t)audioint2msk << 15) & ~((uint32_t)0x00008000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00008000)) | ((uint32_t)audioint2msk << 15));
}

__INLINE uint8_t bt_intcntl_audioint1msk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00004000)) >> 14);
}

__INLINE void bt_intcntl_audioint1msk_setf(uint8_t audioint1msk)
{
    ASSERT_ERR((((uint32_t)audioint1msk << 14) & ~((uint32_t)0x00004000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00004000)) | ((uint32_t)audioint1msk << 14));
}

__INLINE uint8_t bt_intcntl_audioint0msk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00002000)) >> 13);
}

__INLINE void bt_intcntl_audioint0msk_setf(uint8_t audioint0msk)
{
    ASSERT_ERR((((uint32_t)audioint0msk << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00002000)) | ((uint32_t)audioint0msk << 13));
}

__INLINE uint8_t bt_intcntl_swintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}

__INLINE void bt_intcntl_swintmsk_setf(uint8_t swintmsk)
{
    ASSERT_ERR((((uint32_t)swintmsk << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00001000)) | ((uint32_t)swintmsk << 12));
}

__INLINE uint8_t bt_intcntl_timestampintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}

__INLINE void bt_intcntl_timestampintmsk_setf(uint8_t timestampintmsk)
{
    ASSERT_ERR((((uint32_t)timestampintmsk << 11) & ~((uint32_t)0x00000800)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000800)) | ((uint32_t)timestampintmsk << 11));
}

__INLINE uint8_t bt_intcntl_finetgtintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000400)) >> 10);
}

__INLINE void bt_intcntl_finetgtintmsk_setf(uint8_t finetgtintmsk)
{
    ASSERT_ERR((((uint32_t)finetgtintmsk << 10) & ~((uint32_t)0x00000400)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000400)) | ((uint32_t)finetgtintmsk << 10));
}

__INLINE uint8_t bt_intcntl_grosstgtintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}

__INLINE void bt_intcntl_grosstgtintmsk_setf(uint8_t grosstgtintmsk)
{
    ASSERT_ERR((((uint32_t)grosstgtintmsk << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000200)) | ((uint32_t)grosstgtintmsk << 9));
}

__INLINE uint8_t bt_intcntl_errorintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}

__INLINE void bt_intcntl_errorintmsk_setf(uint8_t errorintmsk)
{
    ASSERT_ERR((((uint32_t)errorintmsk << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000100)) | ((uint32_t)errorintmsk << 8));
}

__INLINE uint8_t bt_intcntl_cryptintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}

__INLINE void bt_intcntl_cryptintmsk_setf(uint8_t cryptintmsk)
{
    ASSERT_ERR((((uint32_t)cryptintmsk << 7) & ~((uint32_t)0x00000080)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000080)) | ((uint32_t)cryptintmsk << 7));
}

__INLINE uint8_t bt_intcntl_skipfrmintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}

__INLINE void bt_intcntl_skipfrmintmsk_setf(uint8_t skipfrmintmsk)
{
    ASSERT_ERR((((uint32_t)skipfrmintmsk << 6) & ~((uint32_t)0x00000040)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000040)) | ((uint32_t)skipfrmintmsk << 6));
}

__INLINE uint8_t bt_intcntl_endfrmintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}

__INLINE void bt_intcntl_endfrmintmsk_setf(uint8_t endfrmintmsk)
{
    ASSERT_ERR((((uint32_t)endfrmintmsk << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000020)) | ((uint32_t)endfrmintmsk << 5));
}

__INLINE uint8_t bt_intcntl_startfrmintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}

__INLINE void bt_intcntl_startfrmintmsk_setf(uint8_t startfrmintmsk)
{
    ASSERT_ERR((((uint32_t)startfrmintmsk << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)startfrmintmsk << 4));
}

__INLINE uint8_t bt_intcntl_slpintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}

__INLINE void bt_intcntl_slpintmsk_setf(uint8_t slpintmsk)
{
    ASSERT_ERR((((uint32_t)slpintmsk << 3) & ~((uint32_t)0x00000008)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000008)) | ((uint32_t)slpintmsk << 3));
}

__INLINE uint8_t bt_intcntl_rxintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}

__INLINE void bt_intcntl_rxintmsk_setf(uint8_t rxintmsk)
{
    ASSERT_ERR((((uint32_t)rxintmsk << 2) & ~((uint32_t)0x00000004)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000004)) | ((uint32_t)rxintmsk << 2));
}

__INLINE uint8_t bt_intcntl_clknintmsk_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}

__INLINE void bt_intcntl_clknintmsk_setf(uint8_t clknintmsk)
{
    ASSERT_ERR((((uint32_t)clknintmsk << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_BT_WR(BT_INTCNTL_ADDR, (REG_BT_RD(BT_INTCNTL_ADDR) & ~((uint32_t)0x00000001)) | ((uint32_t)clknintmsk << 0));
}
 ...
 *     23        TXDONEINTSTAT   0
 *     22        RXDONEINTSTAT   0
 *     21	   RXHEADERINTSTAT   0
 *     20      MWSWCIRXINTSTAT   0
 *     19      MWSWCITXINTSTAT   0
 *     18        MTOFFINT1STAT   0
 *     17        MTOFFINT0STAT   0
 *     16        FRSYNCINTSTAT   0
 *     15        AUDIOINT2STAT   0
 ...
 *     06       SKIPFRMINTSTAT   0
 *     05        ENDFRMINTSTAT   0
 *     04      STARTFRMINTSTAT   0
 *     03           SLPINTSTAT   0
 *     02            RXINTSTAT   0
 *     00          CLKNINTSTAT   0
 * </pre>
 */
#define BT_INTSTAT_ADDR   (REG_BTCORE_BASE_ADDR + 0x10)
#define BT_INTSTAT_OFFSET 0x00000010
#define BT_INTSTAT_INDEX  0x00000004
#define BT_INTSTAT_RESET  0x00000000

__INLINE uint32_t bt_intstat_get(void)
{
    return REG_BT_RD(BT_INTSTAT_ADDR);
}

// field definitions
#define BT_TXDONEINTSTAT_BIT    ((uint32_t)0x00800000)
#define BT_TXDONEINTSTAT_POS    23
#define BT_RXDONEINTSTAT_BIT    ((uint32_t)0x00400000)
#define BT_RXDONEINTSTAT_POS    22
#define BT_RXHEADERINTSTAT_BIT  ((uint32_t)0x00200000)
#define BT_RXHEADERINTSTAT_POS  21


#define BT_MWSWCIRXINTSTAT_BIT  ((uint32_t)0x00100000)
#define BT_MWSWCIRXINTSTAT_POS  20
#define BT_MWSWCITXINTSTAT_BIT  ((uint32_t)0x00080000)
#define BT_MWSWCITXINTSTAT_POS  19
#define BT_MTOFFINT1STAT_BIT    ((uint32_t)0x00040000)
#define BT_MTOFFINT1STAT_POS    18
#define BT_MTOFFINT0STAT_BIT    ((uint32_t)0x00020000)
#define BT_MTOFFINT0STAT_POS    17
#define BT_FRSYNCINTSTAT_BIT    ((uint32_t)0x00010000)
#define BT_FRSYNCINTSTAT_POS    16
...
#define BT_SWINTSTAT_BIT        ((uint32_t)0x00001000)
#define BT_SWINTSTAT_POS        12
#define BT_TIMESTAMPINTSTAT_BIT ((uint32_t)0x00000800)
#define BT_TIMESTAMPINTSTAT_POS 11
#define BT_FINETGTINTSTAT_BIT   ((uint32_t)0x00000400)
#define BT_FINETGTINTSTAT_POS   10
#define BT_GROSSTGTINTSTAT_BIT  ((uint32_t)0x00000200)
#define BT_GROSSTGTINTSTAT_POS  9
#define BT_ERRORINTSTAT_BIT     ((uint32_t)0x00000100)
#define BT_ERRORINTSTAT_POS     8
#define BT_CRYPTINTSTAT_BIT     ((uint32_t)0x00000080)
#define BT_CRYPTINTSTAT_POS     7
#define BT_SKIPFRMINTSTAT_BIT   ((uint32_t)0x00000040)
#define BT_SKIPFRMINTSTAT_POS   6
#define BT_ENDFRMINTSTAT_BIT    ((uint32_t)0x00000020)
#define BT_ENDFRMINTSTAT_POS    5
#define BT_STARTFRMINTSTAT_BIT  ((uint32_t)0x00000010)
#define BT_STARTFRMINTSTAT_POS  4
#define BT_SLPINTSTAT_BIT       ((uint32_t)0x00000008)
#define BT_SLPINTSTAT_POS       3
#define BT_RXINTSTAT_BIT        ((uint32_t)0x00000004)
#define BT_RXINTSTAT_POS        2
...
#define BT_TIMESTAMPINTSTAT_RST 0x0
#define BT_FINETGTINTSTAT_RST   0x0
#define BT_GROSSTGTINTSTAT_RST  0x0
#define BT_ERRORINTSTAT_RST     0x0
#define BT_CRYPTINTSTAT_RST     0x0
#define BT_SKIPFRMINTSTAT_RST   0x0
#define BT_ENDFRMINTSTAT_RST    0x0
#define BT_STARTFRMINTSTAT_RST  0x0
#define BT_SLPINTSTAT_RST       0x0
#define BT_RXINTSTAT_RST        0x0
#define BT_CLKNINTSTAT_RST      0x0

__INLINE void bt_intstat_unpack(uint8_t *mwswcirxintstat, uint8_t *mwswcitxintstat, uint8_t *mtoffint1stat, uint8_t *mtoffint0stat, uint8_t *frsyncintstat, uint8_t *audioint2stat,
                                uint8_t *audioint1stat, uint8_t *audioint0stat, uint8_t *swintstat, uint8_t *timestampintstat, uint8_t *finetgtintstat, uint8_t *grosstgtintstat,
                                uint8_t *errorintstat, uint8_t *cryptintstat, uint8_t *skipfrmintstat, uint8_t *endfrmintstat, uint8_t *startfrmintstat, uint8_t *slpintstat,
                                uint8_t *rxintstat, uint8_t *clknintstat)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);

    *mwswcirxintstat  = (localVal & ((uint32_t)0x00100000)) >> 20;
    *mwswcitxintstat  = (localVal & ((uint32_t)0x00080000)) >> 19;
    *mtoffint1stat    = (localVal & ((uint32_t)0x00040000)) >> 18;
    *mtoffint0stat    = (localVal & ((uint32_t)0x00020000)) >> 17;
    *frsyncintstat    = (localVal & ((uint32_t)0x00010000)) >> 16;
    ...
    *skipfrmintstat   = (localVal & ((uint32_t)0x00000040)) >> 6;
    *endfrmintstat    = (localVal & ((uint32_t)0x00000020)) >> 5;
    *startfrmintstat  = (localVal & ((uint32_t)0x00000010)) >> 4;
...
__INLINE uint8_t bt_intstat_mwswcirxintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}

__INLINE uint8_t bt_intstat_mwswcitxintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00080000)) >> 19);
}

__INLINE uint8_t bt_intstat_mtoffint1stat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}

__INLINE uint8_t bt_intstat_mtoffint0stat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}

__INLINE uint8_t bt_intstat_frsyncintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}

__INLINE uint8_t bt_intstat_audioint2stat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00008000)) >> 15);
}

__INLINE uint8_t bt_intstat_audioint1stat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00004000)) >> 14);
}

__INLINE uint8_t bt_intstat_audioint0stat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00002000)) >> 13);
}

__INLINE uint8_t bt_intstat_swintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}

__INLINE uint8_t bt_intstat_timestampintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}

__INLINE uint8_t bt_intstat_finetgtintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000400)) >> 10);
}

__INLINE uint8_t bt_intstat_grosstgtintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}

__INLINE uint8_t bt_intstat_errorintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}

__INLINE uint8_t bt_intstat_cryptintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}

__INLINE uint8_t bt_intstat_skipfrmintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}

__INLINE uint8_t bt_intstat_endfrmintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}

__INLINE uint8_t bt_intstat_startfrmintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}

__INLINE uint8_t bt_intstat_slpintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}

__INLINE uint8_t bt_intstat_rxintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}

__INLINE uint8_t bt_intstat_clknintstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *     20   MWSWCIRXINTRAWSTAT   0
 *     19   MWSWCITXINTRAWSTAT   0
 *     18     MTOFFINT1RAWSTAT   0
 *     17     MTOFFINT0RAWSTAT   0
 *     16     FRSYNCINTRAWSTAT   0
 ...
 *     06    SKIPFRMINTRAWSTAT   0
 *     05     ENDFRMINTRAWSTAT   0
 *     04   STARTFRMINTRAWSTAT   0
 *     03        SLPINTRAWSTAT   0
 *     02         RXINTRAWSTAT   0
 *     00       CLKNINTRAWSTAT   0
 * </pre>
 */
#define BT_INTRAWSTAT_ADDR   (REG_BTCORE_BASE_ADDR + 0x14)
#define BT_INTRAWSTAT_OFFSET 0x00000014
#define BT_INTRAWSTAT_INDEX  0x00000005
#define BT_INTRAWSTAT_RESET  0x00000000

__INLINE uint32_t bt_intrawstat_get(void)
{
    return REG_BT_RD(BT_INTRAWSTAT_ADDR);
}

// field definitions
#define BT_MWSWCIRXINTRAWSTAT_BIT  ((uint32_t)0x00100000)
#define BT_MWSWCIRXINTRAWSTAT_POS  20
#define BT_MWSWCITXINTRAWSTAT_BIT  ((uint32_t)0x00080000)
#define BT_MWSWCITXINTRAWSTAT_POS  19
#define BT_MTOFFINT1RAWSTAT_BIT    ((uint32_t)0x00040000)
#define BT_MTOFFINT1RAWSTAT_POS    18
#define BT_MTOFFINT0RAWSTAT_BIT    ((uint32_t)0x00020000)
#define BT_MTOFFINT0RAWSTAT_POS    17
#define BT_FRSYNCINTRAWSTAT_BIT    ((uint32_t)0x00010000)
#define BT_FRSYNCINTRAWSTAT_POS    16
#define BT_AUDIOINT2RAWSTAT_BIT    ((uint32_t)0x00008000)
#define BT_AUDIOINT2RAWSTAT_POS    15
#define BT_AUDIOINT1RAWSTAT_BIT    ((uint32_t)0x00004000)
#define BT_AUDIOINT1RAWSTAT_POS    14
#define BT_AUDIOINT0RAWSTAT_BIT    ((uint32_t)0x00002000)
#define BT_AUDIOINT0RAWSTAT_POS    13
#define BT_SWINTRAWSTAT_BIT        ((uint32_t)0x00001000)
#define BT_SWINTRAWSTAT_POS        12
#define BT_TIMESTAMPINTRAWSTAT_BIT ((uint32_t)0x00000800)
#define BT_TIMESTAMPINTRAWSTAT_POS 11
#define BT_FINETGTINTRAWSTAT_BIT   ((uint32_t)0x00000400)
#define BT_FINETGTINTRAWSTAT_POS   10
#define BT_GROSSTGTINTRAWSTAT_BIT  ((uint32_t)0x00000200)
#define BT_GROSSTGTINTRAWSTAT_POS  9
#define BT_ERRORINTRAWSTAT_BIT     ((uint32_t)0x00000100)
#define BT_ERRORINTRAWSTAT_POS     8
#define BT_CRYPTINTRAWSTAT_BIT     ((uint32_t)0x00000080)
#define BT_CRYPTINTRAWSTAT_POS     7
#define BT_SKIPFRMINTRAWSTAT_BIT   ((uint32_t)0x00000040)
#define BT_SKIPFRMINTRAWSTAT_POS   6
#define BT_ENDFRMINTRAWSTAT_BIT    ((uint32_t)0x00000020)
#define BT_ENDFRMINTRAWSTAT_POS    5
#define BT_STARTFRMINTRAWSTAT_BIT  ((uint32_t)0x00000010)
#define BT_STARTFRMINTRAWSTAT_POS  4
#define BT_SLPINTRAWSTAT_BIT       ((uint32_t)0x00000008)
#define BT_SLPINTRAWSTAT_POS       3
#define BT_RXINTRAWSTAT_BIT        ((uint32_t)0x00000004)
#define BT_RXINTRAWSTAT_POS        2
#define BT_CLKNINTRAWSTAT_BIT      ((uint32_t)0x00000001)
#define BT_CLKNINTRAWSTAT_POS      0

#define BT_MWSWCIRXINTRAWSTAT_RST  0x0
#define BT_MWSWCITXINTRAWSTAT_RST  0x0
#define BT_MTOFFINT1RAWSTAT_RST    0x0
#define BT_MTOFFINT0RAWSTAT_RST    0x0
#define BT_FRSYNCINTRAWSTAT_RST    0x0
#define BT_AUDIOINT2RAWSTAT_RST    0x0
#define BT_AUDIOINT1RAWSTAT_RST    0x0
#define BT_AUDIOINT0RAWSTAT_RST    0x0
#define BT_SWINTRAWSTAT_RST        0x0
#define BT_TIMESTAMPINTRAWSTAT_RST 0x0
#define BT_FINETGTINTRAWSTAT_RST   0x0
#define BT_GROSSTGTINTRAWSTAT_RST  0x0
#define BT_ERRORINTRAWSTAT_RST     0x0
#define BT_CRYPTINTRAWSTAT_RST     0x0
#define BT_SKIPFRMINTRAWSTAT_RST   0x0
#define BT_ENDFRMINTRAWSTAT_RST    0x0
#define BT_STARTFRMINTRAWSTAT_RST  0x0
#define BT_SLPINTRAWSTAT_RST       0x0
#define BT_RXINTRAWSTAT_RST        0x0
#define BT_CLKNINTRAWSTAT_RST      0x0

__INLINE void bt_intrawstat_unpack(uint8_t *mwswcirxintrawstat, uint8_t *mwswcitxintrawstat, uint8_t *mtoffint1rawstat, uint8_t *mtoffint0rawstat, uint8_t *frsyncintrawstat,
                                   uint8_t *audioint2rawstat, uint8_t *audioint1rawstat, uint8_t *audioint0rawstat, uint8_t *swintrawstat, uint8_t *timestampintrawstat,
                                   uint8_t *finetgtintrawstat, uint8_t *grosstgtintrawstat, uint8_t *errorintrawstat, uint8_t *cryptintrawstat, uint8_t *skipfrmintrawstat,
                                   uint8_t *endfrmintrawstat, uint8_t *startfrmintrawstat, uint8_t *slpintrawstat, uint8_t *rxintrawstat, uint8_t *clknintrawstat)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);

    *mwswcirxintrawstat  = (localVal & ((uint32_t)0x00100000)) >> 20;
    *mwswcitxintrawstat  = (localVal & ((uint32_t)0x00080000)) >> 19;
    *mtoffint1rawstat    = (localVal & ((uint32_t)0x00040000)) >> 18;
    *mtoffint0rawstat    = (localVal & ((uint32_t)0x00020000)) >> 17;
    *frsyncintrawstat    = (localVal & ((uint32_t)0x00010000)) >> 16;
    ...
    *skipfrmintrawstat   = (localVal & ((uint32_t)0x00000040)) >> 6;
    *endfrmintrawstat    = (localVal & ((uint32_t)0x00000020)) >> 5;
    *startfrmintrawstat  = (localVal & ((uint32_t)0x00000010)) >> 4;
...
__INLINE uint8_t bt_intrawstat_mwswcirxintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}

__INLINE uint8_t bt_intrawstat_mwswcitxintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00080000)) >> 19);
}

__INLINE uint8_t bt_intrawstat_mtoffint1rawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}

__INLINE uint8_t bt_intrawstat_mtoffint0rawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}

__INLINE uint8_t bt_intrawstat_frsyncintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}

__INLINE uint8_t bt_intrawstat_audioint2rawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00008000)) >> 15);
}

__INLINE uint8_t bt_intrawstat_audioint1rawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00004000)) >> 14);
}

__INLINE uint8_t bt_intrawstat_audioint0rawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00002000)) >> 13);
}

__INLINE uint8_t bt_intrawstat_swintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}

__INLINE uint8_t bt_intrawstat_timestampintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}

__INLINE uint8_t bt_intrawstat_finetgtintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000400)) >> 10);
}

__INLINE uint8_t bt_intrawstat_grosstgtintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}

__INLINE uint8_t bt_intrawstat_errorintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}

__INLINE uint8_t bt_intrawstat_cryptintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}

__INLINE uint8_t bt_intrawstat_skipfrmintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}

__INLINE uint8_t bt_intrawstat_endfrmintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}

__INLINE uint8_t bt_intrawstat_startfrmintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}

__INLINE uint8_t bt_intrawstat_slpintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}

__INLINE uint8_t bt_intrawstat_rxintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}

__INLINE uint8_t bt_intrawstat_clknintrawstat_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTRAWSTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
 ...
 * </pre>
 */
#define BT_INTACK_ADDR   (REG_BTCORE_BASE_ADDR + 0x18)
#define BT_INTACK_OFFSET 0x00000018
#define BT_INTACK_INDEX  0x00000006
#define BT_INTACK_RESET  0x00000000

__INLINE uint32_t bt_intack_get(void)
{
    return REG_BT_RD(BT_INTACK_ADDR);
}

__INLINE void bt_intack_clear(uint32_t value)
{
    REG_BT_WR(BT_INTACK_ADDR, value);
}

// field definitions
#define BT_MWSWCIRXINTACK_BIT  ((uint32_t)0x00100000)
#define BT_MWSWCIRXINTACK_POS  20
#define BT_MWSWCITXINTACK_BIT  ((uint32_t)0x00080000)
#define BT_MWSWCITXINTACK_POS  19
#define BT_MTOFFINT1ACK_BIT    ((uint32_t)0x00040000)
#define BT_MTOFFINT1ACK_POS    18
#define BT_MTOFFINT0ACK_BIT    ((uint32_t)0x00020000)
#define BT_MTOFFINT0ACK_POS    17
#define BT_FRSYNCINTACK_BIT    ((uint32_t)0x00010000)
#define BT_FRSYNCINTACK_POS    16
...
#define BT_SWINTACK_BIT        ((uint32_t)0x00001000)
#define BT_SWINTACK_POS        12
#define BT_TIMESTAMPINTACK_BIT ((uint32_t)0x00000800)
#define BT_TIMESTAMPINTACK_POS 11
#define BT_FINETGTINTACK_BIT   ((uint32_t)0x00000400)
#define BT_FINETGTINTACK_POS   10
#define BT_GROSSTGTINTACK_BIT  ((uint32_t)0x00000200)
#define BT_GROSSTGTINTACK_POS  9
#define BT_ERRORINTACK_BIT     ((uint32_t)0x00000100)
#define BT_ERRORINTACK_POS     8
#define BT_CRYPTINTACK_BIT     ((uint32_t)0x00000080)
#define BT_CRYPTINTACK_POS     7
#define BT_SKIPFRMINTACK_BIT   ((uint32_t)0x00000040)
#define BT_SKIPFRMINTACK_POS   6
#define BT_ENDFRMINTACK_BIT    ((uint32_t)0x00000020)
#define BT_ENDFRMINTACK_POS    5
#define BT_STARTFRMINTACK_BIT  ((uint32_t)0x00000010)
#define BT_STARTFRMINTACK_POS  4
#define BT_SLPINTACK_BIT       ((uint32_t)0x00000008)
#define BT_SLPINTACK_POS       3
#define BT_RXINTACK_BIT        ((uint32_t)0x00000004)
#define BT_RXINTACK_POS        2
...
#define BT_TIMESTAMPINTACK_RST 0x0
#define BT_FINETGTINTACK_RST   0x0
#define BT_GROSSTGTINTACK_RST  0x0
#define BT_ERRORINTACK_RST     0x0
#define BT_CRYPTINTACK_RST     0x0
#define BT_SKIPFRMINTACK_RST   0x0
#define BT_ENDFRMINTACK_RST    0x0
#define BT_STARTFRMINTACK_RST  0x0
#define BT_SLPINTACK_RST       0x0
#define BT_RXINTACK_RST        0x0
#define BT_CLKNINTACK_RST      0x0

__INLINE void bt_intack_pack(uint8_t mwswcirxintack, uint8_t mwswcitxintack, uint8_t mtoffint1ack, uint8_t mtoffint0ack, uint8_t frsyncintack, uint8_t audioint2ack,
                             uint8_t audioint1ack, uint8_t audioint0ack, uint8_t swintack, uint8_t timestampintack, uint8_t finetgtintack, uint8_t grosstgtintack,
                             uint8_t errorintack, uint8_t cryptintack, uint8_t skipfrmintack, uint8_t endfrmintack, uint8_t startfrmintack, uint8_t slpintack, uint8_t rxintack,
                             uint8_t clknintack)
{
    ASSERT_ERR((((uint32_t)mwswcirxintack << 20) & ~((uint32_t)0x00100000)) == 0);
    ASSERT_ERR((((uint32_t)mwswcitxintack << 19) & ~((uint32_t)0x00080000)) == 0);
    ASSERT_ERR((((uint32_t)mtoffint1ack << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)mtoffint0ack << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)frsyncintack << 16) & ~((uint32_t)0x00010000)) == 0);
    ...
    ASSERT_ERR((((uint32_t)skipfrmintack << 6) & ~((uint32_t)0x00000040)) == 0);
    ASSERT_ERR((((uint32_t)endfrmintack << 5) & ~((uint32_t)0x00000020)) == 0);
    ASSERT_ERR((((uint32_t)startfrmintack << 4) & ~((uint32_t)0x00000010)) == 0);
    ...
    REG_BT_WR(BT_INTACK_ADDR, ((uint32_t)mwswcirxintack << 20) | ((uint32_t)mwswcitxintack << 19) | ((uint32_t)mtoffint1ack << 18) | ((uint32_t)mtoffint0ack << 17) |
                                  ((uint32_t)frsyncintack << 16) | ((uint32_t)audioint2ack << 15) | ((uint32_t)audioint1ack << 14) | ((uint32_t)audioint0ack << 13) |
                                  ((uint32_t)swintack << 12) | ((uint32_t)timestampintack << 11) | ((uint32_t)finetgtintack << 10) | ((uint32_t)grosstgtintack << 9) |
                                  ((uint32_t)errorintack << 8) | ((uint32_t)cryptintack << 7) | ((uint32_t)skipfrmintack << 6) | ((uint32_t)endfrmintack << 5) |
                                  ((uint32_t)startfrmintack << 4) | ((uint32_t)slpintack << 3) | ((uint32_t)rxintack << 2) | ((uint32_t)clknintack << 0));
}

__INLINE void bt_intack_unpack(uint8_t *mwswcirxintack, uint8_t *mwswcitxintack, uint8_t *mtoffint1ack, uint8_t *mtoffint0ack, uint8_t *frsyncintack, uint8_t *audioint2ack,
                               uint8_t *audioint1ack, uint8_t *audioint0ack, uint8_t *swintack, uint8_t *timestampintack, uint8_t *finetgtintack, uint8_t *grosstgtintack,
                               uint8_t *errorintack, uint8_t *cryptintack, uint8_t *skipfrmintack, uint8_t *endfrmintack, uint8_t *startfrmintack, uint8_t *slpintack,
                               uint8_t *rxintack, uint8_t *clknintack)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);

    *mwswcirxintack  = (localVal & ((uint32_t)0x00100000)) >> 20;
    *mwswcitxintack  = (localVal & ((uint32_t)0x00080000)) >> 19;
    *mtoffint1ack    = (localVal & ((uint32_t)0x00040000)) >> 18;
    *mtoffint0ack    = (localVal & ((uint32_t)0x00020000)) >> 17;
    *frsyncintack    = (localVal & ((uint32_t)0x00010000)) >> 16;
    ...
    *skipfrmintack   = (localVal & ((uint32_t)0x00000040)) >> 6;
    *endfrmintack    = (localVal & ((uint32_t)0x00000020)) >> 5;
    *startfrmintack  = (localVal & ((uint32_t)0x00000010)) >> 4;
    *slpintack       = (localVal & ((uint32_t)0x00000008)) >> 3;
    *rxintack        = (localVal & ((uint32_t)0x00000004)) >> 2;
    *clknintack      = (localVal & ((uint32_t)0x00000001)) >> 0;
}

__INLINE uint8_t bt_intack_txdoneintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00800000)) >> 23);
}

__INLINE void bt_intack_txdoneintack_clearf(uint8_t txdoneintack)
{
    ASSERT_ERR((((uint32_t)txdoneintack << 23) & ~((uint32_t)0x00800000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)txdoneintack << 23);
}

__INLINE uint8_t bt_intack_rxdoneintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00400000)) >> 22);
}

__INLINE void bt_intack_rxdoneintack_clearf(uint8_t rxdoneintack)
{
    ASSERT_ERR((((uint32_t)rxdoneintack << 22) & ~((uint32_t)0x00400000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)rxdoneintack << 22);
}

__INLINE uint8_t bt_intack_rxheaderintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00200000)) >> 21);
}

__INLINE void bt_intack_rxheaderintack_clearf(uint8_t rxheaderintack)
{
    ASSERT_ERR((((uint32_t)rxheaderintack << 21) & ~((uint32_t)0x00200000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)rxheaderintack << 21);
}

__INLINE uint8_t bt_intack_mwswcirxintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00100000)) >> 20);
}

__INLINE void bt_intack_mwswcirxintack_clearf(uint8_t mwswcirxintack)
{
    ASSERT_ERR((((uint32_t)mwswcirxintack << 20) & ~((uint32_t)0x00100000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)mwswcirxintack << 20);
}

__INLINE uint8_t bt_intack_mwswcitxintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00080000)) >> 19);
}

__INLINE void bt_intack_mwswcitxintack_clearf(uint8_t mwswcitxintack)
{
    ASSERT_ERR((((uint32_t)mwswcitxintack << 19) & ~((uint32_t)0x00080000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)mwswcitxintack << 19);
}

__INLINE uint8_t bt_intack_mtoffint1ack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}

__INLINE void bt_intack_mtoffint1ack_clearf(uint8_t mtoffint1ack)
{
    ASSERT_ERR((((uint32_t)mtoffint1ack << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)mtoffint1ack << 18);
}

__INLINE uint8_t bt_intack_mtoffint0ack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00020000)) >> 17);
}

__INLINE void bt_intack_mtoffint0ack_clearf(uint8_t mtoffint0ack)
{
    ASSERT_ERR((((uint32_t)mtoffint0ack << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)mtoffint0ack << 17);
}

__INLINE uint8_t bt_intack_frsyncintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}

__INLINE void bt_intack_frsyncintack_clearf(uint8_t frsyncintack)
{
    ASSERT_ERR((((uint32_t)frsyncintack << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)frsyncintack << 16);
}

__INLINE uint8_t bt_intack_audioint2ack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00008000)) >> 15);
}

__INLINE void bt_intack_audioint2ack_clearf(uint8_t audioint2ack)
{
    ASSERT_ERR((((uint32_t)audioint2ack << 15) & ~((uint32_t)0x00008000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)audioint2ack << 15);
}

__INLINE uint8_t bt_intack_audioint1ack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00004000)) >> 14);
}

__INLINE void bt_intack_audioint1ack_clearf(uint8_t audioint1ack)
{
    ASSERT_ERR((((uint32_t)audioint1ack << 14) & ~((uint32_t)0x00004000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)audioint1ack << 14);
}

__INLINE uint8_t bt_intack_audioint0ack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00002000)) >> 13);
}

__INLINE void bt_intack_audioint0ack_clearf(uint8_t audioint0ack)
{
    ASSERT_ERR((((uint32_t)audioint0ack << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)audioint0ack << 13);
}

__INLINE uint8_t bt_intack_swintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00001000)) >> 12);
}

__INLINE void bt_intack_swintack_clearf(uint8_t swintack)
{
    ASSERT_ERR((((uint32_t)swintack << 12) & ~((uint32_t)0x00001000)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)swintack << 12);
}

__INLINE uint8_t bt_intack_timestampintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000800)) >> 11);
}

__INLINE void bt_intack_timestampintack_clearf(uint8_t timestampintack)
{
    ASSERT_ERR((((uint32_t)timestampintack << 11) & ~((uint32_t)0x00000800)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)timestampintack << 11);
}

__INLINE uint8_t bt_intack_finetgtintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000400)) >> 10);
}

__INLINE void bt_intack_finetgtintack_clearf(uint8_t finetgtintack)
{
    ASSERT_ERR((((uint32_t)finetgtintack << 10) & ~((uint32_t)0x00000400)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)finetgtintack << 10);
}

__INLINE uint8_t bt_intack_grosstgtintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}

__INLINE void bt_intack_grosstgtintack_clearf(uint8_t grosstgtintack)
{
    ASSERT_ERR((((uint32_t)grosstgtintack << 9) & ~((uint32_t)0x00000200)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)grosstgtintack << 9);
}

__INLINE uint8_t bt_intack_errorintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}

__INLINE void bt_intack_errorintack_clearf(uint8_t errorintack)
{
    ASSERT_ERR((((uint32_t)errorintack << 8) & ~((uint32_t)0x00000100)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)errorintack << 8);
}

__INLINE uint8_t bt_intack_cryptintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}

__INLINE void bt_intack_cryptintack_clearf(uint8_t cryptintack)
{
    ASSERT_ERR((((uint32_t)cryptintack << 7) & ~((uint32_t)0x00000080)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)cryptintack << 7);
}

__INLINE uint8_t bt_intack_skipfrmintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}

__INLINE void bt_intack_skipfrmintack_clearf(uint8_t skipfrmintack)
{
    ASSERT_ERR((((uint32_t)skipfrmintack << 6) & ~((uint32_t)0x00000040)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)skipfrmintack << 6);
}

__INLINE uint8_t bt_intack_endfrmintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}

__INLINE void bt_intack_endfrmintack_clearf(uint8_t endfrmintack)
{
    ASSERT_ERR((((uint32_t)endfrmintack << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)endfrmintack << 5);
}

__INLINE uint8_t bt_intack_startfrmintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}

__INLINE void bt_intack_startfrmintack_clearf(uint8_t startfrmintack)
{
    ASSERT_ERR((((uint32_t)startfrmintack << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)startfrmintack << 4);
}

__INLINE uint8_t bt_intack_slpintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}

__INLINE void bt_intack_slpintack_clearf(uint8_t slpintack)
{
    ASSERT_ERR((((uint32_t)slpintack << 3) & ~((uint32_t)0x00000008)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)slpintack << 3);
}

__INLINE uint8_t bt_intack_rxintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}

__INLINE void bt_intack_rxintack_clearf(uint8_t rxintack)
{
    ASSERT_ERR((((uint32_t)rxintack << 2) & ~((uint32_t)0x00000004)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)rxintack << 2);
}

__INLINE uint8_t bt_intack_clknintack_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_INTACK_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}

__INLINE void bt_intack_clknintack_clearf(uint8_t clknintack)
{
    ASSERT_ERR((((uint32_t)clknintack << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_BT_WR(BT_INTACK_ADDR, (uint32_t)clknintack << 0);
}
 ...
 * </pre>
 */
#define BT_SLOTCLK_ADDR   (REG_BTCORE_BASE_ADDR + 0x1C)
#define BT_SLOTCLK_OFFSET 0x0000001C
#define BT_SLOTCLK_INDEX  0x00000007
 ...
 * </pre>
 */
#define BT_FINETIMECNT_ADDR   (REG_BTCORE_BASE_ADDR + 0x20)
#define BT_FINETIMECNT_OFFSET 0x00000020
#define BT_FINETIMECNT_INDEX  0x00000008
 ...
 * </pre>
 */
#define BT_ABTRAINCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x24)
#define BT_ABTRAINCNTL_OFFSET 0x00000024
#define BT_ABTRAINCNTL_INDEX  0x00000009
...
__INLINE void bt_abtraincntl_pack(uint8_t abtpageen, uint8_t abtpagestartvalue, uint8_t abtpageload, uint16_t abtpagetime, uint8_t abtinqen, uint8_t abtinqstartvalue,
                                  uint8_t abtinqload, uint16_t abtinqtime)
{
    ...
    REG_BT_WR(BT_ABTRAINCNTL_ADDR, ((uint32_t)abtpageen << 31) | ((uint32_t)abtpagestartvalue << 30) | ((uint32_t)abtpageload << 28) | ((uint32_t)abtpagetime << 16) |
                                       ((uint32_t)abtinqen << 15) | ((uint32_t)abtinqstartvalue << 14) | ((uint32_t)abtinqload << 12) | ((uint32_t)abtinqtime << 0));
}

__INLINE void bt_abtraincntl_unpack(uint8_t *abtpageen, uint8_t *abtpagestartvalue, uint8_t *abtpageload, uint16_t *abtpagetime, uint8_t *abtinqen, uint8_t *abtinqstartvalue,
                                    uint8_t *abtinqload, uint16_t *abtinqtime)
{
 ...
 * </pre>
 */
#define BT_EDRCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x28)
#define BT_EDRCNTL_OFFSET 0x00000028
#define BT_EDRCNTL_INDEX  0x0000000A
...
__INLINE void bt_edrcntl_pack(uint8_t txrateswinstant, uint8_t edrbcast, uint8_t rxswap, uint8_t txswap, uint8_t guardbandtime, uint8_t rxguarddsb, uint8_t gbtxqualgendsb,
                              uint8_t rxgrdtimeout)
{
    ...
    REG_BT_WR(BT_EDRCNTL_ADDR, ((uint32_t)txrateswinstant << 16) | ((uint32_t)edrbcast << 15) | ((uint32_t)rxswap << 13) | ((uint32_t)txswap << 12) |
                                   ((uint32_t)guardbandtime << 8) | ((uint32_t)rxguarddsb << 7) | ((uint32_t)gbtxqualgendsb << 6) | ((uint32_t)rxgrdtimeout << 0));
}

__INLINE void bt_edrcntl_unpack(uint8_t *txrateswinstant, uint8_t *edrbcast, uint8_t *rxswap, uint8_t *txswap, uint8_t *guardbandtime, uint8_t *rxguarddsb, uint8_t *gbtxqualgendsb,
                                uint8_t *rxgrdtimeout)
{
 ...
 * </pre>
 */
#define BT_ET_CURRENTRXDESCPTR_ADDR   (REG_BTCORE_BASE_ADDR + 0x2C)
#define BT_ET_CURRENTRXDESCPTR_OFFSET 0x0000002C
#define BT_ET_CURRENTRXDESCPTR_INDEX  0x0000000B
#define BT_ET_CURRENTRXDESCPTR_RESET  0x00000000

__INLINE uint32_t bt_et_currentrxdescptr_get(void)
{
    return REG_BT_RD(BT_ET_CURRENTRXDESCPTR_ADDR);
}

__INLINE void bt_et_currentrxdescptr_set(uint32_t value)
{
    REG_BT_WR(BT_ET_CURRENTRXDESCPTR_ADDR, value);
}

// field definitions
#define BT_ETPTR_MASK             ((uint32_t)0xFFFF0000)
#define BT_ETPTR_LSB              16
#define BT_ETPTR_WIDTH            ((uint32_t)0x00000010)
#define BT_CURRENTRXDESCPTR_MASK  ((uint32_t)0x00007FFF)
#define BT_CURRENTRXDESCPTR_LSB   0
#define BT_CURRENTRXDESCPTR_WIDTH ((uint32_t)0x0000000F)

#define BT_ETPTR_RST              0x0
#define BT_CURRENTRXDESCPTR_RST   0x0

__INLINE void bt_et_currentrxdescptr_pack(uint16_t etptr, uint16_t currentrxdescptr)
{
    ASSERT_ERR((((uint32_t)etptr << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)currentrxdescptr << 0) & ~((uint32_t)0x00007FFF)) == 0);
    REG_BT_WR(BT_ET_CURRENTRXDESCPTR_ADDR, ((uint32_t)etptr << 16) | ((uint32_t)currentrxdescptr << 0));
}

__INLINE void bt_et_currentrxdescptr_unpack(uint16_t *etptr, uint16_t *currentrxdescptr)
{
    uint32_t localVal = REG_BT_RD(BT_ET_CURRENTRXDESCPTR_ADDR);

    *etptr            = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *currentrxdescptr = (localVal & ((uint32_t)0x00007FFF)) >> 0;
}

__INLINE uint16_t bt_et_currentrxdescptr_etptr_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_ET_CURRENTRXDESCPTR_ADDR);
    return ((localVal & ((uint32_t)0xFFFF0000)) >> 16);
}

__INLINE void bt_et_currentrxdescptr_etptr_setf(uint16_t etptr)
{
    ASSERT_ERR((((uint32_t)etptr << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_ET_CURRENTRXDESCPTR_ADDR, (REG_BT_RD(BT_ET_CURRENTRXDESCPTR_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)etptr << 16));
}

__INLINE uint16_t bt_et_currentrxdescptr_currentrxdescptr_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_ET_CURRENTRXDESCPTR_ADDR);
    return ((localVal & ((uint32_t)0x00007FFF)) >> 0);
}

__INLINE void bt_et_currentrxdescptr_currentrxdescptr_setf(uint16_t currentrxdescptr)
{
    ASSERT_ERR((((uint32_t)currentrxdescptr << 0) & ~((uint32_t)0x00007FFF)) == 0);
    REG_BT_WR(BT_ET_CURRENTRXDESCPTR_ADDR, (REG_BT_RD(BT_ET_CURRENTRXDESCPTR_ADDR) & ~((uint32_t)0x00007FFF)) | ((uint32_t)currentrxdescptr << 0));
}
 ...
 * </pre>
 */
#define BT_DEEPSLCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x30)
...
#define BT_SOFT_WAKEUP_REQ_BIT    ((uint32_t)0x00000010)
#define BT_SOFT_WAKEUP_REQ_POS    4
...
#define BT_SOFT_WAKEUP_REQ_RST    0x0
...
__INLINE void bt_deepslcntl_pack(uint8_t extwkupdsb, uint8_t softwakeupreq, uint8_t deepsleepcorren, uint8_t deepsleepon, uint8_t radiosleepen, uint8_t oscsleepen)
{
    ...
    REG_BT_WR(BT_DEEPSLCNTL_ADDR, ((uint32_t)extwkupdsb << 31) | ((uint32_t)softwakeupreq << 4) | ((uint32_t)deepsleepcorren << 3) | ((uint32_t)deepsleepon << 2) |
                                      ((uint32_t)radiosleepen << 1) | ((uint32_t)oscsleepen << 0));
}

__INLINE void bt_deepslcntl_unpack(uint8_t *extwkupdsb, uint8_t *deepsleepstat, uint8_t *softwakeupreq, uint8_t *deepsleepcorren, uint8_t *deepsleepon, uint8_t *radiosleepen,
                                   uint8_t *oscsleepen)
{
...
__INLINE uint8_t bt_deepslcntl_soft_wakeup_req_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_DEEPSLCNTL_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}

__INLINE void bt_deepslcntl_soft_wakeup_req_setf(uint8_t softwakeupreq)
{
    ASSERT_ERR((((uint32_t)softwakeupreq << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_BT_WR(BT_DEEPSLCNTL_ADDR, (REG_BT_RD(BT_DEEPSLCNTL_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)softwakeupreq << 4));
}
 ...
 * </pre>
 */
#define BT_DEEPSLWKUP_ADDR   (REG_BTCORE_BASE_ADDR + 0x34)
 ...
 * </pre>
 */
#define BT_DEEPSLSTAT_ADDR   (REG_BTCORE_BASE_ADDR + 0x38)
 ...
 * </pre>
 */
#define BT_ENBPRESET_ADDR   (REG_BTCORE_BASE_ADDR + 0x3C)
 ...
 * </pre>
 */
#define BT_FINECNTCORR_ADDR   (REG_BTCORE_BASE_ADDR + 0x40)
 ...
 * </pre>
 */
#define BT_CLKNCNTCORR_ADDR   (REG_BTCORE_BASE_ADDR + 0x44)
...
__INLINE void bt_diagcntl_pack(uint8_t diag3en, uint8_t diag3, uint8_t diag2en, uint8_t diag2, uint8_t diag1en, uint8_t diag1, uint8_t diag0en, uint8_t diag0)
{
    ...
    REG_BT_WR(BT_DIAGCNTL_ADDR, ((uint32_t)diag3en << 31) | ((uint32_t)diag3 << 24) | ((uint32_t)diag2en << 23) | ((uint32_t)diag2 << 16) | ((uint32_t)diag1en << 15) |
                                    ((uint32_t)diag1 << 8) | ((uint32_t)diag0en << 7) | ((uint32_t)diag0 << 0));
}
 ...
 * </pre>
 */
#define BT_DIAGSTAT_ADDR   (REG_BTCORE_BASE_ADDR + 0x54)
 ...
 * </pre>
 */
#define BT_DEBUGADDMAX_ADDR   (REG_BTCORE_BASE_ADDR + 0x58)
 ...
 * </pre>
 */
#define BT_DEBUGADDMIN_ADDR   (REG_BTCORE_BASE_ADDR + 0x5C)
 ...
 *     09   FRM_SCHDL_APFM_ERROR   0
 *     08   FRM_SCHDL_ENTRY_ERROR   0
 ...
 * </pre>
 */
#define BT_ERRORTYPESTAT_ADDR   (REG_BTCORE_BASE_ADDR + 0x60)
...
// field definitions
#define BT_SAM_ERROR_BIT             ((uint32_t)0x00200000)
#define BT_SAM_ERROR_POS             21
...
#define BT_FRM_SCHDL_APFM_ERROR_BIT  ((uint32_t)0x00000200)
#define BT_FRM_SCHDL_APFM_ERROR_POS  9
#define BT_FRM_SCHDL_ENTRY_ERROR_BIT ((uint32_t)0x00000100)
#define BT_FRM_SCHDL_ENTRY_ERROR_POS 8
...
#define BT_FRM_SCHDL_APFM_ERROR_RST  0x0
#define BT_FRM_SCHDL_ENTRY_ERROR_RST 0x0
...
__INLINE void bt_errortypestat_unpack(uint8_t *samerror, uint8_t *rxbufptrerror, uint8_t *txbufptrerror, uint8_t *rxdescemptyerror, uint8_t *txdescemptyerror,
                                      uint8_t *csattnberror, uint8_t *csformaterror, uint8_t *chmaperror, uint8_t *hopunderrunerror, uint8_t *frmcntltimererror,
                                      uint8_t *frmcntlemaccerror, uint8_t *frmcntlapfmerror, uint8_t *frmschdlapfmerror, uint8_t *frmschdlentryerror, uint8_t *mwscoexemaccerror,
                                      uint8_t *pcmemaccerror, uint8_t *audioemaccerror, uint8_t *radiocntlemaccerror, uint8_t *pktcntlemaccerror, uint8_t *cryptmodeerror,
                                      uint8_t *rxcrypterror, uint8_t *txcrypterror)
{
    uint32_t localVal = REG_BT_RD(BT_ERRORTYPESTAT_ADDR);

    *samerror            = (localVal & ((uint32_t)0x00200000)) >> 21;
    ...
    *frmschdlapfmerror   = (localVal & ((uint32_t)0x00000200)) >> 9;
    *frmschdlentryerror  = (localVal & ((uint32_t)0x00000100)) >> 8;
...
__INLINE uint8_t bt_errortypestat_sam_error_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_ERRORTYPESTAT_ADDR);
    return ((localVal & ((uint32_t)0x00200000)) >> 21);
}
...
__INLINE uint8_t bt_errortypestat_frm_schdl_apfm_error_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_ERRORTYPESTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}

__INLINE uint8_t bt_errortypestat_frm_schdl_entry_error_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_ERRORTYPESTAT_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}
 ...
 * </pre>
 */
#define BT_SWPROFILING_ADDR   (REG_BTCORE_BASE_ADDR + 0x64)
...
__INLINE void bt_swprofiling_pack(uint8_t swprof31, uint8_t swprof30, uint8_t swprof29, uint8_t swprof28, uint8_t swprof27, uint8_t swprof26, uint8_t swprof25, uint8_t swprof24,
                                  uint8_t swprof23, uint8_t swprof22, uint8_t swprof21, uint8_t swprof20, uint8_t swprof19, uint8_t swprof18, uint8_t swprof17, uint8_t swprof16,
                                  uint8_t swprof15, uint8_t swprof14, uint8_t swprof13, uint8_t swprof12, uint8_t swprof11, uint8_t swprof10, uint8_t swprof9, uint8_t swprof8,
                                  uint8_t swprof7, uint8_t swprof6, uint8_t swprof5, uint8_t swprof4, uint8_t swprof3, uint8_t swprof2, uint8_t swprof1, uint8_t swprof0)
{
    ...
    REG_BT_WR(BT_SWPROFILING_ADDR, ((uint32_t)swprof31 << 31) | ((uint32_t)swprof30 << 30) | ((uint32_t)swprof29 << 29) | ((uint32_t)swprof28 << 28) | ((uint32_t)swprof27 << 27) |
                                       ((uint32_t)swprof26 << 26) | ((uint32_t)swprof25 << 25) | ((uint32_t)swprof24 << 24) | ((uint32_t)swprof23 << 23) |
                                       ((uint32_t)swprof22 << 22) | ((uint32_t)swprof21 << 21) | ((uint32_t)swprof20 << 20) | ((uint32_t)swprof19 << 19) |
                                       ((uint32_t)swprof18 << 18) | ((uint32_t)swprof17 << 17) | ((uint32_t)swprof16 << 16) | ((uint32_t)swprof15 << 15) |
                                       ((uint32_t)swprof14 << 14) | ((uint32_t)swprof13 << 13) | ((uint32_t)swprof12 << 12) | ((uint32_t)swprof11 << 11) |
                                       ((uint32_t)swprof10 << 10) | ((uint32_t)swprof9 << 9) | ((uint32_t)swprof8 << 8) | ((uint32_t)swprof7 << 7) | ((uint32_t)swprof6 << 6) |
                                       ((uint32_t)swprof5 << 5) | ((uint32_t)swprof4 << 4) | ((uint32_t)swprof3 << 3) | ((uint32_t)swprof2 << 2) | ((uint32_t)swprof1 << 1) |
                                       ((uint32_t)swprof0 << 0));
}

__INLINE void bt_swprofiling_unpack(uint8_t *swprof31, uint8_t *swprof30, uint8_t *swprof29, uint8_t *swprof28, uint8_t *swprof27, uint8_t *swprof26, uint8_t *swprof25,
                                    uint8_t *swprof24, uint8_t *swprof23, uint8_t *swprof22, uint8_t *swprof21, uint8_t *swprof20, uint8_t *swprof19, uint8_t *swprof18,
                                    uint8_t *swprof17, uint8_t *swprof16, uint8_t *swprof15, uint8_t *swprof14, uint8_t *swprof13, uint8_t *swprof12, uint8_t *swprof11,
                                    uint8_t *swprof10, uint8_t *swprof9, uint8_t *swprof8, uint8_t *swprof7, uint8_t *swprof6, uint8_t *swprof5, uint8_t *swprof4, uint8_t *swprof3,
                                    uint8_t *swprof2, uint8_t *swprof1, uint8_t *swprof0)
{
 ...
 * </pre>
 */
#define BT_RADIOCNTL0_ADDR   (REG_BTCORE_BASE_ADDR + 0x70)
...
// field definitions
#define BT_SPIPTR_MASK   ((uint32_t)0xFFFF0000)
#define BT_SPIPTR_LSB    16
#define BT_SPIPTR_WIDTH  ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)spiptr << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_RADIOCNTL0_ADDR, (REG_BT_RD(BT_RADIOCNTL0_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)spiptr << 16));
}
 ...
 * </pre>
 */
#define BT_RADIOCNTL1_ADDR   (REG_BTCORE_BASE_ADDR + 0x74)
...
__INLINE void bt_radiocntl1_pack(uint8_t forceagcen, uint8_t forceiq, uint8_t rxdnsl, uint8_t txdnsl, uint16_t forceagclength, uint8_t syncpulsemode, uint8_t syncpulsesrc,
                                 uint8_t dpcorren, uint8_t jefselect, uint8_t xrfsel, uint8_t subversion)
{
    ...
    REG_BT_WR(BT_RADIOCNTL1_ADDR, ((uint32_t)forceagcen << 31) | ((uint32_t)forceiq << 30) | ((uint32_t)rxdnsl << 29) | ((uint32_t)txdnsl << 28) |
                                      ((uint32_t)forceagclength << 16) | ((uint32_t)syncpulsemode << 15) | ((uint32_t)syncpulsesrc << 14) | ((uint32_t)dpcorren << 13) |
                                      ((uint32_t)jefselect << 12) | ((uint32_t)xrfsel << 4) | ((uint32_t)subversion << 0));
}

__INLINE void bt_radiocntl1_unpack(uint8_t *forceagcen, uint8_t *forceiq, uint8_t *rxdnsl, uint8_t *txdnsl, uint16_t *forceagclength, uint8_t *syncpulsemode, uint8_t *syncpulsesrc,
                                   uint8_t *dpcorren, uint8_t *jefselect, uint8_t *xrfsel, uint8_t *subversion)
{
 ...
 * </pre>
 */
#define BT_RADIOCNTL2_ADDR   (REG_BTCORE_BASE_ADDR + 0x78)
#define BT_RADIOCNTL2_OFFSET 0x00000078
#define BT_RADIOCNTL2_INDEX  0x0000001E
#define BT_RADIOCNTL2_RESET  0x04000100
...
#define BT_FREQTABLE_PTR_MASK       ((uint32_t)0x0000FFFF)
#define BT_FREQTABLE_PTR_LSB        0
#define BT_FREQTABLE_PTR_WIDTH      ((uint32_t)0x00000010)

#define BT_TRAILER_GATING_VAL_RST   0x4
#define BT_SYNCERR_RST              0x0
#define BT_FREQTABLE_PTR_RST        0x100
...
{
    ASSERT_ERR((((uint32_t)freqtableptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_RADIOCNTL2_ADDR, (REG_BT_RD(BT_RADIOCNTL2_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)freqtableptr << 0));
}
 ...
 * </pre>
 */
#define BT_RADIOCNTL3_ADDR   (REG_BTCORE_BASE_ADDR + 0x7C)
...
__INLINE void bt_radiocntl3_pack(uint8_t rxrate2cfg, uint8_t rxrate1cfg, uint8_t rxrate0cfg, uint8_t rxserparif, uint8_t rxsyncrouting, uint8_t rxvalidbeh, uint8_t txrate2cfg,
                                 uint8_t txrate1cfg, uint8_t txrate0cfg, uint8_t txserparif, uint8_t txvalidbeh)
{
    ...
    REG_BT_WR(BT_RADIOCNTL3_ADDR, ((uint32_t)rxrate2cfg << 28) | ((uint32_t)rxrate1cfg << 26) | ((uint32_t)rxrate0cfg << 24) | ((uint32_t)rxserparif << 19) |
                                      ((uint32_t)rxsyncrouting << 18) | ((uint32_t)rxvalidbeh << 16) | ((uint32_t)txrate2cfg << 12) | ((uint32_t)txrate1cfg << 10) |
                                      ((uint32_t)txrate0cfg << 8) | ((uint32_t)txserparif << 2) | ((uint32_t)txvalidbeh << 0));
}

__INLINE void bt_radiocntl3_unpack(uint8_t *rxrate2cfg, uint8_t *rxrate1cfg, uint8_t *rxrate0cfg, uint8_t *rxserparif, uint8_t *rxsyncrouting, uint8_t *rxvalidbeh,
                                   uint8_t *txrate2cfg, uint8_t *txrate1cfg, uint8_t *txrate0cfg, uint8_t *txserparif, uint8_t *txvalidbeh)
{
 ...
 * </pre>
 */
#define BT_RADIOPWRUPDN_ADDR   (REG_BTCORE_BASE_ADDR + 0x8C)
 ...
 * </pre>
 */
#define BT_RADIOTXRXTIM_ADDR   (REG_BTCORE_BASE_ADDR + 0x90)
...
#define BT_RXEIRADJ_MASK       ((uint32_t)0x00010000)
#define BT_RXEIRADJ_LSB        16
#define BT_RXEIRADJ_WIDTH      ((uint32_t)0x00000001)
...
#define BT_RXEIRADJ_RST        0x1
#define BT_RXPATHDLY_RST       0x0
#define BT_TXPATHDLY_RST       0x0

__INLINE void bt_radiotxrxtim_pack(uint8_t syncposition, uint8_t rxeiradj, uint8_t rxpathdly, uint8_t txpathdly)
{
    ...
    REG_BT_WR(BT_RADIOTXRXTIM_ADDR, ((uint32_t)syncposition << 24) | ((uint32_t)rxeiradj << 16) | ((uint32_t)rxpathdly << 8) | ((uint32_t)txpathdly << 0));
}

__INLINE void bt_radiotxrxtim_unpack(uint8_t *syncposition, uint8_t *rxeiradj, uint8_t *rxpathdly, uint8_t *txpathdly)
{
    uint32_t localVal = REG_BT_RD(BT_RADIOTXRXTIM_ADDR);

    *syncposition = (localVal & ((uint32_t)0xFF000000)) >> 24;
    *rxeiradj     = (localVal & ((uint32_t)0x00010000)) >> 16;
...
__INLINE uint8_t bt_radiotxrxtim_rx_eir_adjust_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_RADIOTXRXTIM_ADDR);
    return ((localVal & ((uint32_t)0x00010000)) >> 16);
}

__INLINE void bt_radiotxrxtim_rx_eir_adjust_setf(uint8_t rxeiradj)
{
    // ASSERT_ERR((((uint32_t)syncposition << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_BT_WR(BT_RADIOTXRXTIM_ADDR, (REG_BT_RD(BT_RADIOTXRXTIM_ADDR) & ~((uint32_t)0x00010000)) | ((uint32_t)rxeiradj << 16));
}
 ...
 * </pre>
 */
#define BT_SPIPTRCNTL0_ADDR   (REG_BTCORE_BASE_ADDR + 0xA0)
...
// field definitions
#define BT_TXOFFPTR_MASK  ((uint32_t)0xFFFF0000)
#define BT_TXOFFPTR_LSB   16
#define BT_TXOFFPTR_WIDTH ((uint32_t)0x00000010)
#define BT_TXONPTR_MASK   ((uint32_t)0x0000FFFF)
#define BT_TXONPTR_LSB    0
#define BT_TXONPTR_WIDTH  ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)txoffptr << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_SPIPTRCNTL0_ADDR, (REG_BT_RD(BT_SPIPTRCNTL0_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)txoffptr << 16));
}
...
{
    ASSERT_ERR((((uint32_t)txonptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_SPIPTRCNTL0_ADDR, (REG_BT_RD(BT_SPIPTRCNTL0_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)txonptr << 0));
}
 ...
 * </pre>
 */
#define BT_SPIPTRCNTL1_ADDR   (REG_BTCORE_BASE_ADDR + 0xA4)
...
// field definitions
#define BT_RXOFFPTR_MASK  ((uint32_t)0xFFFF0000)
#define BT_RXOFFPTR_LSB   16
#define BT_RXOFFPTR_WIDTH ((uint32_t)0x00000010)
#define BT_RXONPTR_MASK   ((uint32_t)0x0000FFFF)
#define BT_RXONPTR_LSB    0
#define BT_RXONPTR_WIDTH  ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)rxoffptr << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_SPIPTRCNTL1_ADDR, (REG_BT_RD(BT_SPIPTRCNTL1_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)rxoffptr << 16));
}
...
{
    ASSERT_ERR((((uint32_t)rxonptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_SPIPTRCNTL1_ADDR, (REG_BT_RD(BT_SPIPTRCNTL1_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)rxonptr << 0));
}
 ...
 * </pre>
 */
#define BT_SPIPTRCNTL2_ADDR   (REG_BTCORE_BASE_ADDR + 0xA8)
...
// field definitions
#define BT_RXLENGTHPTR_MASK  ((uint32_t)0xFFFF0000)
#define BT_RXLENGTHPTR_LSB   16
#define BT_RXLENGTHPTR_WIDTH ((uint32_t)0x00000010)
#define BT_RSSIPTR_MASK      ((uint32_t)0x0000FFFF)
#define BT_RSSIPTR_LSB       0
#define BT_RSSIPTR_WIDTH     ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)rxlengthptr << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_SPIPTRCNTL2_ADDR, (REG_BT_RD(BT_SPIPTRCNTL2_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)rxlengthptr << 16));
}
...
{
    ASSERT_ERR((((uint32_t)rssiptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_SPIPTRCNTL2_ADDR, (REG_BT_RD(BT_SPIPTRCNTL2_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)rssiptr << 0));
}
 ...
 * </pre>
 */
#define BT_SPIPTRCNTL3_ADDR   (REG_BTCORE_BASE_ADDR + 0xAC)
...
// field definitions
#define BT_RXPKTTYPPTR_MASK  ((uint32_t)0x0000FFFF)
#define BT_RXPKTTYPPTR_LSB   0
#define BT_RXPKTTYPPTR_WIDTH ((uint32_t)0x00000010)
 ...
 * </pre>
 */
#define BT_AESCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0xB0)
 ...
 * </pre>
 */
#define BT_AESKEY31_0_ADDR   (REG_BTCORE_BASE_ADDR + 0xB4)
 ...
 * </pre>
 */
#define BT_AESKEY63_32_ADDR   (REG_BTCORE_BASE_ADDR + 0xB8)
 ...
 * </pre>
 */
#define BT_AESKEY95_64_ADDR   (REG_BTCORE_BASE_ADDR + 0xBC)
 ...
 * </pre>
 */
#define BT_AESKEY127_96_ADDR   (REG_BTCORE_BASE_ADDR + 0xC0)
 ...
 * </pre>
 */
#define BT_AESPTR_ADDR   (REG_BTCORE_BASE_ADDR + 0xC4)
...
// field definitions
#define BT_E0PTR_MASK   ((uint32_t)0xFFFF0000)
#define BT_E0PTR_LSB    16
#define BT_E0PTR_WIDTH  ((uint32_t)0x00000010)
#define BT_AESPTR_MASK  ((uint32_t)0x0000FFFF)
#define BT_AESPTR_LSB   0
#define BT_AESPTR_WIDTH ((uint32_t)0x00000010)

#define BT_E0PTR_RST    0x0
#define BT_AESPTR_RST   0x0

__INLINE void bt_aesptr_pack(uint16_t e0ptr, uint16_t aesptr)
{
    ASSERT_ERR((((uint32_t)e0ptr << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)aesptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_AESPTR_ADDR, ((uint32_t)e0ptr << 16) | ((uint32_t)aesptr << 0));
}

__INLINE void bt_aesptr_unpack(uint16_t *e0ptr, uint16_t *aesptr)
{
    uint32_t localVal = REG_BT_RD(BT_AESPTR_ADDR);

    *e0ptr  = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *aesptr = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}

__INLINE uint16_t bt_aesptr_e0ptr_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_AESPTR_ADDR);
    return ((localVal & ((uint32_t)0xFFFF0000)) >> 16);
}

__INLINE void bt_aesptr_e0ptr_setf(uint16_t e0ptr)
{
    ASSERT_ERR((((uint32_t)e0ptr << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_AESPTR_ADDR, (REG_BT_RD(BT_AESPTR_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)e0ptr << 16));
}

__INLINE uint16_t bt_aesptr_aesptr_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_AESPTR_ADDR);
    return ((localVal & ((uint32_t)0x0000FFFF)) >> 0);
}

__INLINE void bt_aesptr_aesptr_setf(uint16_t aesptr)
{
    ASSERT_ERR((((uint32_t)aesptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_AESPTR_ADDR, (REG_BT_RD(BT_AESPTR_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)aesptr << 0));
}
 ...
 * </pre>
 */
#define BT_TXMICVAL_ADDR   (REG_BTCORE_BASE_ADDR + 0xC8)
 ...
 * </pre>
 */
#define BT_RXMICVAL_ADDR   (REG_BTCORE_BASE_ADDR + 0xCC)
 ...
 * </pre>
 */
#define BT_RFTESTCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0xD0)
...
__INLINE void bt_rftestcntl_pack(uint8_t infiniterx, uint8_t sserrren, uint8_t herrren, uint8_t infinitetx, uint8_t prbstype, uint8_t txpldsrc)
{
    ...
    REG_BT_WR(BT_RFTESTCNTL_ADDR, ((uint32_t)infiniterx << 31) | ((uint32_t)sserrren << 17) | ((uint32_t)herrren << 16) | ((uint32_t)infinitetx << 15) |
                                      ((uint32_t)prbstype << 13) | ((uint32_t)txpldsrc << 12));
}

__INLINE void bt_rftestcntl_unpack(uint8_t *infiniterx, uint8_t *sserrren, uint8_t *herrren, uint8_t *infinitetx, uint8_t *prbstype, uint8_t *txpldsrc)
{
 ...
 * </pre>
 */
#define BT_RFTESTFREQ_ADDR   (REG_BTCORE_BASE_ADDR + 0xD4)
...
// field definitions
#define BT_LOOPBACK_MODE_BIT    ((uint32_t)0x00040000)
#define BT_LOOPBACK_MODE_POS    18
...
#define BT_LOOPBACK_MODE_RST    0x0
...
__INLINE void bt_rftestfreq_pack(uint8_t loopbackmode, uint8_t directloopbacken, uint8_t testmodeen, uint8_t rxfreq, uint8_t txfreq)
{
    ...
    REG_BT_WR(BT_RFTESTFREQ_ADDR,
              ((uint32_t)loopbackmode << 18) | ((uint32_t)directloopbacken << 17) | ((uint32_t)testmodeen << 16) | ((uint32_t)rxfreq << 8) | ((uint32_t)txfreq << 0));
}
...
__INLINE uint8_t bt_rftestfreq_loopback_mode_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_RFTESTFREQ_ADDR);
    return ((localVal & ((uint32_t)0x00040000)) >> 18);
}

__INLINE void bt_rftestfreq_loopback_mode_setf(uint8_t loopbackmode)
{
    ASSERT_ERR((((uint32_t)loopbackmode << 18) & ~((uint32_t)0x00040000)) == 0);
 ...
 * </pre>
 */
#define BT_TIMGENCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0xE0)
 ...
 * </pre>
 */
#define BT_GROSSTIMTGT_ADDR   (REG_BTCORE_BASE_ADDR + 0xE4)
#define BT_GROSSTIMTGT_OFFSET 0x000000E4
#define BT_GROSSTIMTGT_INDEX  0x00000039
#define BT_GROSSTIMTGT_RESET  0x00000000

__INLINE uint32_t bt_grosstimtgt_get(void)
{
    return REG_BT_RD(BT_GROSSTIMTGT_ADDR);
}

__INLINE void bt_grosstimtgt_set(uint32_t value)
{
    REG_BT_WR(BT_GROSSTIMTGT_ADDR, value);
}

// field definitions
#define BT_GROSSTARGET_MASK  ((uint32_t)0x007FFFFF)
#define BT_GROSSTARGET_LSB   0
#define BT_GROSSTARGET_WIDTH ((uint32_t)0x00000017)

#define BT_GROSSTARGET_RST   0x0

__INLINE uint32_t bt_grosstimtgt_grosstarget_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_GROSSTIMTGT_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x007FFFFF)) == 0);
    return (localVal >> 0);
}

__INLINE void bt_grosstimtgt_grosstarget_setf(uint32_t grosstarget)
{
    ASSERT_ERR((((uint32_t)grosstarget << 0) & ~((uint32_t)0x007FFFFF)) == 0);
    REG_BT_WR(BT_GROSSTIMTGT_ADDR, (uint32_t)grosstarget << 0);
}
 ...
 * </pre>
 */
#define BT_FINETIMTGT_ADDR   (REG_BTCORE_BASE_ADDR + 0xE8)
#define BT_FINETIMTGT_OFFSET 0x000000E8
#define BT_FINETIMTGT_INDEX  0x0000003A
 ...
 * </pre>
 */
#define BT_CLKNTGT_ADDR   (REG_BTCORE_BASE_ADDR + 0xEC)
#define BT_CLKNTGT_OFFSET 0x000000EC
#define BT_CLKNTGT_INDEX  0x0000003B
#define BT_CLKNTGT_RESET  0x00000000

__INLINE uint32_t bt_clkntgt_get(void)
{
    return REG_BT_RD(BT_CLKNTGT_ADDR);
}

__INLINE void bt_clkntgt_set(uint32_t value)
{
    REG_BT_WR(BT_CLKNTGT_ADDR, value);
}

// field definitions
#define BT_CLKNTGT_MASK  ((uint32_t)0x0FFFFFFF)
#define BT_CLKNTGT_LSB   0
#define BT_CLKNTGT_WIDTH ((uint32_t)0x0000001C)

#define BT_CLKNTGT_RST   0x0

__INLINE uint32_t bt_clkntgt_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_CLKNTGT_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x0FFFFFFF)) == 0);
    return (localVal >> 0);
}

__INLINE void bt_clkntgt_setf(uint32_t clkntgt)
{
    ASSERT_ERR((((uint32_t)clkntgt << 0) & ~((uint32_t)0x0FFFFFFF)) == 0);
    REG_BT_WR(BT_CLKNTGT_ADDR, (uint32_t)clkntgt << 0);
}
 ...
 * </pre>
 */
#define BT_HMICROSECTGT_ADDR   (REG_BTCORE_BASE_ADDR + 0xF0)
#define BT_HMICROSECTGT_OFFSET 0x000000F0
#define BT_HMICROSECTGT_INDEX  0x0000003C
#define BT_HMICROSECTGT_RESET  0x00000000

__INLINE uint32_t bt_hmicrosectgt_get(void)
{
    return REG_BT_RD(BT_HMICROSECTGT_ADDR);
}

__INLINE void bt_hmicrosectgt_set(uint32_t value)
{
    REG_BT_WR(BT_HMICROSECTGT_ADDR, value);
}

// field definitions
#define BT_HMICROSECTGT_MASK  ((uint32_t)0x000003FF)
#define BT_HMICROSECTGT_LSB   0
#define BT_HMICROSECTGT_WIDTH ((uint32_t)0x0000000A)

#define BT_HMICROSECTGT_RST   0x0

__INLINE uint16_t bt_hmicrosectgt_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_HMICROSECTGT_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0x000003FF)) == 0);
    return (localVal >> 0);
}

__INLINE void bt_hmicrosectgt_setf(uint16_t hmicrosectgt)
{
    ASSERT_ERR((((uint32_t)hmicrosectgt << 0) & ~((uint32_t)0x000003FF)) == 0);
    REG_BT_WR(BT_HMICROSECTGT_ADDR, (uint32_t)hmicrosectgt << 0);
}

/**
 * @brief BTSCHCNTL register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *     31            START_FRM   0
 ...
 * </pre>
 */
#define BT_BTSCHCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x100)
#define BT_BTSCHCNTL_OFFSET 0x00000100
#define BT_BTSCHCNTL_INDEX  0x00000040
#define BT_BTSCHCNTL_RESET  0x00000000

__INLINE uint32_t bt_btschcntl_get(void)
{
    return REG_BT_RD(BT_BTSCHCNTL_ADDR);
}

__INLINE void bt_btschcntl_set(uint32_t value)
{
    REG_BT_WR(BT_BTSCHCNTL_ADDR, value);
}

// field definitions
#define BT_START_FRM_BIT   ((uint32_t)0x80000000)
#define BT_START_FRM_POS   31
#define BT_ENTRY_IDX_MASK  ((uint32_t)0x0000000F)
#define BT_ENTRY_IDX_LSB   0
#define BT_ENTRY_IDX_WIDTH ((uint32_t)0x00000004)

#define BT_START_FRM_RST   0x0
#define BT_ENTRY_IDX_RST   0x0

__INLINE void bt_btschcntl_pack(uint8_t startfrm, uint8_t entryidx)
{
    ASSERT_ERR((((uint32_t)startfrm << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)entryidx << 0) & ~((uint32_t)0x0000000F)) == 0);
    REG_BT_WR(BT_BTSCHCNTL_ADDR, ((uint32_t)startfrm << 31) | ((uint32_t)entryidx << 0));
}

__INLINE void bt_btschcntl_unpack(uint8_t *startfrm, uint8_t *entryidx)
{
    uint32_t localVal = REG_BT_RD(BT_BTSCHCNTL_ADDR);

    *startfrm = (localVal & ((uint32_t)0x80000000)) >> 31;
    *entryidx = (localVal & ((uint32_t)0x0000000F)) >> 0;
}

__INLINE uint8_t bt_btschcntl_start_frm_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_BTSCHCNTL_ADDR);
    return ((localVal & ((uint32_t)0x80000000)) >> 31);
}

__INLINE void bt_btschcntl_start_frm_setf(uint8_t startfrm)
{
    ASSERT_ERR((((uint32_t)startfrm << 31) & ~((uint32_t)0x80000000)) == 0);
    REG_BT_WR(BT_BTSCHCNTL_ADDR, (REG_BT_RD(BT_BTSCHCNTL_ADDR) & ~((uint32_t)0x80000000)) | ((uint32_t)startfrm << 31));
}

__INLINE uint8_t bt_btschcntl_entry_idx_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_BTSCHCNTL_ADDR);
    return ((localVal & ((uint32_t)0x0000000F)) >> 0);
}

__INLINE void bt_btschcntl_entry_idx_setf(uint8_t entryidx)
{
    ASSERT_ERR((((uint32_t)entryidx << 0) & ~((uint32_t)0x0000000F)) == 0);
    REG_BT_WR(BT_BTSCHCNTL_ADDR, (REG_BT_RD(BT_BTSCHCNTL_ADDR) & ~((uint32_t)0x0000000F)) | ((uint32_t)entryidx << 0));
}
 ...
 * </pre>
 */
#define BT_STARTFRMCLKNTS_ADDR   (REG_BTCORE_BASE_ADDR + 0x104)
 ...
 * </pre>
 */
#define BT_STARTFRMFINECNTTS_ADDR   (REG_BTCORE_BASE_ADDR + 0x108)
 ...
 * </pre>
 */
#define BT_ENDFRMCLKNTS_ADDR   (REG_BTCORE_BASE_ADDR + 0x10C)
 ...
 * </pre>
 */
#define BT_ENDFRMFINECNTTS_ADDR   (REG_BTCORE_BASE_ADDR + 0x110)
 ...
 * </pre>
 */
#define BT_SKIPFRMCLKNTS_ADDR   (REG_BTCORE_BASE_ADDR + 0x114)
 ...
 * </pre>
 */
#define BT_SKIPFRMFINECNTTS_ADDR   (REG_BTCORE_BASE_ADDR + 0x118)
 ...
 * </pre>
 */
#define BT_PCACNTL0_ADDR   (REG_BTCORE_BASE_ADDR + 0x120)
#define BT_PCACNTL0_OFFSET 0x00000120
#define BT_PCACNTL0_INDEX  0x00000048
...
__INLINE void bt_pcacntl0_pack(uint16_t targetoffset, uint8_t slvlbl, uint8_t corrstep, uint8_t blindcorren, uint8_t frsyncpol, uint8_t syncsource, uint8_t phaseshiften)
{
    ...
    REG_BT_WR(BT_PCACNTL0_ADDR, ((uint32_t)targetoffset << 16) | ((uint32_t)slvlbl << 8) | ((uint32_t)corrstep << 4) | ((uint32_t)blindcorren << 3) | ((uint32_t)frsyncpol << 2) |
                                    ((uint32_t)syncsource << 1) | ((uint32_t)phaseshiften << 0));
}
 ...
 * </pre>
 */
#define BT_PCACNTL1_ADDR   (REG_BTCORE_BASE_ADDR + 0x124)
#define BT_PCACNTL1_OFFSET 0x00000124
#define BT_PCACNTL1_INDEX  0x00000049
 ...
 * </pre>
 */
#define BT_PCASTAT_ADDR   (REG_BTCORE_BASE_ADDR + 0x128)
#define BT_PCASTAT_OFFSET 0x00000128
#define BT_PCASTAT_INDEX  0x0000004A
 ...
 * </pre>
 */
#define BT_COEXIFCNTL0_ADDR   (REG_BTCORE_BASE_ADDR + 0x130)
#define BT_COEXIFCNTL0_OFFSET 0x00000130
#define BT_COEXIFCNTL0_INDEX  0x0000004C
...
__INLINE void bt_coexifcntl0_pack(uint8_t inqknudgeinc, uint8_t pageknudgeinc, uint8_t mwsscanfreqmsk, uint8_t wlcrxpriomode, uint8_t wlctxpriomode, uint8_t mwstxfrqmsk,
                                  uint8_t mwsrxfrqmsk, uint8_t mwstxmsk, uint8_t mwsrxmsk, uint8_t wlantxmsk, uint8_t wlanrxmsk, uint8_t mwswcien, uint8_t mwscoexen,
                                  uint8_t syncgenen, uint8_t wlancoexen)
{
    ...
    REG_BT_WR(BT_COEXIFCNTL0_ADDR, ((uint32_t)inqknudgeinc << 28) | ((uint32_t)pageknudgeinc << 24) | ((uint32_t)mwsscanfreqmsk << 20) | ((uint32_t)wlcrxpriomode << 18) |
                                       ((uint32_t)wlctxpriomode << 16) | ((uint32_t)mwstxfrqmsk << 14) | ((uint32_t)mwsrxfrqmsk << 12) | ((uint32_t)mwstxmsk << 10) |
                                       ((uint32_t)mwsrxmsk << 8) | ((uint32_t)wlantxmsk << 6) | ((uint32_t)wlanrxmsk << 4) | ((uint32_t)mwswcien << 3) |
                                       ((uint32_t)mwscoexen << 2) | ((uint32_t)syncgenen << 1) | ((uint32_t)wlancoexen << 0));
}

__INLINE void bt_coexifcntl0_unpack(uint8_t *inqknudgeinc, uint8_t *pageknudgeinc, uint8_t *mwsscanfreqmsk, uint8_t *wlcrxpriomode, uint8_t *wlctxpriomode, uint8_t *mwstxfrqmsk,
                                    uint8_t *mwsrxfrqmsk, uint8_t *mwstxmsk, uint8_t *mwsrxmsk, uint8_t *wlantxmsk, uint8_t *wlanrxmsk, uint8_t *mwswcien, uint8_t *mwscoexen,
                                    uint8_t *syncgenen, uint8_t *wlancoexen)
{
 ...
 * </pre>
 */
#define BT_COEXIFCNTL1_ADDR   (REG_BTCORE_BASE_ADDR + 0x134)
#define BT_COEXIFCNTL1_OFFSET 0x00000134
#define BT_COEXIFCNTL1_INDEX  0x0000004D
 ...
 * </pre>
 */
#define BT_COEXIFCNTL2_ADDR   (REG_BTCORE_BASE_ADDR + 0x138)
#define BT_COEXIFCNTL2_OFFSET 0x00000138
#define BT_COEXIFCNTL2_INDEX  0x0000004E
 ...
 * </pre>
 */
#define BT_BTMPRIO0_ADDR   (REG_BTCORE_BASE_ADDR + 0x13C)
#define BT_BTMPRIO0_OFFSET 0x0000013C
#define BT_BTMPRIO0_INDEX  0x0000004F
...
__INLINE void bt_btmprio0_pack(uint8_t btm7, uint8_t btm6, uint8_t btm5, uint8_t btm4, uint8_t btm3, uint8_t btm2, uint8_t btm1, uint8_t btm0)
{
    ...
    REG_BT_WR(BT_BTMPRIO0_ADDR, ((uint32_t)btm7 << 28) | ((uint32_t)btm6 << 24) | ((uint32_t)btm5 << 20) | ((uint32_t)btm4 << 16) | ((uint32_t)btm3 << 12) | ((uint32_t)btm2 << 8) |
                                    ((uint32_t)btm1 << 4) | ((uint32_t)btm0 << 0));
}
 ...
 * </pre>
 */
#define BT_BTMPRIO1_ADDR   (REG_BTCORE_BASE_ADDR + 0x140)
#define BT_BTMPRIO1_OFFSET 0x00000140
#define BT_BTMPRIO1_INDEX  0x00000050
...
__INLINE void bt_btmprio1_pack(uint8_t btm15, uint8_t btm14, uint8_t btm13, uint8_t btm12, uint8_t btm11, uint8_t btm10, uint8_t btm9, uint8_t btm8)
{
    ...
    REG_BT_WR(BT_BTMPRIO1_ADDR, ((uint32_t)btm15 << 28) | ((uint32_t)btm14 << 24) | ((uint32_t)btm13 << 20) | ((uint32_t)btm12 << 16) | ((uint32_t)btm11 << 12) |
                                    ((uint32_t)btm10 << 8) | ((uint32_t)btm9 << 4) | ((uint32_t)btm8 << 0));
}
 ...
 * </pre>
 */
#define BT_BTMPRIO2_ADDR   (REG_BTCORE_BASE_ADDR + 0x144)
#define BT_BTMPRIO2_OFFSET 0x00000144
#define BT_BTMPRIO2_INDEX  0x00000051
...
__INLINE void bt_btmprio2_pack(uint8_t btmdefault, uint8_t btm20, uint8_t btm19, uint8_t btm18, uint8_t btm17, uint8_t btm16)
{
    ...
    REG_BT_WR(BT_BTMPRIO2_ADDR,
              ((uint32_t)btmdefault << 28) | ((uint32_t)btm20 << 16) | ((uint32_t)btm19 << 12) | ((uint32_t)btm18 << 8) | ((uint32_t)btm17 << 4) | ((uint32_t)btm16 << 0));
}
 ...
 * </pre>
 */
#define BT_MWSPTABLE0_ADDR   (REG_BTCORE_BASE_ADDR + 0x150)
#define BT_MWSPTABLE0_OFFSET 0x00000150
#define BT_MWSPTABLE0_INDEX  0x00000054
...
__INLINE void bt_mwsptable0_pack(uint8_t mwspat04, uint8_t mwspat03, uint8_t mwspat02, uint8_t mwspat01, uint8_t mwspat00)
{
    ...
    REG_BT_WR(BT_MWSPTABLE0_ADDR, ((uint32_t)mwspat04 << 16) | ((uint32_t)mwspat03 << 12) | ((uint32_t)mwspat02 << 8) | ((uint32_t)mwspat01 << 4) | ((uint32_t)mwspat00 << 0));
}

__INLINE void bt_mwsptable0_unpack(uint8_t *mwspat04, uint8_t *mwspat03, uint8_t *mwspat02, uint8_t *mwspat01, uint8_t *mwspat00)
{
 ...
 * </pre>
 */
#define BT_MWSPTIMING00_ADDR   (REG_BTCORE_BASE_ADDR + 0x154)
#define BT_MWSPTIMING00_OFFSET 0x00000154
#define BT_MWSPTIMING00_INDEX  0x00000055
 ...
 * </pre>
 */
#define BT_MWSPTIMING01_ADDR   (REG_BTCORE_BASE_ADDR + 0x158)
#define BT_MWSPTIMING01_OFFSET 0x00000158
#define BT_MWSPTIMING01_INDEX  0x00000056
 ...
 * </pre>
 */
#define BT_MWSPTABLE1_ADDR   (REG_BTCORE_BASE_ADDR + 0x15C)
#define BT_MWSPTABLE1_OFFSET 0x0000015C
#define BT_MWSPTABLE1_INDEX  0x00000057
...
__INLINE void bt_mwsptable1_pack(uint8_t mwspat14, uint8_t mwspat13, uint8_t mwspat12, uint8_t mwspat11, uint8_t mwspat10)
{
    ...
    REG_BT_WR(BT_MWSPTABLE1_ADDR, ((uint32_t)mwspat14 << 16) | ((uint32_t)mwspat13 << 12) | ((uint32_t)mwspat12 << 8) | ((uint32_t)mwspat11 << 4) | ((uint32_t)mwspat10 << 0));
}

__INLINE void bt_mwsptable1_unpack(uint8_t *mwspat14, uint8_t *mwspat13, uint8_t *mwspat12, uint8_t *mwspat11, uint8_t *mwspat10)
{
 ...
 * </pre>
 */
#define BT_MWSPTIMING10_ADDR   (REG_BTCORE_BASE_ADDR + 0x160)
#define BT_MWSPTIMING10_OFFSET 0x00000160
#define BT_MWSPTIMING10_INDEX  0x00000058
 ...
 * </pre>
 */
#define BT_MWSPTIMING11_ADDR   (REG_BTCORE_BASE_ADDR + 0x164)
#define BT_MWSPTIMING11_OFFSET 0x00000164
#define BT_MWSPTIMING11_INDEX  0x00000059
 ...
 * </pre>
 */
#define BT_MWSPTABLE2_ADDR   (REG_BTCORE_BASE_ADDR + 0x168)
#define BT_MWSPTABLE2_OFFSET 0x00000168
#define BT_MWSPTABLE2_INDEX  0x0000005A
...
__INLINE void bt_mwsptable2_pack(uint8_t mwspat24, uint8_t mwspat23, uint8_t mwspat22, uint8_t mwspat21, uint8_t mwspat20)
{
    ...
    REG_BT_WR(BT_MWSPTABLE2_ADDR, ((uint32_t)mwspat24 << 16) | ((uint32_t)mwspat23 << 12) | ((uint32_t)mwspat22 << 8) | ((uint32_t)mwspat21 << 4) | ((uint32_t)mwspat20 << 0));
}

__INLINE void bt_mwsptable2_unpack(uint8_t *mwspat24, uint8_t *mwspat23, uint8_t *mwspat22, uint8_t *mwspat21, uint8_t *mwspat20)
{
 ...
 * </pre>
 */
#define BT_MWSPTIMING20_ADDR   (REG_BTCORE_BASE_ADDR + 0x16C)
#define BT_MWSPTIMING20_OFFSET 0x0000016C
#define BT_MWSPTIMING20_INDEX  0x0000005B
 ...
 * </pre>
 */
#define BT_MWSPTIMING21_ADDR   (REG_BTCORE_BASE_ADDR + 0x170)
#define BT_MWSPTIMING21_OFFSET 0x00000170
#define BT_MWSPTIMING21_INDEX  0x0000005C
 ...
 * </pre>
 */
#define BT_MWSIFSTAT_ADDR   (REG_BTCORE_BASE_ADDR + 0x174)
#define BT_MWSIFSTAT_OFFSET 0x00000174
#define BT_MWSIFSTAT_INDEX  0x0000005D
 ...
 * </pre>
 */
#define BT_MWSTXTABLE0_ADDR   (REG_BTCORE_BASE_ADDR + 0x180)
#define BT_MWSTXTABLE0_OFFSET 0x00000180
#define BT_MWSTXTABLE0_INDEX  0x00000060
 ...
 * </pre>
 */
#define BT_MWSRXTABLE0_ADDR   (REG_BTCORE_BASE_ADDR + 0x184)
#define BT_MWSRXTABLE0_OFFSET 0x00000184
#define BT_MWSRXTABLE0_INDEX  0x00000061
 ...
 * </pre>
 */
#define BT_MWSSFTABLE1_ADDR   (REG_BTCORE_BASE_ADDR + 0x188)
#define BT_MWSSFTABLE1_OFFSET 0x00000188
#define BT_MWSSFTABLE1_INDEX  0x00000062
 ...
 * </pre>
 */
#define BT_MWSSFTABLE2_ADDR   (REG_BTCORE_BASE_ADDR + 0x18C)
#define BT_MWSSFTABLE2_OFFSET 0x0000018C
#define BT_MWSSFTABLE2_INDEX  0x00000063
 ...
 * </pre>
 */
#define BT_MWSSFTABLE3_ADDR   (REG_BTCORE_BASE_ADDR + 0x190)
#define BT_MWSSFTABLE3_OFFSET 0x00000190
#define BT_MWSSFTABLE3_INDEX  0x00000064
 ...
 * </pre>
 */
#define BT_MWSSFTABLE4_ADDR   (REG_BTCORE_BASE_ADDR + 0x194)
#define BT_MWSSFTABLE4_OFFSET 0x00000194
#define BT_MWSSFTABLE4_INDEX  0x00000065
 ...
 * </pre>
 */
#define BT_MWSSFTABLE5_ADDR   (REG_BTCORE_BASE_ADDR + 0x198)
#define BT_MWSSFTABLE5_OFFSET 0x00000198
#define BT_MWSSFTABLE5_INDEX  0x00000066
 ...
 * </pre>
 */
#define BT_MWSSFTABLE6_ADDR   (REG_BTCORE_BASE_ADDR + 0x19C)
#define BT_MWSSFTABLE6_OFFSET 0x0000019C
#define BT_MWSSFTABLE6_INDEX  0x00000067
 ...
 * </pre>
 */
#define BT_MWSSFTABLE7_ADDR   (REG_BTCORE_BASE_ADDR + 0x1A0)
#define BT_MWSSFTABLE7_OFFSET 0x000001A0
#define BT_MWSSFTABLE7_INDEX  0x00000068
 ...
 * </pre>
 */
#define BT_MWSSFTABLE8_ADDR   (REG_BTCORE_BASE_ADDR + 0x1A4)
#define BT_MWSSFTABLE8_OFFSET 0x000001A4
#define BT_MWSSFTABLE8_INDEX  0x00000069
 ...
 * </pre>
 */
#define BT_MWSFRSYNCOFFSET_ADDR   (REG_BTCORE_BASE_ADDR + 0x1B0)
#define BT_MWSFRSYNCOFFSET_OFFSET 0x000001B0
#define BT_MWSFRSYNCOFFSET_INDEX  0x0000006C
 ...
 * </pre>
 */
#define BT_MWSTXOFFSET_ADDR   (REG_BTCORE_BASE_ADDR + 0x1B4)
#define BT_MWSTXOFFSET_OFFSET 0x000001B4
#define BT_MWSTXOFFSET_INDEX  0x0000006D
 ...
 * </pre>
 */
#define BT_MWSRXOFFSET_ADDR   (REG_BTCORE_BASE_ADDR + 0x1B8)
#define BT_MWSRXOFFSET_OFFSET 0x000001B8
#define BT_MWSRXOFFSET_INDEX  0x0000006E
 ...
 * </pre>
 */
#define BT_MWSWCICNTL0_ADDR   (REG_BTCORE_BASE_ADDR + 0x1C0)
#define BT_MWSWCICNTL0_OFFSET 0x000001C0
#define BT_MWSWCICNTL0_INDEX  0x00000070
 ...
 * </pre>
 */
#define BT_MWSWCICNTL1_ADDR   (REG_BTCORE_BASE_ADDR + 0x1C4)
#define BT_MWSWCICNTL1_OFFSET 0x000001C4
#define BT_MWSWCICNTL1_INDEX  0x00000071
 ...
 * </pre>
 */
#define BT_MWSWCITXCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x1C8)
#define BT_MWSWCITXCNTL_OFFSET 0x000001C8
#define BT_MWSWCITXCNTL_INDEX  0x00000072
...
#define BT_WCITXPTR_MASK  ((uint32_t)0x0000FFFF)
#define BT_WCITXPTR_LSB   0
#define BT_WCITXPTR_WIDTH ((uint32_t)0x00000010)
...
__INLINE void bt_mwswcitxcntl_pack(uint8_t wcitxnb, uint16_t wcitxptr)
{
    ...
    ASSERT_ERR((((uint32_t)wcitxptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_mwswcitxcntl_unpack(uint8_t *wcitxnb, uint16_t *wcitxptr)
{
    ...
    *wcitxptr = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)wcitxptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_MWSWCITXCNTL_ADDR, (REG_BT_RD(BT_MWSWCITXCNTL_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)wcitxptr << 0));
}
 ...
 * </pre>
 */
#define BT_MWSWCIRXCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x1CC)
#define BT_MWSWCIRXCNTL_OFFSET 0x000001CC
#define BT_MWSWCIRXCNTL_INDEX  0x00000073
...
#define BT_WCIRXPTR_MASK  ((uint32_t)0x0000FFFF)
#define BT_WCIRXPTR_LSB   0
#define BT_WCIRXPTR_WIDTH ((uint32_t)0x00000010)
...
__INLINE void bt_mwswcirxcntl_pack(uint8_t wcirxnb, uint16_t wcirxptr)
{
    ...
    ASSERT_ERR((((uint32_t)wcirxptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_mwswcirxcntl_unpack(uint8_t *wcirxnb, uint16_t *wcirxptr)
{
    ...
    *wcirxptr = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)wcirxptr << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_MWSWCIRXCNTL_ADDR, (REG_BT_RD(BT_MWSWCIRXCNTL_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)wcirxptr << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOCHANCNTL_0_ADDR   (REG_BTCORE_BASE_ADDR + 0x1D0)
#define BT_E_SCOCHANCNTL_0_OFFSET 0x000001D0
#define BT_E_SCOCHANCNTL_0_INDEX  0x00000074
...
#define BT_T_ESCO_0_MASK       ((uint32_t)0x000000FF)
#define BT_T_ESCO_0_LSB        0
#define BT_T_ESCO_0_WIDTH      ((uint32_t)0x00000008)
...
__INLINE void bt_e_scochancntl_0_pack(uint8_t escochanswen0, uint8_t escochanen0, uint8_t itmode0, uint8_t intdelay0, uint8_t tesco0)
{
    ...
    REG_BT_WR(BT_E_SCOCHANCNTL_0_ADDR,
              ((uint32_t)escochanswen0 << 15) | ((uint32_t)escochanen0 << 14) | ((uint32_t)itmode0 << 13) | ((uint32_t)intdelay0 << 8) | ((uint32_t)tesco0 << 0));
}
...
__INLINE uint8_t bt_e_scochancntl_0_t_esco_0_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_E_SCOCHANCNTL_0_ADDR);
    return ((localVal & ((uint32_t)0x000000FF)) >> 0);
}

__INLINE void bt_e_scochancntl_0_t_esco_0_setf(uint8_t tesco0)
{
    ASSERT_ERR((((uint32_t)tesco0 << 0) & ~((uint32_t)0x000000FF)) == 0);
 ...
 * </pre>
 */
#define BT_E_SCOMUTECNTL_0_ADDR   (REG_BTCORE_BASE_ADDR + 0x1D4)
#define BT_E_SCOMUTECNTL_0_OFFSET 0x000001D4
#define BT_E_SCOMUTECNTL_0_INDEX  0x00000075
...
__INLINE void bt_e_scomutecntl_0_pack(uint8_t mutesink0, uint8_t mutesource0, uint8_t invl01, uint8_t invl00, uint16_t mutepatt0)
{
    ...
    REG_BT_WR(BT_E_SCOMUTECNTL_0_ADDR,
              ((uint32_t)mutesink0 << 23) | ((uint32_t)mutesource0 << 22) | ((uint32_t)invl01 << 18) | ((uint32_t)invl00 << 16) | ((uint32_t)mutepatt0 << 0));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16          eSCO0PTRTX1   0x0
 *  15:00          eSCO0PTRTX0   0x0
 * </pre>
 */
#define BT_E_SCOCURRENTTXPTR_0_ADDR   (REG_BTCORE_BASE_ADDR + 0x1D8)
#define BT_E_SCOCURRENTTXPTR_0_OFFSET 0x000001D8
#define BT_E_SCOCURRENTTXPTR_0_INDEX  0x00000076
...
// field definitions
#define BT_E_SCO_0PTRTX_1_MASK  ((uint32_t)0xFFFF0000)
#define BT_E_SCO_0PTRTX_1_LSB   16
#define BT_E_SCO_0PTRTX_1_WIDTH ((uint32_t)0x00000010)
#define BT_E_SCO_0PTRTX_0_MASK  ((uint32_t)0x0000FFFF)
#define BT_E_SCO_0PTRTX_0_LSB   0
#define BT_E_SCO_0PTRTX_0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)esco0ptrtx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)esco0ptrtx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_e_scocurrenttxptr_0_unpack(uint16_t *esco0ptrtx1, uint16_t *esco0ptrtx0)
{
    ...
    *esco0ptrtx1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *esco0ptrtx0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)esco0ptrtx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_0_ADDR, (REG_BT_RD(BT_E_SCOCURRENTTXPTR_0_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)esco0ptrtx1 << 16));
}
...
{
    ASSERT_ERR((((uint32_t)esco0ptrtx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_0_ADDR, (REG_BT_RD(BT_E_SCOCURRENTTXPTR_0_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)esco0ptrtx0 << 0));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16          eSCO0PTRRX1   0x0
 *  15:00          eSCO0PTRRX0   0x0
 * </pre>
 */
#define BT_E_SCOCURRENTRXPTR_0_ADDR   (REG_BTCORE_BASE_ADDR + 0x1DC)
#define BT_E_SCOCURRENTRXPTR_0_OFFSET 0x000001DC
#define BT_E_SCOCURRENTRXPTR_0_INDEX  0x00000077
...
// field definitions
#define BT_E_SCO_0PTRRX_1_MASK  ((uint32_t)0xFFFF0000)
#define BT_E_SCO_0PTRRX_1_LSB   16
#define BT_E_SCO_0PTRRX_1_WIDTH ((uint32_t)0x00000010)
#define BT_E_SCO_0PTRRX_0_MASK  ((uint32_t)0x0000FFFF)
#define BT_E_SCO_0PTRRX_0_LSB   0
#define BT_E_SCO_0PTRRX_0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)esco0ptrrx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)esco0ptrrx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_e_scocurrentrxptr_0_unpack(uint16_t *esco0ptrrx1, uint16_t *esco0ptrrx0)
{
    ...
    *esco0ptrrx1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *esco0ptrrx0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)esco0ptrrx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_0_ADDR, (REG_BT_RD(BT_E_SCOCURRENTRXPTR_0_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)esco0ptrrx1 << 16));
}
...
{
    ASSERT_ERR((((uint32_t)esco0ptrrx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_0_ADDR, (REG_BT_RD(BT_E_SCOCURRENTRXPTR_0_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)esco0ptrrx0 << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOLTCNTL_0_ADDR   (REG_BTCORE_BASE_ADDR + 0x1E0)
#define BT_E_SCOLTCNTL_0_OFFSET 0x000001E0
#define BT_E_SCOLTCNTL_0_INDEX  0x00000078
...
__INLINE void bt_e_scoltcntl_0_pack(uint8_t retxnb0, uint8_t escoedrrx0, uint8_t escoedrtx0, uint8_t syntype0, uint8_t synltaddr0)
{
    ...
    REG_BT_WR(BT_E_SCOLTCNTL_0_ADDR,
              ((uint32_t)retxnb0 << 16) | ((uint32_t)escoedrrx0 << 5) | ((uint32_t)escoedrtx0 << 4) | ((uint32_t)syntype0 << 3) | ((uint32_t)synltaddr0 << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOTRCNTL_0_ADDR   (REG_BTCORE_BASE_ADDR + 0x1E4)
#define BT_E_SCOTRCNTL_0_OFFSET 0x000001E4
#define BT_E_SCOTRCNTL_0_INDEX  0x00000079
 ...
 * </pre>
 */
#define BT_E_SCODAYCNT_0_ADDR   (REG_BTCORE_BASE_ADDR + 0x1E8)
#define BT_E_SCODAYCNT_0_OFFSET 0x000001E8
#define BT_E_SCODAYCNT_0_INDEX  0x0000007A
 ...
 * </pre>
 */
#define BT_E_SCOCHANCNTL_1_ADDR   (REG_BTCORE_BASE_ADDR + 0x1F0)
#define BT_E_SCOCHANCNTL_1_OFFSET 0x000001F0
#define BT_E_SCOCHANCNTL_1_INDEX  0x0000007C
...
#define BT_T_ESCO_1_MASK       ((uint32_t)0x000000FF)
#define BT_T_ESCO_1_LSB        0
#define BT_T_ESCO_1_WIDTH      ((uint32_t)0x00000008)
...
__INLINE void bt_e_scochancntl_1_pack(uint8_t escochanswen1, uint8_t escochanen1, uint8_t itmode1, uint8_t intdelay1, uint8_t tesco1)
{
    ...
    REG_BT_WR(BT_E_SCOCHANCNTL_1_ADDR,
              ((uint32_t)escochanswen1 << 15) | ((uint32_t)escochanen1 << 14) | ((uint32_t)itmode1 << 13) | ((uint32_t)intdelay1 << 8) | ((uint32_t)tesco1 << 0));
}
...
__INLINE uint8_t bt_e_scochancntl_1_t_esco_1_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_E_SCOCHANCNTL_1_ADDR);
    return ((localVal & ((uint32_t)0x000000FF)) >> 0);
}

__INLINE void bt_e_scochancntl_1_t_esco_1_setf(uint8_t tesco1)
{
    ASSERT_ERR((((uint32_t)tesco1 << 0) & ~((uint32_t)0x000000FF)) == 0);
 ...
 * </pre>
 */
#define BT_E_SCOMUTECNTL_1_ADDR   (REG_BTCORE_BASE_ADDR + 0x1F4)
#define BT_E_SCOMUTECNTL_1_OFFSET 0x000001F4
#define BT_E_SCOMUTECNTL_1_INDEX  0x0000007D
...
__INLINE void bt_e_scomutecntl_1_pack(uint8_t mutesink1, uint8_t mutesource1, uint8_t invl11, uint8_t invl10, uint16_t mutepatt1)
{
    ...
    REG_BT_WR(BT_E_SCOMUTECNTL_1_ADDR,
              ((uint32_t)mutesink1 << 23) | ((uint32_t)mutesource1 << 22) | ((uint32_t)invl11 << 18) | ((uint32_t)invl10 << 16) | ((uint32_t)mutepatt1 << 0));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16          eSCO1PTRTX1   0x0
 *  15:00          eSCO1PTRTX0   0x0
 * </pre>
 */
#define BT_E_SCOCURRENTTXPTR_1_ADDR   (REG_BTCORE_BASE_ADDR + 0x1F8)
#define BT_E_SCOCURRENTTXPTR_1_OFFSET 0x000001F8
#define BT_E_SCOCURRENTTXPTR_1_INDEX  0x0000007E
...
// field definitions
#define BT_E_SCO_1PTRTX_1_MASK  ((uint32_t)0xFFFF0000)
#define BT_E_SCO_1PTRTX_1_LSB   16
#define BT_E_SCO_1PTRTX_1_WIDTH ((uint32_t)0x00000010)
#define BT_E_SCO_1PTRTX_0_MASK  ((uint32_t)0x0000FFFF)
#define BT_E_SCO_1PTRTX_0_LSB   0
#define BT_E_SCO_1PTRTX_0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)esco1ptrtx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)esco1ptrtx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_e_scocurrenttxptr_1_unpack(uint16_t *esco1ptrtx1, uint16_t *esco1ptrtx0)
{
    ...
    *esco1ptrtx1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *esco1ptrtx0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)esco1ptrtx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_1_ADDR, (REG_BT_RD(BT_E_SCOCURRENTTXPTR_1_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)esco1ptrtx1 << 16));
}
...
{
    ASSERT_ERR((((uint32_t)esco1ptrtx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_1_ADDR, (REG_BT_RD(BT_E_SCOCURRENTTXPTR_1_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)esco1ptrtx0 << 0));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16          eSCO1PTRRX1   0x0
 *  15:00          eSCO1PTRRX0   0x0
 * </pre>
 */
#define BT_E_SCOCURRENTRXPTR_1_ADDR   (REG_BTCORE_BASE_ADDR + 0x1FC)
#define BT_E_SCOCURRENTRXPTR_1_OFFSET 0x000001FC
#define BT_E_SCOCURRENTRXPTR_1_INDEX  0x0000007F
...
// field definitions
#define BT_E_SCO_1PTRRX_1_MASK  ((uint32_t)0xFFFF0000)
#define BT_E_SCO_1PTRRX_1_LSB   16
#define BT_E_SCO_1PTRRX_1_WIDTH ((uint32_t)0x00000010)
#define BT_E_SCO_1PTRRX_0_MASK  ((uint32_t)0x0000FFFF)
#define BT_E_SCO_1PTRRX_0_LSB   0
#define BT_E_SCO_1PTRRX_0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)esco1ptrrx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)esco1ptrrx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_e_scocurrentrxptr_1_unpack(uint16_t *esco1ptrrx1, uint16_t *esco1ptrrx0)
{
    ...
    *esco1ptrrx1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *esco1ptrrx0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)esco1ptrrx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_1_ADDR, (REG_BT_RD(BT_E_SCOCURRENTRXPTR_1_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)esco1ptrrx1 << 16));
}
...
{
    ASSERT_ERR((((uint32_t)esco1ptrrx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_1_ADDR, (REG_BT_RD(BT_E_SCOCURRENTRXPTR_1_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)esco1ptrrx0 << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOLTCNTL_1_ADDR   (REG_BTCORE_BASE_ADDR + 0x200)
#define BT_E_SCOLTCNTL_1_OFFSET 0x00000200
#define BT_E_SCOLTCNTL_1_INDEX  0x00000080
...
__INLINE void bt_e_scoltcntl_1_pack(uint8_t retxnb1, uint8_t escoedrrx1, uint8_t escoedrtx1, uint8_t syntype1, uint8_t synltaddr1)
{
    ...
    REG_BT_WR(BT_E_SCOLTCNTL_1_ADDR,
              ((uint32_t)retxnb1 << 16) | ((uint32_t)escoedrrx1 << 5) | ((uint32_t)escoedrtx1 << 4) | ((uint32_t)syntype1 << 3) | ((uint32_t)synltaddr1 << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOTRCNTL_1_ADDR   (REG_BTCORE_BASE_ADDR + 0x204)
#define BT_E_SCOTRCNTL_1_OFFSET 0x00000204
#define BT_E_SCOTRCNTL_1_INDEX  0x00000081
 ...
 * </pre>
 */
#define BT_E_SCODAYCNT_1_ADDR   (REG_BTCORE_BASE_ADDR + 0x208)
#define BT_E_SCODAYCNT_1_OFFSET 0x00000208
#define BT_E_SCODAYCNT_1_INDEX  0x00000082
 ...
 * </pre>
 */
#define BT_E_SCOCHANCNTL_2_ADDR   (REG_BTCORE_BASE_ADDR + 0x210)
#define BT_E_SCOCHANCNTL_2_OFFSET 0x00000210
#define BT_E_SCOCHANCNTL_2_INDEX  0x00000084
...
#define BT_T_ESCO_2_MASK       ((uint32_t)0x000000FF)
#define BT_T_ESCO_2_LSB        0
#define BT_T_ESCO_2_WIDTH      ((uint32_t)0x00000008)
...
__INLINE void bt_e_scochancntl_2_pack(uint8_t escochanswen2, uint8_t escochanen2, uint8_t itmode2, uint8_t intdelay2, uint8_t tesco2)
{
    ...
    REG_BT_WR(BT_E_SCOCHANCNTL_2_ADDR,
              ((uint32_t)escochanswen2 << 15) | ((uint32_t)escochanen2 << 14) | ((uint32_t)itmode2 << 13) | ((uint32_t)intdelay2 << 8) | ((uint32_t)tesco2 << 0));
}
...
__INLINE uint8_t bt_e_scochancntl_2_t_esco_2_getf(void)
{
    uint32_t localVal = REG_BT_RD(BT_E_SCOCHANCNTL_2_ADDR);
    return ((localVal & ((uint32_t)0x000000FF)) >> 0);
}

__INLINE void bt_e_scochancntl_2_t_esco_2_setf(uint8_t tesco2)
{
    ASSERT_ERR((((uint32_t)tesco2 << 0) & ~((uint32_t)0x000000FF)) == 0);
 ...
 * </pre>
 */
#define BT_E_SCOMUTECNTL_2_ADDR   (REG_BTCORE_BASE_ADDR + 0x214)
#define BT_E_SCOMUTECNTL_2_OFFSET 0x00000214
#define BT_E_SCOMUTECNTL_2_INDEX  0x00000085
...
__INLINE void bt_e_scomutecntl_2_pack(uint8_t mutesink2, uint8_t mutesource2, uint8_t invl21, uint8_t invl20, uint16_t mutepatt2)
{
    ...
    REG_BT_WR(BT_E_SCOMUTECNTL_2_ADDR,
              ((uint32_t)mutesink2 << 23) | ((uint32_t)mutesource2 << 22) | ((uint32_t)invl21 << 18) | ((uint32_t)invl20 << 16) | ((uint32_t)mutepatt2 << 0));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16          eSCO2PTRTX1   0x0
 *  15:00          eSCO2PTRTX0   0x0
 * </pre>
 */
#define BT_E_SCOCURRENTTXPTR_2_ADDR   (REG_BTCORE_BASE_ADDR + 0x218)
#define BT_E_SCOCURRENTTXPTR_2_OFFSET 0x00000218
#define BT_E_SCOCURRENTTXPTR_2_INDEX  0x00000086
...
// field definitions
#define BT_E_SCO_2PTRTX_1_MASK  ((uint32_t)0xFFFF0000)
#define BT_E_SCO_2PTRTX_1_LSB   16
#define BT_E_SCO_2PTRTX_1_WIDTH ((uint32_t)0x00000010)
#define BT_E_SCO_2PTRTX_0_MASK  ((uint32_t)0x0000FFFF)
#define BT_E_SCO_2PTRTX_0_LSB   0
#define BT_E_SCO_2PTRTX_0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)esco2ptrtx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)esco2ptrtx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_e_scocurrenttxptr_2_unpack(uint16_t *esco2ptrtx1, uint16_t *esco2ptrtx0)
{
    ...
    *esco2ptrtx1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *esco2ptrtx0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)esco2ptrtx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_2_ADDR, (REG_BT_RD(BT_E_SCOCURRENTTXPTR_2_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)esco2ptrtx1 << 16));
}
...
{
    ASSERT_ERR((((uint32_t)esco2ptrtx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTTXPTR_2_ADDR, (REG_BT_RD(BT_E_SCOCURRENTTXPTR_2_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)esco2ptrtx0 << 0));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16          eSCO2PTRRX1   0x0
 *  15:00          eSCO2PTRRX0   0x0
 * </pre>
 */
#define BT_E_SCOCURRENTRXPTR_2_ADDR   (REG_BTCORE_BASE_ADDR + 0x21C)
#define BT_E_SCOCURRENTRXPTR_2_OFFSET 0x0000021C
#define BT_E_SCOCURRENTRXPTR_2_INDEX  0x00000087
...
// field definitions
#define BT_E_SCO_2PTRRX_1_MASK  ((uint32_t)0xFFFF0000)
#define BT_E_SCO_2PTRRX_1_LSB   16
#define BT_E_SCO_2PTRRX_1_WIDTH ((uint32_t)0x00000010)
#define BT_E_SCO_2PTRRX_0_MASK  ((uint32_t)0x0000FFFF)
#define BT_E_SCO_2PTRRX_0_LSB   0
#define BT_E_SCO_2PTRRX_0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)esco2ptrrx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)esco2ptrrx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_e_scocurrentrxptr_2_unpack(uint16_t *esco2ptrrx1, uint16_t *esco2ptrrx0)
{
    ...
    *esco2ptrrx1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *esco2ptrrx0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)esco2ptrrx1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_2_ADDR, (REG_BT_RD(BT_E_SCOCURRENTRXPTR_2_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)esco2ptrrx1 << 16));
}
...
{
    ASSERT_ERR((((uint32_t)esco2ptrrx0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_E_SCOCURRENTRXPTR_2_ADDR, (REG_BT_RD(BT_E_SCOCURRENTRXPTR_2_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)esco2ptrrx0 << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOLTCNTL_2_ADDR   (REG_BTCORE_BASE_ADDR + 0x220)
#define BT_E_SCOLTCNTL_2_OFFSET 0x00000220
#define BT_E_SCOLTCNTL_2_INDEX  0x00000088
...
__INLINE void bt_e_scoltcntl_2_pack(uint8_t retxnb2, uint8_t escoedrrx2, uint8_t escoedrtx2, uint8_t syntype2, uint8_t synltaddr2)
{
    ...
    REG_BT_WR(BT_E_SCOLTCNTL_2_ADDR,
              ((uint32_t)retxnb2 << 16) | ((uint32_t)escoedrrx2 << 5) | ((uint32_t)escoedrtx2 << 4) | ((uint32_t)syntype2 << 3) | ((uint32_t)synltaddr2 << 0));
}
 ...
 * </pre>
 */
#define BT_E_SCOTRCNTL_2_ADDR   (REG_BTCORE_BASE_ADDR + 0x224)
#define BT_E_SCOTRCNTL_2_OFFSET 0x00000224
#define BT_E_SCOTRCNTL_2_INDEX  0x00000089
 ...
 * </pre>
 */
#define BT_E_SCODAYCNT_2_ADDR   (REG_BTCORE_BASE_ADDR + 0x228)
#define BT_E_SCODAYCNT_2_OFFSET 0x00000228
#define BT_E_SCODAYCNT_2_INDEX  0x0000008A
 ...
 * </pre>
 */
#define BT_AUDIOCNTL0_ADDR   (REG_BTCORE_BASE_ADDR + 0x230)
#define BT_AUDIOCNTL0_OFFSET 0x00000230
#define BT_AUDIOCNTL0_INDEX  0x0000008C
...
__INLINE void bt_audiocntl0_pack(uint8_t linearformat0, uint8_t sampletype0, uint8_t aulawen0, uint8_t aulawcode0, uint8_t cvsden0, uint8_t cvsdbitorder0)
{
    ...
    REG_BT_WR(BT_AUDIOCNTL0_ADDR, ((uint32_t)linearformat0 << 20) | ((uint32_t)sampletype0 << 16) | ((uint32_t)aulawen0 << 15) | ((uint32_t)aulawcode0 << 8) |
                                      ((uint32_t)cvsden0 << 7) | ((uint32_t)cvsdbitorder0 << 0));
}
 ...
 * </pre>
 */
#define BT_AUDIOCNTL1_ADDR   (REG_BTCORE_BASE_ADDR + 0x234)
#define BT_AUDIOCNTL1_OFFSET 0x00000234
#define BT_AUDIOCNTL1_INDEX  0x0000008D
...
__INLINE void bt_audiocntl1_pack(uint8_t linearformat1, uint8_t sampletype1, uint8_t aulawen1, uint8_t aulawcode1, uint8_t cvsden1, uint8_t cvsdbitorder1)
{
    ...
    REG_BT_WR(BT_AUDIOCNTL1_ADDR, ((uint32_t)linearformat1 << 20) | ((uint32_t)sampletype1 << 16) | ((uint32_t)aulawen1 << 15) | ((uint32_t)aulawcode1 << 8) |
                                      ((uint32_t)cvsden1 << 7) | ((uint32_t)cvsdbitorder1 << 0));
}
 ...
 * </pre>
 */
#define BT_AUDIOCNTL2_ADDR   (REG_BTCORE_BASE_ADDR + 0x238)
#define BT_AUDIOCNTL2_OFFSET 0x00000238
#define BT_AUDIOCNTL2_INDEX  0x0000008E
...
__INLINE void bt_audiocntl2_pack(uint8_t linearformat2, uint8_t sampletype2, uint8_t aulawen2, uint8_t aulawcode2, uint8_t cvsden2, uint8_t cvsdbitorder2)
{
    ...
    REG_BT_WR(BT_AUDIOCNTL2_ADDR, ((uint32_t)linearformat2 << 20) | ((uint32_t)sampletype2 << 16) | ((uint32_t)aulawen2 << 15) | ((uint32_t)aulawcode2 << 8) |
                                      ((uint32_t)cvsden2 << 7) | ((uint32_t)cvsdbitorder2 << 0));
}
 ...
 * </pre>
 */
#define BT_PCMGENCNTL_ADDR   (REG_BTCORE_BASE_ADDR + 0x240)
#define BT_PCMGENCNTL_OFFSET 0x00000240
#define BT_PCMGENCNTL_INDEX  0x00000090
...
__INLINE void bt_pcmgencntl_pack(uint8_t vxchsel, uint8_t loopback, uint8_t monolrsel, uint8_t monostereo, uint8_t mstslv, uint8_t byteswap, uint8_t lrswap, uint8_t pcmen)
{
    ...
    REG_BT_WR(BT_PCMGENCNTL_ADDR, ((uint32_t)vxchsel << 8) | ((uint32_t)loopback << 6) | ((uint32_t)monolrsel << 5) | ((uint32_t)monostereo << 4) | ((uint32_t)mstslv << 3) |
                                      ((uint32_t)byteswap << 2) | ((uint32_t)lrswap << 1) | ((uint32_t)pcmen << 0));
}

__INLINE void bt_pcmgencntl_unpack(uint8_t *vxchsel, uint8_t *loopback, uint8_t *monolrsel, uint8_t *monostereo, uint8_t *mstslv, uint8_t *byteswap, uint8_t *lrswap,
                                   uint8_t *pcmen)
{
 ...
 * </pre>
 */
#define BT_PCMPHYSCNTL0_ADDR   (REG_BTCORE_BASE_ADDR + 0x244)
#define BT_PCMPHYSCNTL0_OFFSET 0x00000244
#define BT_PCMPHYSCNTL0_INDEX  0x00000091
...
__INLINE void bt_pcmphyscntl0_pack(uint8_t firstactslot, uint8_t slotnb, uint8_t samptype, uint8_t sampsz, uint8_t lsb1st, uint8_t pcmiom, uint8_t lrchpol, uint8_t doutcfg,
                                   uint8_t fsyncshp)
{
    ...
    REG_BT_WR(BT_PCMPHYSCNTL0_ADDR, ((uint32_t)firstactslot << 20) | ((uint32_t)slotnb << 16) | ((uint32_t)samptype << 13) | ((uint32_t)sampsz << 12) | ((uint32_t)lsb1st << 10) |
                                        ((uint32_t)pcmiom << 9) | ((uint32_t)lrchpol << 8) | ((uint32_t)doutcfg << 4) | ((uint32_t)fsyncshp << 0));
}

__INLINE void bt_pcmphyscntl0_unpack(uint8_t *firstactslot, uint8_t *slotnb, uint8_t *samptype, uint8_t *sampsz, uint8_t *lsb1st, uint8_t *pcmiom, uint8_t *lrchpol,
                                     uint8_t *doutcfg, uint8_t *fsyncshp)
{
 ...
 * </pre>
 */
#define BT_PCMPHYSCNTL1_ADDR   (REG_BTCORE_BASE_ADDR + 0x248)
#define BT_PCMPHYSCNTL1_OFFSET 0x00000248
#define BT_PCMPHYSCNTL1_INDEX  0x00000092
 ...
 * </pre>
 */
#define BT_PCMPADDING_ADDR   (REG_BTCORE_BASE_ADDR + 0x24C)
#define BT_PCMPADDING_OFFSET 0x0000024C
#define BT_PCMPADDING_INDEX  0x00000093
 ...
 * </pre>
 */
#define BT_PCMPLLCNTL0_ADDR   (REG_BTCORE_BASE_ADDR + 0x250)
#define BT_PCMPLLCNTL0_OFFSET 0x00000250
#define BT_PCMPLLCNTL0_INDEX  0x00000094
 ...
 * </pre>
 */
#define BT_PCMPLLCNTL1_ADDR   (REG_BTCORE_BASE_ADDR + 0x254)
#define BT_PCMPLLCNTL1_OFFSET 0x00000254
#define BT_PCMPLLCNTL1_INDEX  0x00000095
 ...
 * </pre>
 */
#define BT_PCMPLLCNTL2_ADDR   (REG_BTCORE_BASE_ADDR + 0x258)
#define BT_PCMPLLCNTL2_OFFSET 0x00000258
#define BT_PCMPLLCNTL2_INDEX  0x00000096
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16        PCMSOURCEPTR1   0x0
 *  15:00        PCMSOURCEPTR0   0x0
 * </pre>
 */
#define BT_PCMSOURCEPTR_ADDR   (REG_BTCORE_BASE_ADDR + 0x25C)
#define BT_PCMSOURCEPTR_OFFSET 0x0000025C
#define BT_PCMSOURCEPTR_INDEX  0x00000097
...
// field definitions
#define BT_PCMSOURCEPTR1_MASK  ((uint32_t)0xFFFF0000)
#define BT_PCMSOURCEPTR1_LSB   16
#define BT_PCMSOURCEPTR1_WIDTH ((uint32_t)0x00000010)
#define BT_PCMSOURCEPTR0_MASK  ((uint32_t)0x0000FFFF)
#define BT_PCMSOURCEPTR0_LSB   0
#define BT_PCMSOURCEPTR0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)pcmsourceptr1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)pcmsourceptr0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_pcmsourceptr_unpack(uint16_t *pcmsourceptr1, uint16_t *pcmsourceptr0)
{
    ...
    *pcmsourceptr1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *pcmsourceptr0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)pcmsourceptr1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_PCMSOURCEPTR_ADDR, (REG_BT_RD(BT_PCMSOURCEPTR_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)pcmsourceptr1 << 16));
}
...
{
    ASSERT_ERR((((uint32_t)pcmsourceptr0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
    REG_BT_WR(BT_PCMSOURCEPTR_ADDR, (REG_BT_RD(BT_PCMSOURCEPTR_ADDR) & ~((uint32_t)0x0000FFFF)) | ((uint32_t)pcmsourceptr0 << 0));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:16          PCMSINKPTR1   0x0
 *  15:00          PCMSINKPTR0   0x0
 * </pre>
 */
#define BT_PCMSINKPTR_ADDR   (REG_BTCORE_BASE_ADDR + 0x260)
#define BT_PCMSINKPTR_OFFSET 0x00000260
#define BT_PCMSINKPTR_INDEX  0x00000098
...
// field definitions
#define BT_PCMSINKPTR1_MASK  ((uint32_t)0xFFFF0000)
#define BT_PCMSINKPTR1_LSB   16
#define BT_PCMSINKPTR1_WIDTH ((uint32_t)0x00000010)
#define BT_PCMSINKPTR0_MASK  ((uint32_t)0x0000FFFF)
#define BT_PCMSINKPTR0_LSB   0
#define BT_PCMSINKPTR0_WIDTH ((uint32_t)0x00000010)
...
{
    ASSERT_ERR((((uint32_t)pcmsinkptr1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR((((uint32_t)pcmsinkptr0 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE void bt_pcmsinkptr_unpack(uint16_t *pcmsinkptr1, uint16_t *pcmsinkptr0)
{
    ...
    *pcmsinkptr1 = (localVal & ((uint32_t)0xFFFF0000)) >> 16;
    *pcmsinkptr0 = (localVal & ((uint32_t)0x0000FFFF)) >> 0;
}
...
{
    ASSERT_ERR((((uint32_t)pcmsinkptr1 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_BT_WR(BT_PCMSINKPTR_ADDR, (REG_BT_RD(BT_PCMSINKPTR_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)pcmsinkptr1 << 16));
}
