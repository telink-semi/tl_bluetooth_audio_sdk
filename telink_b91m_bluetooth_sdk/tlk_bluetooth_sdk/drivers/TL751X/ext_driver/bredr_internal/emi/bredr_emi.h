...
extern void bt_emi_tx_continue_mode_run(RF_MODE_BT_e mode, signed short chn, unsigned char _slice, BT_PKT_Data_type_e type);

extern void bt_emi_tx_burst_mode_init(RF_MODE_BT_e mode, signed short chn, unsigned char _slice, BT_PKT_Data_type_e type);
...
extern void rf_bt_tx_init_conitnue(unsigned char _btMode, unsigned char _pktType, signed short _chn, unsigned char _slice, unsigned char _dataType);

extern void rf_bt_kick();

extern void rf_bt_rx_init(unsigned char _mode, signed short _chn);

extern void bt_current_test_cfg(void);
