 ...
 * @return  none.
 */
void pm_tim_recover_32k_rc(void);
 ...
 * @return  none.
 */
void pm_tim_recover_32k_xtal(void);
...
{
#if (defined(MCU_CORE_TL751X_N22))
    return (g_p_pm_status_info->mcu_status & MCU_DEEPRET_BACK);
#else
...
{
#if (defined(MCU_CORE_TL751X_N22))
    return g_p_pm_status_info->is_pad_wakeup;
#else
...
/**
 * @brief      This function serves to determine whether mcu is waked up by timer.
 * @param[in]  none.
 * @return     1- yes , 0- no.
 */
__INLINE int pm_is_32kTmrWakeup(void)
{
#if (defined(MCU_CORE_TL751X_N22))
    return ((g_p_pm_status_info->wakeup_src & WAKEUP_STATUS_TIMER) ? 1 : 0);
#else
    return ((g_pm_status_info.wakeup_src & WAKEUP_STATUS_TIMER) ? 1 : 0);
#endif
}
...
{
#if (defined(MCU_CORE_TL751X_N22))
    return g_p_pm_status_info->mcu_status;
#else
...
/**
 * @brief      This function serves to get the wakeup source of mcu.
 * @param[in]  none.
 * @return     wakeup source.
 */
__INLINE int pm_get_wakeup_status(void)
{
#if (defined(MCU_CORE_TL751X_N22))
    return g_p_pm_status_info->wakeup_src;
#else
