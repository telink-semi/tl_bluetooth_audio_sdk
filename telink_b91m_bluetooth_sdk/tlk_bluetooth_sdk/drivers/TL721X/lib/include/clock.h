 ...
 * | :-----------------------------------| :--------------------------------- | :------------ |:------------------------|
 * |             <4:0>                   |                 <7:5>              |    <15:8>     |  <22:21>                |
 * | analog_86<4:0> bbpll_240M_div_ratio | analog_84<7:5> bbpll_240M_vco_itrim|      clk      | analog_85<6:5> pre_div  |
 */
typedef enum
{
	PLL_CLK_192M    = (0x10 | (7 << 5) | (192 << 8)| (0x60<<16)),
	PLL_CLK_240M    = (0x12 | (5 << 5) | (240 << 8)| (0x60<<16)),
...
#define PLL_192M_CCLK_192M_HCLK_96M_PCLK_96M_MSPI_48M  clock_init(BASEBAND_PLL, CLK_DIV1, CCLK_DIV2_TO_HCLK_DIV2_TO_PCLK, CLK_DIV4)
