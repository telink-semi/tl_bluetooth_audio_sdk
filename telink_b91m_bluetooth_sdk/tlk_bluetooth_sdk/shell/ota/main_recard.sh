#!/bin/bash
#cfg here
bootFile="../../../boot_loader/751x/boot_loader_rtc.bin"
d25fFile="../../build/TL751X/recording_card/recording_card.bin"
dspFile="../../../dsp/bin/dsp_audio_sdk_v0.1.0.2_ram_boot.bin"
n22File="../../build/TL751X/controller/RECARDING_CARD/recording_card_controller.bin"
d25fBinVersion="1"
n22BinVersion="1"
dspBinVersion="1"
