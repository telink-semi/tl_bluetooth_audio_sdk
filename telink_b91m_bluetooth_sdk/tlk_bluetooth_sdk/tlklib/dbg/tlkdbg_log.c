...
/**
 * @brief       Table for converting values to hexadecimal characters
 */
__attribute__((section(".data"))) static uint8_t scTlkDbgHexTable[] = "0123456789abcdef";
 ...
 */
_attribute_ram_code_sec_noinline_ void tlkdbg_log_sendData(char *pStr, uint8_t *pData, uint16_t dataLen)
{
