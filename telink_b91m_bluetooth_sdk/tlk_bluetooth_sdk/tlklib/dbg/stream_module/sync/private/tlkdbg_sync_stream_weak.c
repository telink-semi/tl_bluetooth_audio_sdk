/********************************************************************************************************
 * @file    tlkdbg_sync_stream_weak.c
 *
 ...
 * @return      none.
 */
__attribute__((weak)) void tlkdbg_sync_stream_init(void) {}
 ...
 * @return      none.
 */
__attribute__((weak)) void tlkdbg_sync_stream_write(uint8_t type, void *pData, uint16_t dataLen)
{
    (void)type;
    (void)pData;
    (void)dataLen;
