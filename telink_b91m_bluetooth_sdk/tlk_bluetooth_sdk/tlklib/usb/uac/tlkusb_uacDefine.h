...
typedef enum
{
    ...
    TLKUSB_AUD_SAMPLE_24000 = 24000,
    TLKUSB_AUD_SAMPLE_32000 = 32000,
    TLKUSB_AUD_SAMPLE_44100 = 44100,
    TLKUSB_AUD_SAMPLE_48000 = 48000,
} TLKUSB_AUD_SPK_SAMPLE_RATE;

#ifndef TLKALG_UAC_PPM_MIC_ENABLE
#define TLKALG_UAC_PPM_MIC_ENABLE 1
#endif
#ifndef TLKALG_UAC_PPM_SPK_ENABLE
#define TLKALG_UAC_PPM_SPK_ENABLE 1
#endif
#ifndef TLKALG_UAC_PPM_ENABLE
#define TLKALG_UAC_PPM_ENABLE (TLKALG_UAC_PPM_MIC_ENABLE || TLKALG_UAC_PPM_SPK_ENABLE)
#endif

#define TLKLIB_UAC_PPM_MIC_ENABLE (TLKALG_UAC_PPM_MIC_ENABLE && TLKALG_PPM_MIC_ENABLE)
#define TLKLIB_UAC_PPM_SPK_ENABLE (TLKALG_UAC_PPM_SPK_ENABLE && TLKALG_PPM_SPK_ENABLE)
#define TLKLIB_UAC_PPM_ENABLE     (TLKALG_UAC_PPM_ENABLE && TLK_ALG_PPM_ENABLE)
...
#ifndef APP_USB_ISO_IN_BUFF_SIZE
#define APP_USB_ISO_IN_BUFF_SIZE (1024 * 4)
#endif

#ifndef APP_USB_ISO_OUT_BUFF_SIZE
...
#ifndef APP_USB_PPM_IN_BUFF_SIZE
#define APP_USB_PPM_IN_BUFF_SIZE 16 //(1024 * 4)
#endif

#ifndef APP_USB_PPM_OUT_BUFF_SIZE
...
#ifndef TLK_USB_UAC_DUAL_SOUNDCARD_MODE
#define TLK_USB_UAC_DUAL_SOUNDCARD_MODE 0
#endif
...
#define TLKUSB_UAC_EDP_SPK1 USB_EDP5_OUT
#else
...
enum TLKUSB_AUDID_ENUM
{
    ...
    TLKUSB_AUDID_SPK1_INPUT_TERMINAL_ID,
    TLKUSB_AUDID_SPK1_FEATURE_UNIT_ID,
    TLKUSB_AUDID_SPK1_OUTPUT_TERMINAL_ID,
};
