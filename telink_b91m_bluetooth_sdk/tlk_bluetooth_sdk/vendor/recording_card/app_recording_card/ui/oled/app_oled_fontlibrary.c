...
/* Width 8 pixels, Height 16 pixels */
...
/* Same Chinese character only needs to be defined once, order does not matter */
/* Must be all Chinese characters or full-width characters, do not add any half-width characters */
...
const ChineseCell_t OLED_CF16x16[] = {
    ...
    /* Add new Chinese character data at this position following the format above */
    //...


    /* Default graphic displayed when specified Chinese character is not found (a box with question mark inside),
     ensure it is at the end of the array */
