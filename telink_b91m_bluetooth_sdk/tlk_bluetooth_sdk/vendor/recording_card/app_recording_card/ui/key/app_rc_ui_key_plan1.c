...
#ifdef APP_RC_UI_KEY_PLAN1_1KEY
...
void app_rc_key1_long_long_press_evt(void)
{
...
void app_rc_ui_key_init(void)
{
    ...
    tlkdrv_key_registerVendorConfigCallback(KEY_EVT_VENDOR_CONFIG_10, app_rc_key1_long_long_press_evt);
}
