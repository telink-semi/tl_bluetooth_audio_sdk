...
/**
  ...
  * @return      none
  */
volatile u32 A_STIMER_CNT   = 0;
volatile u32 A_STIMER_CNT01 = 0;
...
{
    tlk_tpsll_tpdt_bbtimer_irq_handler();
}
#if MCU_CORE_N22
CLIC_ISR_REGISTER(tlk_tpsll_bbtimer_irq_handler, IRQ_TIMER_BB)
#else
PLIC_ISR_REGISTER(tlk_tpsll_bbtimer_irq_handler, IRQ_TIMER_BB)
#endif
/**
