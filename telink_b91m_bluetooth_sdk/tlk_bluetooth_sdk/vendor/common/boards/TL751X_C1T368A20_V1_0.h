...
#define TLKDRV_ANC0_MIC_DMA  DMA6
#define TLKDRV_ANC0_MIC_FIFO FIFO1
#define TLKDRV_ANC0_SPK_DMA  DMA7
...
#define AUDIO_HAC_DAC_L_CH        HAC_CHN0
#define AUDIO_HAC_DAC_R_CH        HAC_CHN1
#define TLKDRV_AUDIO_SPK_LCH_DMA  DMA4
#define TLKDRV_AUDIO_SPK_RCH_DMA  DMA5

#define TLKDRV_CODEC_SPK_DMA      TLKDRV_AUDIO_SPK_LCH_DMA
#define TLKDRV_AUDIO_SPK_LCH_FIFO FIFO0
#define TLKDRV_AUDIO_SPK_RCH_FIFO FIFO1
...
#define TLKDRV_AUDIO_MIC_LCH_DMA  DMA6
#define TLKDRV_AUDIO_MIC_RCH_DMA  DMA7
#define TLKDRV_CODEC_MIC_DMA      TLKDRV_AUDIO_MIC_LCH_DMA
...
#define TLKDRV_ICODEC_DMIC_CLK1_PIN GPIO_PI1
#define TLKDRV_ICODEC_DMIC_DATA_PIN GPIO_PI0
