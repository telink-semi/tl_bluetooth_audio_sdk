...
void tlkhal_clock_setLevel(uint8_t level, void *futureUse)
{
    ...
    case 0:
    {
        clock_init(BASEBAND_PLL, CLK_DIV8, CCLK_DIV1_TO_HCLK_DIV1_TO_PCLK, CLK_DIV4);
    } break;
    case 1:
    {
    ...
    case 3:
    {
        PLL_192M_CCLK_192M_HCLK_96M_PCLK_96M_MSPI_48M;
    } break;
    case 4:
    {
        PLL_240M_CCLK_240M_HCLK_120M_PCLK_120M_MSPI_48M; //tpsll_audio_dongle
    } break;
    }
}
