...
#elif (CHIP_TYPE == CHIP_TYPE_TL652X)
#define MCU_CORE_TYPE MCU_CORE_TL652X
#endif
...
#ifndef MCU_CORE_TL753X_TEMP
#define MCU_CORE_TL753X_TEMP 0
#endif

#if (MCU_CORE_TYPE == CHIP_TYPE_TL751X) || (MCU_CORE_TYPE == CHIP_TYPE_TL752X)
#define MCU_DUAL_CORE_ENABLE 1
#elif (MCU_CORE_TYPE == CHIP_TYPE_TL652X) || (MCU_CORE_TYPE == CHIP_TYPE_TL753X)
#define MCU_DUAL_CORE_ENABLE 1
...
#if (MCU_CORE_TL751X_N22 || MCU_CORE_TL752X_N22 || MCU_CORE_TL753X_N22 || MCU_CORE_TL322X_N22 || MCU_CORE_TL652X_CORE0 || MCU_CORE_TL652X_CORE1)
