...
#ifdef __riscv
#define LC3_RAM_CODE_ON 1
#define LC3_RAM_DATA_ON 1
#endif

#if LC3_RAM_CODE_ON
#define LC3_RAM_CODE __attribute__((section(".ram_code"))) __attribute__((noinline))
#else
#define LC3_RAM_CODE
#endif

#if LC3_RAM_DATA_ON
#define LC3_DRAM_DATA __attribute__((section(".data")))
#else
#define LC3_DRAM_DATA
#endif

#if __riscv
#define LC3_NOINLINE __attribute__((noinline))
#else
#define LC3_NOINLINE
#endif
 ...
 * - For encoding, keep 1.25 ms of temporal window
 * - For decoding, keep 18 ms of history, aligned on frames, and a frame
 */

#define __LC3_NS(dt_us, sr_hz) ((dt_us * sr_hz) / 1000 / 1000)

#define __LC3_ND(dt_us, sr_hz) ((dt_us) == 7500 ? 23 * __LC3_NS(dt_us, sr_hz) / 30 : 5 * __LC3_NS(dt_us, sr_hz) / 8)
...
#define LC3_ENCODER_BUFFER_COUNT(dt_us, sr_hz) ((__LC3_NS(dt_us, sr_hz) + __LC3_NT(sr_hz)) / 2 + __LC3_NS(dt_us, sr_hz) + __LC3_ND(dt_us, sr_hz))
...
#define LC3_DECODER_BUFFER_COUNT(dt_us, sr_hz) (__LC3_NH(dt_us, sr_hz) + __LC3_ND(dt_us, sr_hz) + __LC3_NS(dt_us, sr_hz))
