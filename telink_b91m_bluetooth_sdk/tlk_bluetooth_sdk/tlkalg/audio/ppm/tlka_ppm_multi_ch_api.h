...
int  tlka_ppm_asrc_16_bit_get_size();
...
int  tlka_ppm_asrc_24_bit_get_size();
void tlka_ppm_asrc_24_bit_init(void *st, TLKA_PPM_ASRC_CHANNEL channel, int ppm);
