...
swECC_make_key(). */
typedef unsigned char (*sECC_RNG_Function)(unsigned char *dest, unsigned int size);
 ...
 */
unsigned char swECC_shared_secret(const unsigned char *public_key, const unsigned char *private_key, unsigned char *secret, ecc_curve_t curve_sel);
#endif
