 ...
 * macro KE_MSG_ALLOC() (which will call tlk_bt_ctrl_ke_msg_alloc()).

 * The message can then be sent with tlk_bt_ctrl_ke_msg_send(). The kernel
 * will take care of freeing the allocated memory.

 * If the message has no parameters, the tlk_bt_ctrl_ke_msg_send_basic() function
 * can be used.
 *
 * @{
 ****************************************************************************************
...
#include "common/compiler.h" // compiler definition
#include "stack/common/co_list.h"
 ...
 *                       Usually retrieved by a tlk_bt_ctrl_ke_msg_alloc()
 *
...
/**
 ****************************************************************************************
 * @brief Convenient wrapper to tlk_bt_ctrl_ke_msg_alloc()
 *
 * This macro calls tlk_bt_ctrl_ke_msg_alloc() and cast the returned pointer to the
 * appropriate structure. Can only be used if a parameter structure exists
 * for this message (otherwise, use tlk_bt_ctrl_ke_msg_send_basic()).
 *
 ...
 ****************************************************************************************
 */
#define KE_MSG_ALLOC(id, dest, src, param_str) (struct param_str *)tlk_bt_ctrl_ke_msg_alloc(id, dest, src, sizeof(struct param_str))

/**
 ****************************************************************************************
 * @brief Convenient wrapper to tlk_bt_ctrl_ke_msg_free()
 *
 * This macro calls tlk_bt_ctrl_ke_msg_free() with the appropriate msg pointer as parameter, according
 * to the message parameter pointer passed.
 *
 * @param[in] param_ptr parameter structure pointer
 ****************************************************************************************
 */
#define KE_MSG_FREE(param_ptr) tlk_bt_ctrl_ke_msg_free(ke_param2msg((param_ptr)))
 ...
 * for this message (otherwise, use tlk_bt_ctrl_ke_msg_send_basic()).Can only be used if the data array is
 ...
 ****************************************************************************************
 */
#define KE_MSG_ALLOC_DYN(id, dest, src, param_str, length) (struct param_str *)tlk_bt_ctrl_ke_msg_alloc(id, dest, src, (sizeof(struct param_str) + (length)));
 ...
 * pointer has been sent to tlk_bt_ctrl_ke_msg_send(). If the message is not sent, it must
 * be freed explicitly with tlk_bt_ctrl_ke_msg_free().
 *
 ...
 ****************************************************************************************
 */
void *tlk_bt_ctrl_ke_msg_alloc(ke_msg_id_t const id, ke_task_id_t const dest_id, ke_task_id_t const src_id, uint16_t const param_len);

/**
 ****************************************************************************************
 * @brief Message sending.
 *
 * Send a message previously allocated with any tlk_bt_ctrl_ke_msg_alloc()-like functions.
 *
...
void tlk_bt_ctrl_ke_msg_send(void const *param_ptr);
 ...
 ****************************************************************************************
 */
void tlk_bt_ctrl_ke_msg_send_basic(ke_msg_id_t const id, ke_task_id_t const dest_id, ke_task_id_t const src_id);
 ...
 ****************************************************************************************
 */
void tlk_bt_ctrl_ke_msg_forward(void const *param_ptr, ke_task_id_t const dest_id, ke_task_id_t const src_id);
 ...
 ****************************************************************************************
 */
void tlk_bt_ctrl_ke_msg_forward_new_id(void const *param_ptr, ke_msg_id_t const msg_id, ke_task_id_t const dest_id, ke_task_id_t const src_id);
 ...
 ****************************************************************************************
 */
void tlk_bt_ctrl_ke_msg_free(struct ke_msg const *param);
 ...
 ****************************************************************************************
 */
ke_msg_id_t tlk_bt_ctrl_ke_msg_dest_id_get(void const *param_ptr);
 ...
 ****************************************************************************************
 */
ke_msg_id_t tlk_bt_ctrl_ke_msg_src_id_get(void const *param_ptr);
 ...
 */
bool tlk_bt_ctrl_ke_msg_in_queue(void const *param_ptr);
/// @} MSG
