...
#define BLE_ACTIVE_SCAN_STATE    0x20
...
#define BLE_NON_CON_ADV_ACTIVE_SCAN_STATE    0x10
#define BLE_DISC_ADV_ACTIVE_SCAN_STATE       0x20
#define BLE_CON_ADV_ACTIVE_SCAN_STATE        0x40
#define BLE_HDC_DIRECT_ADV_ACTIVE_SCAN_STATE 0x80
...
#define BLE_ACTIVE_SCAN_INIT_STATE   0x80

//byte 3
#define BLE_PASS_SCAN_MASTER_STATE           0x01
#define BLE_ACTIVE_SCAN_MASTER_STATE         0x02
#define BLE_PASS_SCAN_SLAVE_STATE            0x04
#define BLE_ACTIVE_SCAN_SLAVE_STATE          0x08
...
#define BLE_LDC_DIRECT_ADV_ACTIVE_SCAN_STATE 0x80
...
#define FEAT_ERROR_DATA_REP_BIT_POS    53
...
#define PAGE_RESP_TO_DEF  2
#define PAGE_SETUP_TO_DEF 64
...
/// EIR Data Type
#define EIR_DT_UUID16_PART  0x02 /* More 16-bit UUIDs available */
#define EIR_DT_UUID16       0x03 /* Complete list of 16-bit UUIDs */
#define EIR_DT_UUID32_PART  0x04 /* More 32-bit UUIDs available */
#define EIR_DT_UUID32       0x05 /* Complete list of 32-bit UUIDs */
#define EIR_DT_UUID128_PART 0x06 /* More 128-bit UUIDs available */
#define EIR_DT_UUID128      0x07 /* Complete 128-bit UUIDs available */
#define EIR_DT_NAME_PART    0x08 /* Shortened local name */
#define EIR_DT_NAME         0x09 /* Complete local name */
#define EIR_DT_TXPOWER      0x0a /* TX Power level */
#define EIR_DT_OOB_COD      0x0d /* SSP OOB Class of Device */
#define EIR_DT_OOB_C        0x0e /* SSP OOB Hash C */
#define EIR_DT_OOB_R        0x0f /* SSP OOB Randomizer R */
#define EIR_DT_ID           0x10 /* Device ID */
#define EIR_DT_MANUFACTURER 0xff /* Manufacturer Specific Data */
...
#define PAGE_SCAN_INTV_MIN 0x0024
...
#define INQ_SCAN_WIN_MIN 0x0024
...
#define INQ_TX_PWR_DBM_DFT 0x28
...
#define HOLD_MODE_ACTIVE_DEFAULT           0x00
#define HOLD_MODE_ACTIVE_SUSP_PAGE_SCAN    0x01
#define HOLD_MODE_ACTIVE_SUSP_INQUIRY_SCAN 0x02
#define HOLD_MODE_ACTIVE_SUSP_PERIODIC_INQ 0x04
#define HOLD_MODE_ACTIVE_NOT_MASK          0xF8
...
#define AFH_NB_CHANNEL_MIN 21 // As for eagle BT IP, the channel number in AFH must be greater than 20
...
struct sam_type0_submap
{
    ...
    //The nth (numbering from 0) such field defines the submap type of the nth submap in the map:
    // - SAM_SLOT_NOT_AVAILABLE: The slot is not available for transmission or reception.
