...
typedef struct __attribute__((packed))
{
    ...
    u16 maxSDU_m2s;
    u16 maxSDU_s2m;
    u8  SDU_interval_m2s[3];
    u8  SDU_interval_s2m[3];
    u8  framing;
} hci_le_cisEstablishedEvt_v2_t;
...
int hci_le_periodicAdvSyncEstablished_evt_v2(u8 status, u16 syncHandle, u8 advSID, u8 advAddrType, u8 advAddress[6], u8 advPHY, u16 perdAdvItvl, u8 advClkAccuracy, u8 num_subevent,
                                             u8 subevent_intvl, u8 rsp_slot_delay, u8 rsp_slot_spacing);
...
int hci_le_periodicAdvSyncTransferRcvd_evt(u8 status, u16 connHandle, u16 serviceData, u16 syncHandle, u8 advSID, u8 advAddrType, u8 advAddr[6], u8 advPHY, u16 perdAdvItvl,
                                           u8 advClkAccuracy);
int hci_le_cisEstablished_evt(u8 status, u16 cisHandle, u8 cigSyncDly[3], u8 cisSyncDly[3], u8 transLaty_m2s[3], u8 transLaty_s2m[3], u8 phy_m2s, u8 phy_s2m, u8 nse, u8 bn_m2s,
                              u8 bn_s2m, u8 ft_m2s, u8 ft_s2m, u16 maxPDU_m2s, u16 maxPDU_s2m, u16 isoIntvl);
int hci_le_cisEstablished_evt_v2(u8 status, u16 cisHandle, u8 cigSyncDly[3], u8 cisSyncDly[3], u8 transLaty_m2s[3], u8 transLaty_s2m[3], u8 phy_m2s, u8 phy_s2m, u8 nse, u8 bn_m2s,
                                 u8 bn_s2m, u8 ft_m2s, u8 ft_s2m, u16 maxPDU_m2s, u16 maxPDU_s2m, u16 isoIntvl, u8 sub_interval[3], u16 maxSDU_m2s, u16 maxSDU_s2m,
                                 u8 SDU_interval_m2s[3], u8 SDU_interval_s2m[3], u8 framing);
int hci_le_cisReq_evt(u16 aclHandle, u16 cisHandle, u8 cigId, u8 cisId);
int hci_le_createBigComplete_evt(u8 status, u8 bigHandle, u8 bigSyncDly[3], u8 transLatyBig[3], u8 phy, u8 nse, u8 bn, u8 pto, u8 irc, u16 maxPDU, u16 isoIntvl, u8 numBis,
                                 u16 *bisHandles);
...
int hci_le_connectionComplete_evt(u8 status, u16 connHandle, u8 role, u8 peerAddrType, u8 *peerAddr, u16 connInterval, u16 periphr_Latency, u16 supervisionTimeout,
                                  u8 masterClkAccuracy);
int hci_le_enhancedConnectionComplete_evt(u8 status, u16 connHandle, u8 role, u8 peerAddrType, u8 *peerAddr, u8 *localRpa, u8 *peerRpa, u16 connInterval, u16 connLatency,
...
int hci_tlk_connectionEstablish_evt(u8 status, u16 connHandle, u8 role, u8 peerAddrType, u8 *peerAddr, u16 connInterval, u16 periphr_Latency, u16 supervisionTimeout,
                                    u8 masterClkAccuracy);
