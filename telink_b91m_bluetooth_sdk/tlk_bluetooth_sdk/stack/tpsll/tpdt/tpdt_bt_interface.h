 ...
 * @note        
 */
extern uint32_t bttpdt_get_target_tick_based_clkn(void);
 ...
 * @note        
 */
extern void     bttpdt_get_sco_parameters(uint8_t *sco_used, uint32_t *sco_task_tick, uint8_t *interval);
 ...
 * @note        
 */
extern uint32_t bttpdt_bt_disconnection_tpdt_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpdt_bt_sco_start_tpdt_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpdt_bt_sco_sync_tpdt_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpdt_bt_acl_end_in_sco_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpdt_tws_get_role_handler(void *parameter);
 ...
 * @note        
 */
extern uint8_t  bttpdt_get_bt_page_state(void);
 ...
 * @note        
 */
_attribute_le_ram_code_ u8 tpdt_headset_start_connection_setup(uint32_t timeout, uint8_t setup_mode);
#endif
