...
/* callback */
typedef int (*tph_mode_change_handler_cb_t)(u8 *mode,u16 len);
extern tph_mode_change_handler_cb_t tph_mode_change_handler_cb;
 ...
 * @note        
 */
__INLINE void tph_mode_change_handler_cb_register(tph_mode_change_handler_cb_t callback)
{
    tph_mode_change_handler_cb = callback;
}

typedef int (*tph_dongle_mac_address_update_handler_cb_t)(u8 *mac_address,u16 len);
extern tph_dongle_mac_address_update_handler_cb_t tph_dongle_mac_address_update_handler_cb;
 ...
 * @note        
 */
__INLINE void tph_dongle_mac_address_update_handler_cb_register(tph_dongle_mac_address_update_handler_cb_t callback)
{
    tph_dongle_mac_address_update_handler_cb = callback;
}

typedef int (*tph_dongle_connected_handler_cb_t)(u8 *data,u16 len);
extern tph_dongle_connected_handler_cb_t tph_dongle_connected_handler_cb;
 ...
 * @note        
 */
__INLINE void tph_dongle_connected_handler_cb_register(tph_dongle_connected_handler_cb_t callback)
{
    tph_dongle_connected_handler_cb = callback;
}

typedef int (*tph_dongle_disconnected_handler_cb_t)(u8* disconnect_reason,u16 len);
extern tph_dongle_disconnected_handler_cb_t tph_dongle_disconnected_handler_cb;
 ...
 * @note        
 */
__INLINE void tph_dongle_disconnected_handler_cb_register(tph_dongle_disconnected_handler_cb_t callback)
{
    tph_dongle_disconnected_handler_cb = callback;
}

typedef uint8_t (*tph_stimer_handler_callback_t)(uint32_t tick, uint8_t *p_des, uint16_t fno);
extern tph_stimer_handler_callback_t tph_stimer_handler_cb;

typedef uint8_t (*tph_stimer_start_callback_t)(void);
extern tph_stimer_start_callback_t tph_stimer_start_cb;
 ...
 * @note        
 */
__INLINE void tph_stimer_start_cb_register(tph_stimer_start_callback_t callback)
{
    tph_stimer_start_cb = callback;
}

typedef void (*tph_rx_audio_data_callback_t)(uint32_t tick, tph_sco_msg_pdu_header_for_host_t *p_pdu_format);
extern tph_rx_audio_data_callback_t tph_rx_audio_data_cb;
 ...
 * @note        
 */
__INLINE void tph_rx_audio_data_cb_register(tph_rx_audio_data_callback_t callback)
{
    tph_rx_audio_data_cb = callback;
}
 ...
 * @note        
 */
extern u8 tph_dongle_start_connection_setup(u8 setup_mode);
 ...
 * @note        
 */
extern u8 tph_headset_start_disconnection(tph_disconnect_reason_for_host_e disconnect_reason);
 ...
 * @note        
 */
extern u8 tph_dongle_exit_connection_setup(void);
 ...
 * @note        
 */
extern u8 tph_dongle_connection_setup_is_going(void);
 ...
 * @note        
 */
extern u8 tph_headset_bt_acl_is_connected(void);
 ...
 * @note        
 */
extern u8 tph_headset_bt_audio_is_existed(void);
 ...
 * @note        
 */
extern u8 tph_headset_is_slave(void);
 ...
 * @note        
 */
extern u8 tph_headset_is_master(void);
 ...
 * @note        
 */
extern void tph_headset_set_bt_active_pending(void);
 ...
 * @note        
 */
extern void tph_headset_set_mode(u8 mode);
 ...
 * @note        
 */
extern void tph_headset_unset_mode(u8 mode);
 ...
 * @note        
 */
extern void tph_headset_set_mode_save(u8 mode);
 ...
 * @note        
 */
extern void tph_headset_unset_mode_save(u8 mode);
 ...
 * @note        
 */
extern u8   tph_headset_get_mode(void);
 ...
 * @note        
 */
extern u8   tph_headset_get_mode_save(void);
 ...
 * @note        
 */
extern u16  tph_env_get_fno(void);
 ...
 * @note        
 */
extern u8  tph_headset_role_is_single(void);
 ...
 * @note        
 */
extern u8  tph_headset_is_left(void);
 ...
 * @note        
 */
extern u8  tph_dongle_is_idle(void);
 ...
 * @note        
 */
extern u8  tph_dongle_is_connected(void);
 ...
 * @note        
 */
extern u8  tph_dongle_audio_is_existed(void);
 ...
 * @note        
 */
extern u8  tph_dongle_audio_is_music(void);
 ...
 * @note        
 */
extern u8  tph_dongle_audio_is_phone(void);
 ...
 * @note        
 */
extern int tph_bt_audio_is_existed(void);
 ...
 * @note        
 */
extern int tph_bt_audio_is_phone(void);
 ...
 * @note        
 */
extern int tph_bt_audio_is_music(void);

/**
 * @brief       This function clears the SCO message receive FIFO.
 * @return      none.
 * @note        
 */
extern void tph_clear_sco_msg_rxfifo(void);
 ...
 * @note        
 */
extern u8  *tph_get_sco_msg_from_rxfifo(uint8_t rptr);
 ...
 * @note        
 */
extern u8   tph_get_number_of_sco_msg_rxfifo_available(void);
 ...
 * @note        
 */
extern u32 tph_acl_msg_push_txfifo(u8 dst_id, u8 msg_id, u8 cmd, u8 *p, u8 len, void (*callback)(u8 dst_id, u8 msg_id, u8 cmd));
 ...
 * @note        
 */
extern u32 tph_sco_msg_push_txfifo(u8 format, u8 idx, u8 *p, u8 len, void (*callback)(u8 dst_id, u8 msg_id, u8 cmd));
 ...
 * @note        
 */
extern void tph_dongle_set_setup_ac_chn(u32 setup_ac, u8 setup_chn);
 ...
 * @note        
 */
extern void tph_headset_set_local_mac(u8 *local_mac);
 ...
 * @note        
 */
extern void tph_headset_set_gen_mac(u8 *gen_mac);
 ...
 * @note        
 */
extern void tph_headset_set_dongle_mac(u8 *dongle_mac);
 ...
 * @note        
 */
extern void tph_headset_set_dongle_mac_existed(u8 en);

/**
 * @brief       This function sets the flag for dongle disconnection for OTA.
 * @param[in]   en        - enable flag.
 * @return      none.
 * @note        
 */
extern void tph_headset_set_dg_disconnect_for_ota(u8 en);
 ...
 * @note        
 */
extern u8   tph_get_ac_chn_from_mac(uint8_t *mac, uint8_t *ac, uint8_t *chn);
 ...
 * @note        
 */
extern void tph_pwm_irq_handler(void);
 ...
 * @note        
 */
extern void tph_bbtimer_irq_handler(void);
 ...
 * @note        
 */
void tph_host_set_schedule_task(u8 en, u32 interval_us, u16 duration_unit, u8 duration_cnt, u32 anchor_point_tick);
 ...
 * @note        
 */
extern void tph_controller_init(void);
#endif
