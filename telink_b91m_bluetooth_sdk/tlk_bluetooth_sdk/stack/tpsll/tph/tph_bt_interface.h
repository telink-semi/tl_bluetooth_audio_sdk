 ...
 * @note        
 */
extern uint32_t bttph_get_target_tick_based_clkn(void);
 ...
 * @note        
 */
extern void     bttph_get_sco_parameters(uint8_t *sco_used, uint32_t *sco_task_tick, uint8_t *interval);
 ...
 * @note        
 */
extern uint32_t bttph_bt_disconnection_tph_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttph_bt_sco_start_tph_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttph_bt_sco_sync_tph_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttph_bt_acl_end_in_sco_handler(void *parameter);
 ...
 * @note        
 */
extern uint8_t  bttph_get_bt_page_state(void);
 ...
 * @note        
 */
extern uint8_t bttph_get_bt_tx_traffic(void);
