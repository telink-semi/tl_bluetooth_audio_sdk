 ...
 * @note        
 */
extern uint32_t bttpt_get_target_tick_based_clkn(void);
 ...
 * @note        
 */
extern void     bttpt_get_sco_parameters(uint8_t *sco_used, uint32_t *sco_task_tick, uint8_t *interval);
 ...
 * @note        
 */
extern uint8_t  bttpt_bt_sniff_para_sync_handler(uint32_t * bt_sniff_task_end_tick, uint32_t * bt_sniff_intv_us);
 ...
 * @note        
 */
extern uint32_t bttpt_bt_disconnection_tpt_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpt_bt_sco_start_tpt_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpt_bt_sco_sync_tpt_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpt_bt_acl_end_in_sco_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpt_tws_get_role_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpt_tws_get_handover_busy_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpt_tws_afh_sync_parameters_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpt_tws_enc_sync_parameters_handler(void *parameter);
 ...
 * @note        
 */
extern uint32_t bttpt_tws_sniff_sync_parameters_handler(void *parameter);
 ...
 * @note        
 */
extern uint8_t  bttpt_get_bt_page_state(void);
 ...
 * @note        
 */
extern uint8_t  bttpt_get_bt_tx_traffic(void);
 ...
 * @note        
 */
extern bool bttpt_get_bt_access_mode(void);
 ...
 * @note        
 */
extern u8 tpt_headset_start_connection_setup(uint32_t timeout, uint8_t setup_mode);
