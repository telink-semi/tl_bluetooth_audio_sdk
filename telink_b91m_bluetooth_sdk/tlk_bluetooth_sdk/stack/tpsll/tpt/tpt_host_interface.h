...
/* callback */
typedef void (*tpt_dongle_mac_address_update_handler_cb_t)(u8 *mac_address);
extern tpt_dongle_mac_address_update_handler_cb_t tpt_dongle_mac_address_update_handler_cb;
 ...
 * @note        
 */
__INLINE void tpt_dongle_mac_address_update_handler_cb_register(tpt_dongle_mac_address_update_handler_cb_t callback)
{
    tpt_dongle_mac_address_update_handler_cb = callback;
}

typedef void (*tpt_dongle_connected_handler_cb_t)(void);
extern tpt_dongle_connected_handler_cb_t tpt_dongle_connected_handler_cb;
 ...
 * @note        
 */
__INLINE void tpt_dongle_connected_handler_cb_register(tpt_dongle_connected_handler_cb_t callback)
{
    tpt_dongle_connected_handler_cb = callback;
}

typedef void (*tpt_dongle_disconnected_handler_cb_t)(u8 disconnect_reason);
extern tpt_dongle_disconnected_handler_cb_t tpt_dongle_disconnected_handler_cb;
 ...
 * @note        
 */
__INLINE void tpt_dongle_disconnected_handler_cb_register(tpt_dongle_disconnected_handler_cb_t callback)
{
    tpt_dongle_disconnected_handler_cb = callback;
}

typedef void (*tpt_tws_headset_connected_handler_cb_t)(void);
extern tpt_tws_headset_connected_handler_cb_t tpt_tws_headset_connected_handler_cb;
 ...
 * @note        
 */
__INLINE void tpt_tws_headset_connected_handler_cb_register(tpt_tws_headset_connected_handler_cb_t callback)
{
    tpt_tws_headset_connected_handler_cb = callback;
}

typedef void (*tpt_tws_headset_disconnected_handler_cb_t)(u8 disconnect_reason);
extern tpt_tws_headset_disconnected_handler_cb_t tpt_tws_headset_disconnected_handler_cb;
 ...
 * @note        
 */
__INLINE void tpt_tws_headset_disconnected_handler_cb_register(tpt_tws_headset_disconnected_handler_cb_t callback)
{
    tpt_tws_headset_disconnected_handler_cb = callback;
}

typedef uint8_t (*tpt_stimer_handler_callback_t)(uint32_t tick, uint8_t *p_des, uint16_t fno);
extern tpt_stimer_handler_callback_t tpt_stimer_handler_cb;

typedef uint8_t (*tpt_stimer_start_callback_t)(void);
extern tpt_stimer_start_callback_t tpt_stimer_start_cb;
 ...
 * @note        
 */
__INLINE void tpt_stimer_start_cb_register(tpt_stimer_start_callback_t callback)
{
    tpt_stimer_start_cb = callback;
}

typedef void (*tpt_rx_audio_data_callback_t)(uint32_t tick, tpt_sco_msg_pdu_header_for_host_t *p_pdu_format);
extern tpt_rx_audio_data_callback_t tpt_rx_audio_data_cb;
 ...
 * @note        
 */
__INLINE void tpt_rx_audio_data_cb_register(tpt_rx_audio_data_callback_t callback)
{
    tpt_rx_audio_data_cb = callback;
}
 ...
 * @note        
 */
extern u8 tpt_dongle_start_connection_setup(u8 setup_mode);
 ...
 * @note        
 */
extern u8 tpt_headset_start_disconnection(tpt_disconnect_reason_for_host_e disconnect_reason);
 ...
 * @note        
 */
extern u8 tpt_dongle_exit_connection_setup(void);
 ...
 * @note        
 */
extern u8 tpt_dongle_connection_setup_is_going(void);
 ...
 * @note        
 */
extern u8 tpt_headset_exit_connection_setup(void);
 ...
 * @note        
 */
extern void tpt_headset_set_bt_active_pending(void);
 ...
 * @note        
 */
extern u8 tpt_headset_bt_acl_is_connected(void);
 ...
 * @note        
 */
extern u8 tpt_headset_bt_audio_is_existed(void);
 ...
 * @note        
 */
extern u8 tpt_headset_is_slave(void);
 ...
 * @note        
 */
extern u8 tpt_headset_is_master(void);
 ...
 * @note        
 */
extern u8 tpt_role_set_single(void);// IDLE, or single
 ...
 * @note        
 */
extern void tpt_headset_set_mode_save(u8 mode);
 ...
 * @note        
 */
extern void tpt_headset_unset_mode_save(u8 mode);
 ...
 * @note        
 */
extern void tpt_headset_set_mode(u8 mode);
 ...
 * @note        
 */
extern void tpt_headset_unset_mode(u8 mode);
 ...
 * @note        
 */
extern u8   tpt_headset_get_mode(void);
 ...
 * @note        
 */
extern u8   tpt_headset_get_mode_save(void);
 ...
 * @note        
 */
extern u16  tpt_env_get_fno(void);
 ...
 * @note        
 */
extern u8   tpt_headset_role_is_single(void);
 ...
 * @note        
 */
extern u8   tpt_headset_is_left(void);
 ...
 * @note        
 */
extern void tpt_headset_set_left(u8 left);
 ...
 * @note        
 */
extern u8  tpt_dongle_is_idle(void);
 ...
 * @note        
 */
extern u8  tpt_dongle_is_connected(void);
 ...
 * @note        
 */
extern u8  tpt_dongle_audio_is_existed(void);
 ...
 * @note        
 */
extern u8  tpt_dongle_audio_is_music(void);
 ...
 * @note        
 */
extern u8  tpt_dongle_audio_is_phone(void);
 ...
 * @note        
 */
extern int tpt_bt_audio_is_existed(void);
 ...
 * @note        
 */
extern int tpt_bt_audio_is_phone(void);
 ...
 * @note        
 */
extern int tpt_bt_audio_is_music(void);

/**
 * @brief       Clears the SCO message receive FIFO.
 * @return      none.
 * @note        
 */
extern void tpt_clear_sco_msg_rxfifo(void);
 ...
 * @note        
 */
extern u8  *tpt_get_sco_msg_from_rxfifo(uint8_t rptr);
 ...
 * @note        
 */
extern u8   tpt_get_number_of_sco_msg_rxfifo_available(void);
 ...
 * @note        
 */
extern u32 tpt_acl_msg_push_txfifo(u8 dst_id, u8 msg_id, u8 cmd, u8 *p, u8 len, void (*callback)(u8 dst_id, u8 msg_id, u16 cmd));
 ...
 * @note        
 */
extern u32 tpt_sco_msg_push_txfifo(u8 format, u8 idx, u8 *p, u8 len, void (*callback)(u8 dst_id, u8 msg_id, u16 cmd));
 ...
 * @note        
 */
extern void tpt_dongle_set_setup_ac_chn(u32 setup_ac, u8 setup_chn);
 ...
 * @note        
 */
extern void tpt_headset_set_local_mac(u8 *local_mac);
 ...
 * @note        
 */
extern void tpt_headset_set_gen_mac(u8 *gen_mac);
 ...
 * @note        
 */
extern void tpt_headset_set_dongle_mac(u8 *dongle_mac);
 ...
 * @note        
 */
extern void tpt_headset_set_dongle_mac_existed(u8 en);
 ...
 * @note        
 */
extern void tpt_headset_set_dg_disconnect_for_ota(u8 en);
 ...
 * @note        
 */
extern u8   tpt_get_ac_chn_from_mac(uint8_t *mac, uint8_t *ac, uint8_t *chn);
 ...
 * @note        
 */
extern void tpt_pwm_irq_handler(void);
 ...
 * @note        
 */
extern void tpt_bbtimer_irq_handler(void);
 ...
 * @note        
 */
extern void tpt_host_set_schedule_task(u8 en, u32 interval_us, u16 duration_unit, u8 duration_cnt, u32 anchor_point_tick);
 ...
 * @note        
 */
extern void tpt_controller_init(u16 usb_id);
 ...
 * @note        
 */
extern void tpt_host_power_control(tpt_power_control_obj_e obj, tpt_host_pwr_control_opcode_e pwr_opcode);
