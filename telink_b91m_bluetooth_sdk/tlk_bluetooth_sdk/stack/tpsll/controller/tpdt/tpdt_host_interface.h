...
/* callback */
typedef void (*tpdt_dongle_mac_address_update_handler_cb_t)(uint8_t *mac_address);
extern tpdt_dongle_mac_address_update_handler_cb_t gp_tlk_tpsll_tpdt_dongle_mac_address_update_handler_cb;
 ...
 * @note
 */
__INLINE void tlk_tpsll_tpdt_dongle_mac_address_update_handler_cb_register(tpdt_dongle_mac_address_update_handler_cb_t callback)
{
    gp_tlk_tpsll_tpdt_dongle_mac_address_update_handler_cb = callback;
}

typedef void (*tpdt_dongle_connected_handler_cb_t)(void);
extern tpdt_dongle_connected_handler_cb_t gp_tlk_tpsll_tpdt_dongle_connected_handler_cb;
 ...
 * @note
 */
__INLINE void tlk_tpsll_tpdt_dongle_connected_handler_cb_register(tpdt_dongle_connected_handler_cb_t callback)
{
    gp_tlk_tpsll_tpdt_dongle_connected_handler_cb = callback;
}

typedef void (*tpdt_dongle_disconnected_handler_cb_t)(uint8_t disconnect_reason);
extern tpdt_dongle_disconnected_handler_cb_t gp_tlk_tpsll_tpdt_dongle_disconnected_handler_cb;
 ...
 * @note
 */
__INLINE void tlk_tpsll_tpdt_dongle_disconnected_handler_cb_register(tpdt_dongle_disconnected_handler_cb_t callback)
{
    gp_tlk_tpsll_tpdt_dongle_disconnected_handler_cb = callback;
}

typedef void (*tpdt_tws_headset_connected_handler_cb_t)(void);
extern tpdt_tws_headset_connected_handler_cb_t gp_tlk_tpsll_tpdt_tws_headset_connected_handler_cb;
 ...
 * @note
 */
__INLINE void tlk_tpsll_tpdt_tws_headset_connected_handler_cb_register(tpdt_tws_headset_connected_handler_cb_t callback)
{
    gp_tlk_tpsll_tpdt_tws_headset_connected_handler_cb = callback;
}

typedef void (*tpdt_tws_headset_disconnected_handler_cb_t)(uint8_t disconnect_reason);
extern tpdt_tws_headset_disconnected_handler_cb_t gp_tlk_tpsll_tpdt_tws_headset_disconnected_handler_cb;
 ...
 * @note
 */
__INLINE void tlk_tpsll_tpdt_tws_headset_disconnected_handler_cb_register(tpdt_tws_headset_disconnected_handler_cb_t callback)
{
    gp_tlk_tpsll_tpdt_tws_headset_disconnected_handler_cb = callback;
}

typedef uint8_t (*tpdt_stimer_handler_callback_t)(uint32_t tick, uint8_t *p_des, uint16_t fno);
extern tpdt_stimer_handler_callback_t gp_tlk_tpsll_tpdt_stimer_handler_cb;

typedef uint8_t (*tpdt_stimer_start_callback_t)(void);
extern tpdt_stimer_start_callback_t gp_tlk_tpsll_tpdt_stimer_start_cb;
 ...
 * @note
 */
__INLINE void tlk_tpsll_tpdt_stimer_start_cb_register(tpdt_stimer_start_callback_t callback)
{
    gp_tlk_tpsll_tpdt_stimer_start_cb = callback;
}

typedef void (*tpdt_rx_audio_data_callback_t)(uint32_t tick, tpdt_sco_msg_pdu_header_for_host_t *p_pdu_format);
extern tpdt_rx_audio_data_callback_t gp_tlk_tpsll_tpdt_rx_audio_data_cb;
 ...
 * @note
 */
__INLINE void tlk_tpsll_tpdt_rx_audio_data_cb_register(tpdt_rx_audio_data_callback_t callback)
{
    gp_tlk_tpsll_tpdt_rx_audio_data_cb = callback;
}
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_dongle_start_connection_setup(uint8_t setup_mode);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_start_disconnection(tpdt_disconnect_reason_for_host_e disconnect_reason);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_dongle_exit_connection_setup(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_dongle_connection_setup_is_going(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_exit_connection_setup(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_bt_acl_is_connected(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_bt_audio_is_existed(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_is_slave(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_is_master(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_role_set_single(void); // IDLE, or single
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_set_mode_save(uint8_t mode);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_unset_mode_save(uint8_t mode);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_set_mode(uint8_t mode);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_set_le_mode(uint8_t mode);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_unset_mode(uint8_t mode);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_unset_le_mode(uint8_t mode);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_get_mode(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_get_mode_save(void);
 ...
 * @note
 */
extern uint16_t tlk_tpsll_tpdt_env_get_fno(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_role_is_single(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_headset_is_left(void);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_set_left(uint8_t left);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_dongle_is_idle(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_dongle_is_connected(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_dongle_audio_is_existed(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_dongle_audio_is_music(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_dongle_audio_is_phone(void);
 ...
 * @note
 */
extern int tlk_tpsll_tpdt_bt_audio_is_existed(void);
 ...
 * @note
 */
extern int tlk_tpsll_tpdt_bt_audio_is_phone(void);
 ...
 * @note
 */
extern int tlk_tpsll_tpdt_bt_audio_is_music(void);
 ...
 * @note
 */
extern uint8_t *tlk_tpsll_tpdt_get_sco_msg_from_rxfifo(uint8_t rptr);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_get_number_of_sco_msg_rxfifo_available(void);
 ...
 * @note
 */
extern uint32_t tlk_tpsll_tpdt_acl_msg_push_txfifo(uint8_t dst_id, uint8_t msg_id, uint8_t cmd, uint8_t *p, uint8_t len,
                                                   void (*callback)(uint8_t dst_id, uint8_t msg_id, uint8_t cmd));
 ...
 * @note
 */
extern uint32_t tlk_tpsll_tpdt_sco_msg_push_txfifo(uint8_t format, uint8_t idx, uint8_t *p, uint8_t len, void (*callback)(uint8_t dst_id, uint8_t msg_id, uint8_t cmd));
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_dongle_set_setup_ac_chn(uint32_t setup_ac, uint8_t setup_chn);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_set_local_mac(uint8_t *local_mac);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_set_gen_mac(uint8_t *gen_mac);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_set_dongle_mac(uint8_t *dongle_mac);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_set_dongle_mac_existed(uint8_t en);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_headset_set_dg_disconnect_for_ota(uint8_t en);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_get_ac_chn_from_mac(uint8_t *mac, uint8_t *ac, uint8_t *chn);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_pwm_irq_handler(void);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_bbtimer_irq_handler(void);
 ...
 * @note
 */
void tlk_tpsll_tpdt_host_set_schedule_task(uint8_t en, uint32_t interval_us, uint16_t duration_unit, uint8_t duration_cnt, uint32_t anchor_point_tick);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_controller_init(uint16_t usb_id);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_host_get_tws_role(void);
 ...
 * @note
 */
extern void tlk_tpsll_tpdt_host_get_tws_connect_mac(uint8_t *remote_mac, uint8_t *target_mac, uint8_t *gen_mac);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpdt_host_get_handover_host_info(uint8_t *p_host_status_info);
