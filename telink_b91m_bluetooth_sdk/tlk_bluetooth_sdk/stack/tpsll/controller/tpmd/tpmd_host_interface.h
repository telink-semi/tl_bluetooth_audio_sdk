...
typedef uint8_t (*tpmd_dongle_audio_path_callback_t)(uint16_t cmd);
extern tpmd_dongle_audio_path_callback_t gp_tlk_tpsll_tpmd_audio_path_cb;
 ...
 * @note
 */
__INLINE void tlk_tpsll_tpmd_audio_path_cb_register(tpmd_dongle_audio_path_callback_t callback)
{
    gp_tlk_tpsll_tpmd_audio_path_cb = callback;
}

typedef void (*tpmd_cmd_ui_handler_cb_t)(uint8_t *cmd);
extern tpmd_cmd_ui_handler_cb_t gp_tlk_tpsll_tpmd_cmd_ui_handler_cb;
 ...
 * @note
 */
__INLINE void tlk_tpsll_tpmd_cmd_ui_handler_cb_register(tpmd_cmd_ui_handler_cb_t callback)
{
    gp_tlk_tpsll_tpmd_cmd_ui_handler_cb = callback;
}
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_get_sco_pos_in_bt_voice(void);
/**
 * @brief       Retrieves the current dongle mode.
 * @return      The dongle mode.
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_host_get_dongle_mode(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_host_dongle_start_connection_scan(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_host_start_dongle_sco_setup(uint8_t audio_mode);
/**
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_host_exit_dongle_sco(void);
/**
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_host_switch_dongle_sco_audio_mode(uint8_t audio_mode);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_dongle_is_connected(void);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_pwm_irq_handler(void);
/**
 * @brief       This function handles the bbtimer interrupt.
 * @return      none.
 * @note
 */
extern void tlk_tpsll_tpmd_bbtimer_irq_handler(void);
 ...
 * @note
 */
void tlk_tpsll_tpmd_host_set_schedule_task(uint8_t en, uint32_t interval_us, uint16_t duration_unit, uint8_t duration_cnt, uint32_t anchor_point_tick);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_controller_init(void);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_dongle_set_setup_ac_chn(uint32_t setup_ac, uint8_t setup_chn);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_get_ac_chn_from_mac(uint8_t *mac, uint8_t *ac, uint8_t *chn);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_dongle_set_headset_mac(uint8_t *gen_mac);
 ...
 * @note
 */
extern uint16_t tlk_tpsll_tpmd_env_get_fno(void);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_dongle_set_local_mac(uint8_t *local_mac);


typedef void (*tpmd_headset_connected_handler_cb_t)(uint8_t *mac_address);
extern tpmd_headset_connected_handler_cb_t gp_tlk_tpsll_tpmd_headset_connected_handler_cb;
 ...
 * @note
 */
inline void tlk_tpsll_tpmd_headset_connected_handler_cb_register(tpmd_headset_connected_handler_cb_t callback)
{
    gp_tlk_tpsll_tpmd_headset_connected_handler_cb = callback;
}

typedef void (*tpmd_headset_disconnected_handler_cb_t)(uint8_t disconnect_reason);
extern tpmd_headset_disconnected_handler_cb_t gp_tlk_tpsll_tpmd_headset_disconnected_handler_cb;
 ...
 * @note
 */
inline void tlk_tpsll_tpmd_headset_disconnected_handler_cb_register(tpmd_headset_disconnected_handler_cb_t callback)
{
    gp_tlk_tpsll_tpmd_headset_disconnected_handler_cb = callback;
}
 ...
 * @note
 */
uint8_t tlk_tpsll_tpmd_headset_is_cc_headset_connected(void);
 ...
 * @note
 */
uint8_t tlk_tpsll_tpmd_headset_master_is_left(void);
 ...
 * @note
 */
extern uint8_t *tlk_tpsll_tpmd_dongle_get_mic_data_ptr(void);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_headset_get_setup_ac_chn(uint32_t *setup_ac, uint8_t *setup_chn);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_headset_get_gen_mac(uint8_t *gen_mac);
 ...
 * @note
 */
extern uint8_t *tlk_tpsll_tpmd_sco_music_msg_push_txfifo(uint8_t format, uint8_t chnl, uint8_t len, void (*callback)(uint8_t dst_id, uint8_t msg_id, uint8_t cmd));
 ...
 * @note
 */
extern uint8_t *tlk_tpsll_tpmd_opus_music_msg_push_txfifo(uint8_t *p, uint8_t len, void (*callback)(uint8_t dst_id, uint8_t msg_id, uint8_t cmd));
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_msg_tx_done_handler(uint8_t dst_id, uint8_t msg_id, uint8_t cmd);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_sco_music_msg_push_txfifo_done(uint8_t chnl);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_headset_is_single_role(void);
 ...
 * @note
 */
extern uint8_t tlk_tpsll_tpmd_dongle_start_disconnection(tpmd_disconnect_reason_e disconnect_reason);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_host_set_power_index(uint8_t pwr_idx);
 ...
 * @note
 */
extern void tlk_tpsll_tpmd_host_set_audio_path_status(uint8_t is_running);
