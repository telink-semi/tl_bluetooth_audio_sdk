...
#define LEA_CODEC_MODE_MONO       0x03
...
#else
#if (TLKHW_TYPE == BOARD_721X_EVK_C1T315A20 && TLKDRV_CODEC_ICODEC_ENABLE && (CODEC_INPUT_MODE != CODEC_INPUT_DMIC))
#define LEA_CODEC_INPUT_MODE LEA_CODEC_MODE_MONO
#else
#define LEA_CODEC_INPUT_MODE LEA_CODEC_MODE_LEFT_ONLY
#endif
