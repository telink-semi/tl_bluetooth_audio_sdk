 ...
 */
__attribute__((weak)) int tlkmdi_tinySql_getBtMacAddress(uint8_t *recBuffer)
{
#if TLK_STK_BTBLE_CTKD
    return tlkmdi_tinySql_getLeMacAddress(recBuffer);
#else
    if (recBuffer == NULL) {
        return -TLK_EPARAM;
    }
 ...
 * @returns   0 indicates success, other values indicate corresponding error codes.
 */
__attribute__((weak)) int tlkmdi_tinySql_setBtMacAddress(uint8_t *inBuffer)
{
    (void)inBuffer;
 ...
 * @returns   0 indicates success, other values indicate corresponding error codes.
 */
__attribute__((weak)) int tlkmdi_tinySql_getLeMacAddress(uint8_t *recBuffer)
{
    if (recBuffer == NULL) {
        return -TLK_EPARAM;
    }
    tlkhal_get_bluetooth_mac(recBuffer);
    return TLK_ENONE;
}
 ...
 * @returns   0 indicates success, other values indicate corresponding error codes.
 */
__attribute__((weak)) int tlkmdi_tinySql_setLeMacAddress(uint8_t *inBuffer)
{
    (void)inBuffer;
    return -TLK_ENOSUPPORT;
}
 ...
 */
__attribute__((weak)) int tlkmdi_tinySql_getTpsAddr(uint8_t *recBuffer)
{
    return tlkmdi_tinySql_getLeMacAddress(recBuffer);
}
 ...
 */
__attribute__((weak)) int tlkmdi_tinySql_getTpdAddr(uint8_t *recBuffer)
{
    return tlkmdi_tinySql_getLeMacAddress(recBuffer);
}
#endif
