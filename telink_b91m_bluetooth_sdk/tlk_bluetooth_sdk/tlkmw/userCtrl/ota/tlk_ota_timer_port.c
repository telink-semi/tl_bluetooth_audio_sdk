...
// #include <stdint.h>
// General API implementation (the specific implementation of registration calls).
 ...
 * @note       This is a weak function that needs to be implemented by the user
 */
__attribute__((weak)) bool tlk_ota_timer_porting_create(tlk_ota_timer_handle_t *timer, uint32_t timeout_ms, timer_callback_t callback, void *user_data)
{
    (void)timer;
    (void)timeout_ms;
    (void)callback;
 ...
 * @note       This is a weak function that needs to be implemented by the user
 */
__attribute__((weak)) bool tlk_ota_timer_porting_start(tlk_ota_timer_handle_t timer)
{
    (void)timer;
    return false;
}
 ...
 * @note       This is a weak function that needs to be implemented by the user
 */
__attribute__((weak)) bool tlk_ota_timer_porting_stop(tlk_ota_timer_handle_t timer)
{
    (void)timer;
    return false;
}
 ...
 * @note       This is a weak function that needs to be implemented by the user
 */
__attribute__((weak)) bool tlk_ota_timer_porting_reset_timeout(tlk_ota_timer_handle_t timer, uint32_t new_timeout_ms)
{
    (void)timer;
    (void)new_timeout_ms;
    return false;
 ...
 * @note       This is a weak function that needs to be implemented by the user
 */
__attribute__((weak)) bool tlk_ota_timer_porting_destroy(tlk_ota_timer_handle_t timer)
{
    (void)timer;
    return false;
}
 ...
 * @note       This is a weak function that needs to be implemented by the user
 */
__attribute__((weak)) bool tlk_ota_timer_porting_is_running(tlk_ota_timer_handle_t timer)
{
    (void)timer;
    return false;
}
